...
impl world::Accessible for Location {
    ...
    fn can_access(&self, ctx: &Context, world: &World) -> bool {
        ctx.can_afford(&self.price) && match self.id {
            ...
            LocationId::Ebih__Hidden_Portal__Button__Hit_Button => rules::access_invoke_melee_or_invoke_boomerang(ctx, world),
    ...
    fn observe_access(&self, ctx: &Context, world: &World, full_obs: &mut FullObservation) -> bool {
        ...
        match self.id {
            ...
            LocationId::Ebih__Hidden_Portal__Button__Hit_Button => rules::observe_access_invoke_melee_or_invoke_boomerang(ctx, world, full_obs),
    ...
    fn explain_rule(&self, ctx: &Self::Context, world: &World, edict: &mut FxHashMap<&'static str, String>) -> (bool, Vec<&'static str>) {
        match self.id {
            ...
            LocationId::Ebih__Hidden_Portal__Button__Hit_Button => rules::explain_invoke_melee_or_invoke_boomerang(ctx, world, edict),
