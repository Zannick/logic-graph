...
pub fn access___invoke_grab_and_invoke_climb_or___invoke_hook_and_invoke_hover(
    ctx: &Context,
    world: &World,
) -> bool {
...
pub fn access___invoke_hook_and_invoke_hover_or_invoke_infinite_climb(
    ...
    // ($hook and $hover) or $infinite_climb
    ((helper__hook!(ctx, world) && helper__hover!(ctx, world))
...
pub fn access___invoke_infinite_climb_and_slingshot_hook_or___invoke_climb_and_invoke_grab_and_anuman(
    ctx: &Context,
    world: &World,
) -> bool {
    // ($infinite_climb and Slingshot_Hook) or ($climb and $grab and Anuman)
...
pub fn access___slingshot_hook_and_slingshot_weapon_or_drone_melee_damage(
    ctx: &Context,
    world: &World,
) -> bool {
    // (Slingshot_Hook and Slingshot_Weapon) or Drone_Melee_Damage
...
pub fn access_amagi__main_area__ctx__combo_and___invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // ^_combo and ($hook or $grab or $climb)
    (ctx.amagi__main_area__ctx__combo()
        && ((helper__hook!(ctx, world) || helper__grab!(ctx, world)) || helper__climb!(ctx, world)))
}
...
pub fn access_amagi_stronghold_boulder_1_and_underwater_movement_and___invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // Amagi_Stronghold_Boulder_1 and Underwater_Movement and ($hook or $grab or $climb)
...
pub fn access_annuna__east_bridge__ctx__combo_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // ^_combo and ($hook or $grab)
    (ctx.annuna__east_bridge__ctx__combo()
        && (helper__hook!(ctx, world) || helper__grab!(ctx, world)))
}
...
pub fn access_annuna__west_bridge__ctx__doors_opened_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // ^_doors_opened and ($hook or $grab)
    (ctx.annuna__west_bridge__ctx__doors_opened()
        && (helper__hook!(ctx, world) || helper__grab!(ctx, world)))
}
...
pub fn access_annuna_east_bridge_gate_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // Annuna_East_Bridge_Gate and ($hook or $grab)
    (ctx.has(Item::Annuna_East_Bridge_Gate)
        && (helper__hook!(ctx, world) || helper__grab!(ctx, world)))
}
...
pub fn access_annuna_east_bridge_gate_and_nanite_mist(ctx: &Context, world: &World) -> bool {
    // Annuna_East_Bridge_Gate and Nanite_Mist
    (ctx.has(Item::Annuna_East_Bridge_Gate) && ctx.has(Item::Nanite_Mist))
}
...
pub fn access_anuman_or_invoke_hover(ctx: &Context, world: &World) -> bool {
    // Anuman or $hover
    (ctx.has(Item::Anuman) || helper__hover!(ctx, world))
}
...
pub fn access_ebih_hidden_portal_gate_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // Ebih_Hidden_Portal_Gate and ($hook or $grab)
    (ctx.has(Item::Ebih_Hidden_Portal_Gate)
        && (helper__hook!(ctx, world) || helper__grab!(ctx, world)))
}
...
pub fn access_ebih_interchange_gate_and_ebih_interchange_block_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // Ebih_Interchange_Gate and Ebih_Interchange_Block and ($hook or $grab)
    ((ctx.has(Item::Ebih_Interchange_Gate) && ctx.has(Item::Ebih_Interchange_Block))
        && (helper__hook!(ctx, world) || helper__grab!(ctx, world)))
}
pub fn access_ebih_interchange_gate_and_not_ebih_interchange_block_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // Ebih_Interchange_Gate and not Ebih_Interchange_Block and ($hook or $grab)
    ((ctx.has(Item::Ebih_Interchange_Gate) && !ctx.has(Item::Ebih_Interchange_Block))
        && (helper__hook!(ctx, world) || helper__grab!(ctx, world)))
}
...
pub fn access_giguna__carnelian__ctx__lower_susar_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // ^_lower_susar and ($hook or $grab)
    (ctx.giguna__carnelian__ctx__lower_susar()
        && (helper__hook!(ctx, world) || helper__grab!(ctx, world)))
}
...
pub fn access_giguna__east_caverns__ctx__mid_susar_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // ^_mid_susar and ($hook or $grab)
    (ctx.giguna__east_caverns__ctx__mid_susar()
        && (helper__hook!(ctx, world) || helper__grab!(ctx, world)))
}
...
pub fn access_giguna__giguna_base__ctx__door_open_and___invoke_hook_or___invoke_grab_and_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // ^_door_open and ($hook or ($grab and $climb))
    (ctx.giguna__giguna_base__ctx__door_open()
        && (helper__hook!(ctx, world) || (helper__grab!(ctx, world) && helper__climb!(ctx, world))))
}
...
pub fn access_giguna_dual_path_switch_and___invoke_hook_or_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // Giguna_Dual_Path_Switch and ($hook or $climb)
    (ctx.has(Item::Giguna_Dual_Path_Switch)
        && (helper__hook!(ctx, world) || helper__climb!(ctx, world)))
}
pub fn access_giguna_dual_path_switch_and___invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // Giguna_Dual_Path_Switch and ($hook or $grab or $climb)
    (ctx.has(Item::Giguna_Dual_Path_Switch)
        && ((helper__hook!(ctx, world) || helper__grab!(ctx, world)) || helper__climb!(ctx, world)))
}
...
pub fn access_giguna_gateway_block_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // Giguna_Gateway_Block and ($hook or $grab)
    (ctx.has(Item::Giguna_Gateway_Block)
        && (helper__hook!(ctx, world) || helper__grab!(ctx, world)))
}
...
pub fn access_giguna_gubi_and___invoke_boomerang_or_invoke_hover(
    ctx: &Context,
    world: &World,
) -> bool {
    // Giguna_Gubi and ($boomerang or $hover)
    (ctx.has(Item::Giguna_Gubi) && (helper__boomerang!(ctx, world) || helper__hover!(ctx, world)))
}
...
pub fn access_giguna_vertical_interchange_rock_and___invoke_hook_and_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // Giguna_Vertical_Interchange_Rock and ($hook and $grab)
    (ctx.has(Item::Giguna_Vertical_Interchange_Rock)
        && (helper__hook!(ctx, world) && helper__grab!(ctx, world)))
}
...
pub fn access_glacier_fortress_gate_and___invoke_hook_or_anuman_or_invoke_grab_or_invoke_hover(
    ctx: &Context,
    world: &World,
) -> bool {
    // Glacier_Fortress_Gate and ($hook or Anuman or $grab or $hover)
    (ctx.has(Item::Glacier_Fortress_Gate)
...
pub fn access_invoke_climb_and_not_anuman(ctx: &Context, world: &World) -> bool {
    // $climb and not Anuman
    (helper__climb!(ctx, world) && !ctx.has(Item::Anuman))
}
pub fn access_invoke_climb_or_invoke_hover(ctx: &Context, world: &World) -> bool {
    // $climb or $hover
    (helper__climb!(ctx, world) || helper__hover!(ctx, world))
}
...
pub fn access_invoke_hook_or___anuman_and___invoke_grab_or_invoke_climb_or___invoke_grab_and_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // $hook or (Anuman and ($grab or $climb)) or ($grab and $climb)
    ((helper__hook!(ctx, world)
...
pub fn access_invoke_hook_or___invoke_grab_and_anuman_or_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // $hook or ($grab and Anuman) or $climb
    ((helper__hook!(ctx, world) || (helper__grab!(ctx, world) && ctx.has(Item::Anuman)))
        || helper__climb!(ctx, world))
}
pub fn access_invoke_hook_or___invoke_grab_and_invoke_climb(ctx: &Context, world: &World) -> bool {
    // $hook or ($grab and $climb)
    (helper__hook!(ctx, world) || (helper__grab!(ctx, world) && helper__climb!(ctx, world)))
}
pub fn access_invoke_hook_or___underwater_movement_and_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // $hook or (Underwater_Movement and $grab)
    (helper__hook!(ctx, world) || (ctx.has(Item::Underwater_Movement) && helper__grab!(ctx, world)))
}
pub fn access_invoke_hook_or___underwater_movement_and_invoke_hover(
    ctx: &Context,
    world: &World,
) -> bool {
    // $hook or (Underwater_Movement and $hover)
    (helper__hook!(ctx, world)
...
pub fn access_invoke_hook_or_anuman_or_invoke_grab(ctx: &Context, world: &World) -> bool {
    // $hook or Anuman or $grab
    ((helper__hook!(ctx, world) || ctx.has(Item::Anuman)) || helper__grab!(ctx, world))
}
pub fn access_invoke_hook_or_anuman_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // $hook or Anuman or $grab or $climb
    (((helper__hook!(ctx, world) || ctx.has(Item::Anuman)) || helper__grab!(ctx, world))
        || helper__climb!(ctx, world))
}
pub fn access_invoke_hook_or_anuman_or_invoke_grab_or_invoke_hover(
    ctx: &Context,
    world: &World,
) -> bool {
    // $hook or Anuman or $grab or $hover
    (((helper__hook!(ctx, world) || ctx.has(Item::Anuman)) || helper__grab!(ctx, world))
        || helper__hover!(ctx, world))
}
pub fn access_invoke_hook_or_anuman_or_invoke_hover(ctx: &Context, world: &World) -> bool {
    // $hook or Anuman or $hover
    ((helper__hook!(ctx, world) || ctx.has(Item::Anuman)) || helper__hover!(ctx, world))
}
pub fn access_invoke_hook_or_anuman_or_invoke_hover_or_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // $hook or Anuman or $hover or $grab
    (((helper__hook!(ctx, world) || ctx.has(Item::Anuman)) || helper__hover!(ctx, world))
        || helper__grab!(ctx, world))
}
pub fn access_invoke_hook_or_invoke_climb(ctx: &Context, world: &World) -> bool {
    // $hook or $climb
    (helper__hook!(ctx, world) || helper__climb!(ctx, world))
}
pub fn access_invoke_hook_or_invoke_climb_or___invoke_grab_and_anuman(
    ctx: &Context,
    world: &World,
) -> bool {
    // $hook or $climb or ($grab and Anuman)
    ((helper__hook!(ctx, world) || helper__climb!(ctx, world))
        || (helper__grab!(ctx, world) && ctx.has(Item::Anuman)))
}
pub fn access_invoke_hook_or_invoke_grab(ctx: &Context, world: &World) -> bool {
    // $hook or $grab
    (helper__hook!(ctx, world) || helper__grab!(ctx, world))
}
pub fn access_invoke_hook_or_invoke_grab_or_anuman(ctx: &Context, world: &World) -> bool {
    // $hook or $grab or Anuman
    ((helper__hook!(ctx, world) || helper__grab!(ctx, world)) || ctx.has(Item::Anuman))
}
pub fn access_invoke_hook_or_invoke_grab_or_invoke_climb(ctx: &Context, world: &World) -> bool {
    // $hook or $grab or $climb
    ((helper__hook!(ctx, world) || helper__grab!(ctx, world)) || helper__climb!(ctx, world))
}
...
pub fn access_invoke_hook_or_invoke_hover_or___invoke_grab_and_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // $hook or $hover or ($grab and $climb)
    ((helper__hook!(ctx, world) || helper__hover!(ctx, world))
        || (helper__grab!(ctx, world) && helper__climb!(ctx, world)))
}
pub fn access_invoke_hook_or_invoke_hover_or_invoke_grab(ctx: &Context, world: &World) -> bool {
    // $hook or $hover or $grab
    ((helper__hook!(ctx, world) || helper__hover!(ctx, world)) || helper__grab!(ctx, world))
}
pub fn access_invoke_hook_or_invoke_hover_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // $hook or $hover or $grab or $climb
    (((helper__hook!(ctx, world) || helper__hover!(ctx, world)) || helper__grab!(ctx, world))
        || helper__climb!(ctx, world))
}
...
pub fn access_invoke_hookhover_and___slingshot_weapon_or_slingshot_charge(
    ctx: &Context,
    world: &World,
) -> bool {
    // $hookhover and (Slingshot_Weapon or Slingshot_Charge)
    (helper__hookhover!(ctx, world)
        && (ctx.has(Item::Slingshot_Weapon) || ctx.has(Item::Slingshot_Charge)))
}
...
pub fn access_invoke_hover_or_anuman_or_invoke_climb(ctx: &Context, world: &World) -> bool {
    // $hover or Anuman or $climb
    ((helper__hover!(ctx, world) || ctx.has(Item::Anuman)) || helper__climb!(ctx, world))
}
pub fn access_invoke_hover_or_invoke_climb(ctx: &Context, world: &World) -> bool {
    // $hover or $climb
    (helper__hover!(ctx, world) || helper__climb!(ctx, world))
}
pub fn access_invoke_hover_or_invoke_hook(ctx: &Context, world: &World) -> bool {
    // $hover or $hook
    (helper__hover!(ctx, world) || helper__hook!(ctx, world))
}
pub fn access_invoke_hover_or_invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // $hover or $hook or $grab or $climb
    (((helper__hover!(ctx, world) || helper__hook!(ctx, world)) || helper__grab!(ctx, world))
        || helper__climb!(ctx, world))
}
...
pub fn access_invoke_spin_or_invoke_charge(ctx: &Context, world: &World) -> bool {
    // $spin or $charge
    (helper__spin!(ctx, world) || helper__charge!(ctx, world))
}
pub fn access_invoke_spin_or_invoke_hook(ctx: &Context, world: &World) -> bool {
    // $spin or $hook
    (helper__spin!(ctx, world) || helper__hook!(ctx, world))
}
pub fn access_invoke_spinhover(ctx: &Context, world: &World) -> bool {
    // $spinhover
    helper__spinhover!(ctx, world)
}
pub fn access_invoke_spinhover_or_invoke_charge(ctx: &Context, world: &World) -> bool {
    // $spinhover or $charge
    (helper__spinhover!(ctx, world) || helper__charge!(ctx, world))
}
...
pub fn access_mode_eq_drone_and___ebih_waterfall_block_left_or_invoke_block_clip(
    ctx: &Context,
    world: &World,
) -> bool {
    // ^mode == 'drone' and (Ebih_Waterfall_Block_Left or $block_clip)
    (ctx.mode() == enums::Mode::Drone
        && (ctx.has(Item::Ebih_Waterfall_Block_Left) || helper__block_clip!(ctx, world)))
}
pub fn access_mode_eq_drone_and___ebih_waterfall_block_left_or_invoke_hook(
    ctx: &Context,
    world: &World,
) -> bool {
    // ^mode == 'drone' and (Ebih_Waterfall_Block_Left or $hook)
    (ctx.mode() == enums::Mode::Drone
        && (ctx.has(Item::Ebih_Waterfall_Block_Left) || helper__hook!(ctx, world)))
}
pub fn access_mode_eq_drone_and___ebih_waterfall_block_right_or_invoke_block_clip(
    ctx: &Context,
    world: &World,
) -> bool {
    // ^mode == 'drone' and (Ebih_Waterfall_Block_Right or $block_clip)
    (ctx.mode() == enums::Mode::Drone
        && (ctx.has(Item::Ebih_Waterfall_Block_Right) || helper__block_clip!(ctx, world)))
}
pub fn access_mode_eq_drone_and___ebih_waterfall_block_right_or_invoke_hook(
    ctx: &Context,
    world: &World,
) -> bool {
    // ^mode == 'drone' and (Ebih_Waterfall_Block_Right or $hook)
    (ctx.mode() == enums::Mode::Drone
        && (ctx.has(Item::Ebih_Waterfall_Block_Right) || helper__hook!(ctx, world)))
}
...
pub fn access_mode_eq_drone_and_not_anuman_and_not_slingshot_hook(
    ctx: &Context,
    world: &World,
) -> bool {
    // ^mode == 'drone' and not Anuman and not Slingshot_Hook
    ((ctx.mode() == enums::Mode::Drone && !ctx.has(Item::Anuman)) && !ctx.has(Item::Slingshot_Hook))
}
...
pub fn access_mode_ne_drone_and_not_anuman(ctx: &Context, world: &World) -> bool {
...
pub fn access_not_anuman(ctx: &Context, world: &World) -> bool {
    // not Anuman
    !ctx.has(Item::Anuman)
}
...
pub fn access_not_ebih__base_camp__ctx__left_platform_moved_and_____invoke_platform_and_invoke_hook_or_invoke_hover(
    ctx: &Context,
    world: &World,
) -> bool {
    // not ^_left_platform_moved and (($platform and $hook) or $hover)
    (!ctx.ebih__base_camp__ctx__left_platform_moved()
        && ((helper__platform!(ctx, world) && helper__hook!(ctx, world))
            || helper__hover!(ctx, world)))
}
pub fn access_not_ebih__drone_room__ctx__platform_moved_and___invoke_hook_or_infect(
    ctx: &Context,
    world: &World,
) -> bool {
    // not ^_platform_moved and ($hook or Infect)
    (!ctx.ebih__drone_room__ctx__platform_moved()
        && (helper__hook!(ctx, world) || ctx.has(Item::Infect)))
}
...
pub fn access_not_ebih_waterfall_block_left(ctx: &Context, world: &World) -> bool {
    // not Ebih_Waterfall_Block_Left
    !ctx.has(Item::Ebih_Waterfall_Block_Left)
}
pub fn access_not_ebih_waterfall_block_right(ctx: &Context, world: &World) -> bool {
    // not Ebih_Waterfall_Block_Right
...
pub fn access_not_giguna__ruins_west__ctx__kishib_handled_and___invoke_allegiance1_or_invoke_shockwave(
    ctx: &Context,
    world: &World,
) -> bool {
    // not ^_kishib_handled and ($allegiance1 or $shockwave)
    (!ctx.giguna__ruins_west__ctx__kishib_handled()
        && (helper__allegiance1!(ctx, world) || helper__shockwave!(ctx, world)))
}
...
pub fn access_not_invoke_allegiance1(ctx: &Context, world: &World) -> bool {
    // not $allegiance1
    !helper__allegiance1!(ctx, world)
}
pub fn access_not_invoke_boomerang(ctx: &Context, world: &World) -> bool {
    // not $boomerang
    !helper__boomerang!(ctx, world)
}
pub fn access_not_invoke_climb(ctx: &Context, world: &World) -> bool {
    // not $climb
    !helper__climb!(ctx, world)
}
...
pub fn access_not_invoke_hook_and___not_invoke_grab_or_not_anuman(
    ctx: &Context,
    world: &World,
) -> bool {
    // not $hook and (not $grab or not Anuman)
    (!helper__hook!(ctx, world) && (!helper__grab!(ctx, world) || !ctx.has(Item::Anuman)))
}
pub fn access_not_invoke_hook_and_not_anuman(ctx: &Context, world: &World) -> bool {
    // not $hook and not Anuman
    (!helper__hook!(ctx, world) && !ctx.has(Item::Anuman))
}
pub fn access_not_invoke_hook_and_not_invoke_climb_and___not_invoke_grab_or_not_anuman(
    ctx: &Context,
    world: &World,
) -> bool {
    // not $hook and not $climb and (not $grab or not Anuman)
    ((!helper__hook!(ctx, world) && !helper__climb!(ctx, world))
        && (!helper__grab!(ctx, world) || !ctx.has(Item::Anuman)))
}
pub fn access_not_invoke_hook_and_not_invoke_grab(ctx: &Context, world: &World) -> bool {
    // not $hook and not $grab
    (!helper__hook!(ctx, world) && !helper__grab!(ctx, world))
}
pub fn access_not_invoke_hook_and_not_invoke_grab_and_not_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // not $hook and not $grab and not $climb
    ((!helper__hook!(ctx, world) && !helper__grab!(ctx, world)) && !helper__climb!(ctx, world))
}
pub fn access_not_invoke_hook_and_not_invoke_hover(ctx: &Context, world: &World) -> bool {
    // not $hook and not $hover
    (!helper__hook!(ctx, world) && !helper__hover!(ctx, world))
}
pub fn access_not_invoke_hook_and_not_invoke_hover_and_not_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // not $hook and not $hover and not $grab
    ((!helper__hook!(ctx, world) && !helper__hover!(ctx, world)) && !helper__grab!(ctx, world))
}
pub fn access_not_invoke_hook_and_not_underwater_movement(ctx: &Context, world: &World) -> bool {
    // not $hook and not Underwater_Movement
    (!helper__hook!(ctx, world) && !ctx.has(Item::Underwater_Movement))
}
pub fn access_not_invoke_hook_or_not_invoke_hover(ctx: &Context, world: &World) -> bool {
    // not $hook or not $hover
    (!helper__hook!(ctx, world) || !helper__hover!(ctx, world))
}
pub fn access_not_invoke_hookhover(ctx: &Context, world: &World) -> bool {
    // not $hookhover
    !helper__hookhover!(ctx, world)
}
pub fn access_not_invoke_hover(ctx: &Context, world: &World) -> bool {
    // not $hover
    !helper__hover!(ctx, world)
}
pub fn access_not_invoke_hover_and_not_invoke_spin(ctx: &Context, world: &World) -> bool {
    // not $hover and not $spin
    (!helper__hover!(ctx, world) && !helper__spin!(ctx, world))
}
pub fn access_not_invoke_infinite_climb_or_not_slingshot_hook(
    ctx: &Context,
    world: &World,
) -> bool {
    // not $infinite_climb or not Slingshot_Hook
    (!helper__infinite_climb!(ctx, world) || !ctx.has(Item::Slingshot_Hook))
}
pub fn access_not_invoke_spin(ctx: &Context, world: &World) -> bool {
    // not $spin
    !helper__spin!(ctx, world)
}
pub fn access_not_invoke_spin_and_not_invoke_hookhover(ctx: &Context, world: &World) -> bool {
    // not $spin and not $hookhover
    (!helper__spin!(ctx, world) && !helper__hookhover!(ctx, world))
}
pub fn access_not_invoke_spinhover(ctx: &Context, world: &World) -> bool {
    // not $spinhover
    !helper__spinhover!(ctx, world)
}
...
pub fn access_not_slingshot_hook_and_not_drone_hover(ctx: &Context, world: &World) -> bool {
    // not Slingshot_Hook and not Drone_Hover
    (!ctx.has(Item::Slingshot_Hook) && !ctx.has(Item::Drone_Hover))
}
pub fn access_not_slingshot_hook_or_not_drone_hover(ctx: &Context, world: &World) -> bool {
    // not Slingshot_Hook or not Drone_Hover
    (!ctx.has(Item::Slingshot_Hook) || !ctx.has(Item::Drone_Hover))
}
pub fn access_not_slingshot_hook_or_not_slingshot_weapon(ctx: &Context, world: &World) -> bool {
    // not Slingshot_Hook or not Slingshot_Weapon
    (!ctx.has(Item::Slingshot_Hook) || !ctx.has(Item::Slingshot_Weapon))
}
...
pub fn access_not_uhrum_annuna_corridor_block(ctx: &Context, world: &World) -> bool {
    // not Uhrum_Annuna_Corridor_Block
    !ctx.has(Item::Uhrum_Annuna_Corridor_Block)
}
pub fn access_not_uhrum_east_lake_block(ctx: &Context, world: &World) -> bool {
    // not Uhrum_East_Lake_Block
    !ctx.has(Item::Uhrum_East_Lake_Block)
}
pub fn access_not_underwater_movement(ctx: &Context, world: &World) -> bool {
    // not Underwater_Movement
    !ctx.has(Item::Underwater_Movement)
}
pub fn access_not_underwater_movement_and_not_invoke_hook(ctx: &Context, world: &World) -> bool {
    // not Underwater_Movement and not $hook
    (!ctx.has(Item::Underwater_Movement) && !helper__hook!(ctx, world))
}
pub fn access_not_underwater_movement_or_not_slingshot_hook_or_not_drone_hover(
    ctx: &Context,
    world: &World,
) -> bool {
    // not Underwater_Movement or not Slingshot_Hook or not Drone_Hover
    ((!ctx.has(Item::Underwater_Movement) || !ctx.has(Item::Slingshot_Hook))
        || !ctx.has(Item::Drone_Hover))
}
pub fn access_not_wall_climb(ctx: &Context, world: &World) -> bool {
    // not Wall_Climb
...
pub fn access_slingshot_hook_and___slingshot_weapon_or_slingshot_charge(
    ctx: &Context,
    world: &World,
) -> bool {
    // Slingshot_Hook and (Slingshot_Weapon or Slingshot_Charge)
    (ctx.has(Item::Slingshot_Hook)
        && (ctx.has(Item::Slingshot_Weapon) || ctx.has(Item::Slingshot_Charge)))
}
pub fn access_slingshot_hook_and___slingshot_weapon_or_slingshot_charge_and_drone_hover(
    ctx: &Context,
    world: &World,
) -> bool {
    // Slingshot_Hook and (Slingshot_Weapon or Slingshot_Charge) and Drone_Hover
    ((ctx.has(Item::Slingshot_Hook)
        && (ctx.has(Item::Slingshot_Weapon) || ctx.has(Item::Slingshot_Charge)))
        && ctx.has(Item::Drone_Hover))
}
...
pub fn access_slingshot_hook_or___underwater_movement_and_drone_hover(
    ctx: &Context,
    world: &World,
) -> bool {
    // Slingshot_Hook or (Underwater_Movement and Drone_Hover)
    (ctx.has(Item::Slingshot_Hook)
...
pub fn access_slingshot_weapon_and_drone_hover_and_not_drone_melee_damage_3(
    ctx: &Context,
    world: &World,
) -> bool {
    // Slingshot_Weapon and Drone_Hover and not Drone_Melee_Damage_3
    ((ctx.has(Item::Slingshot_Weapon) && ctx.has(Item::Drone_Hover))
        && !ctx.has(Item::Drone_Melee_Damage_3))
}
pub fn access_slingshot_weapon_and_not_drone_melee_damage_3(ctx: &Context, world: &World) -> bool {
    // Slingshot_Weapon and not Drone_Melee_Damage_3
    (ctx.has(Item::Slingshot_Weapon) && !ctx.has(Item::Drone_Melee_Damage_3))
}
...
pub fn access_uhrum_annuna_corridor_block_or_invoke_block_clip_escape(
    ctx: &Context,
    world: &World,
) -> bool {
    // Uhrum_Annuna_Corridor_Block or $block_clip_escape
    (ctx.has(Item::Uhrum_Annuna_Corridor_Block) || helper__block_clip_escape!(ctx, world))
}
...
pub fn access_uhrum_east_lake_block_or___invoke_block_clip_and_slingshot_hook(
    ctx: &Context,
    world: &World,
) -> bool {
    // Uhrum_East_Lake_Block or ($block_clip and Slingshot_Hook)
    (ctx.has(Item::Uhrum_East_Lake_Block)
...
pub fn access_uhrum_waterfalls_block_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // Uhrum_Waterfalls_Block and ($hook or $grab)
    (ctx.has(Item::Uhrum_Waterfalls_Block)
        && (helper__hook!(ctx, world) || helper__grab!(ctx, world)))
}
...
pub fn access_underwater_movement_and___invoke_hook_or___invoke_grab_and_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // Underwater_Movement and ($hook or ($grab and $climb))
    (ctx.has(Item::Underwater_Movement)
        && (helper__hook!(ctx, world) || (helper__grab!(ctx, world) && helper__climb!(ctx, world))))
}
pub fn access_underwater_movement_and___invoke_hook_or_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // Underwater_Movement and ($hook or $climb)
    (ctx.has(Item::Underwater_Movement)
        && (helper__hook!(ctx, world) || helper__climb!(ctx, world)))
}
pub fn access_underwater_movement_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // Underwater_Movement and ($hook or $grab)
    (ctx.has(Item::Underwater_Movement) && (helper__hook!(ctx, world) || helper__grab!(ctx, world)))
}
pub fn access_underwater_movement_and___invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // Underwater_Movement and ($hook or $grab or $climb)
    (ctx.has(Item::Underwater_Movement)
        && ((helper__hook!(ctx, world) || helper__grab!(ctx, world)) || helper__climb!(ctx, world)))
}
...
pub fn access_underwater_movement_or___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // Underwater_Movement or ($hook or $grab)
    (ctx.has(Item::Underwater_Movement) || (helper__hook!(ctx, world) || helper__grab!(ctx, world)))
}
pub fn access_underwater_movement_or___invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // Underwater_Movement or ($hook or $grab or $climb)
    (ctx.has(Item::Underwater_Movement)
        || ((helper__hook!(ctx, world) || helper__grab!(ctx, world)) || helper__climb!(ctx, world)))
}
pub fn access_underwater_movement_or_drone_hover(ctx: &Context, world: &World) -> bool {
    // Underwater_Movement or Drone_Hover
    (ctx.has(Item::Underwater_Movement) || ctx.has(Item::Drone_Hover))
}
pub fn access_underwater_movement_or_invoke_hook(ctx: &Context, world: &World) -> bool {
    // Underwater_Movement or $hook
    (ctx.has(Item::Underwater_Movement) || helper__hook!(ctx, world))
}
pub fn access_underwater_movement_or_invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
) -> bool {
    // Underwater_Movement or $hook or $grab
...
pub fn access_underwater_movement_or_invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
) -> bool {
    // Underwater_Movement or $hook or $grab or $climb
...
pub fn access_underwater_movement_or_invoke_hover(ctx: &Context, world: &World) -> bool {
    // Underwater_Movement or $hover
    (ctx.has(Item::Underwater_Movement) || helper__hover!(ctx, world))
}
...
pub fn access_underwater_movement_or_slingshot_hook_or_drone_hover(
    ctx: &Context,
    world: &World,
) -> bool {
    // Underwater_Movement or Slingshot_Hook or Drone_Hover
    ((ctx.has(Item::Underwater_Movement) || ctx.has(Item::Slingshot_Hook))
        || ctx.has(Item::Drone_Hover))
}
...
pub fn explain___invoke_grab_and_invoke_climb_or___invoke_hook_and_invoke_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain___invoke_hook_and_invoke_hover_or_invoke_infinite_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain___invoke_infinite_climb_and_slingshot_hook_or___invoke_climb_and_invoke_grab_and_anuman(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain___slingshot_hook_and_slingshot_weapon_or_drone_melee_damage(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_amagi__main_area__ctx__combo_and___invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_amagi_stronghold_boulder_1_and_underwater_movement_and___invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_annuna__east_bridge__ctx__combo_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_annuna__west_bridge__ctx__doors_opened_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_annuna_east_bridge_gate_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_annuna_east_bridge_gate_and_nanite_mist(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_anuman_or_invoke_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_ebih_hidden_portal_gate_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_ebih_interchange_gate_and_ebih_interchange_block_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_ebih_interchange_gate_and_not_ebih_interchange_block_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_giguna__carnelian__ctx__lower_susar_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_giguna__east_caverns__ctx__mid_susar_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_giguna__giguna_base__ctx__door_open_and___invoke_hook_or___invoke_grab_and_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_giguna_dual_path_switch_and___invoke_hook_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_giguna_dual_path_switch_and___invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_giguna_gateway_block_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_giguna_gubi_and___invoke_boomerang_or_invoke_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_giguna_vertical_interchange_rock_and___invoke_hook_and_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_glacier_fortress_gate_and___invoke_hook_or_anuman_or_invoke_grab_or_invoke_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_climb_and_not_anuman(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_climb_or_invoke_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or___anuman_and___invoke_grab_or_invoke_climb_or___invoke_grab_and_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or___invoke_grab_and_anuman_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or___invoke_grab_and_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or___underwater_movement_and_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or___underwater_movement_and_invoke_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or_anuman_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or_anuman_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or_anuman_or_invoke_grab_or_invoke_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or_anuman_or_invoke_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or_anuman_or_invoke_hover_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or_invoke_climb_or___invoke_grab_and_anuman(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or_invoke_grab_or_anuman(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or_invoke_hover_or___invoke_grab_and_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or_invoke_hover_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hook_or_invoke_hover_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hookhover_and___slingshot_weapon_or_slingshot_charge(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hover_or_anuman_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hover_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_hover_or_invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_spin_or_invoke_charge(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_spin_or_invoke_hook(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_invoke_spinhover_or_invoke_charge(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_mode_eq_drone_and___ebih_waterfall_block_left_or_invoke_block_clip(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_mode_eq_drone_and___ebih_waterfall_block_left_or_invoke_hook(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_mode_eq_drone_and___ebih_waterfall_block_right_or_invoke_block_clip(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_mode_eq_drone_and___ebih_waterfall_block_right_or_invoke_hook(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_mode_eq_drone_and_not_anuman_and_not_slingshot_hook(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_mode_ne_drone_and_not_anuman(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_ebih__base_camp__ctx__left_platform_moved_and_____invoke_platform_and_invoke_hook_or_invoke_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_ebih__drone_room__ctx__platform_moved_and___invoke_hook_or_infect(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_ebih_waterfall_block_left(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_ebih_waterfall_block_right(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_giguna__ruins_west__ctx__kishib_handled_and___invoke_allegiance1_or_invoke_shockwave(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_invoke_allegiance1(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
    ...
    {
        let (res, mut refs) = hexplain__allegiance1!(ctx, world, edict);
        edict.insert("not$allegiance1", format!("{:?}", res));
        refs.push("not$allegiance1");
        (!res, refs)
    }
}
pub fn explain_not_invoke_boomerang(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
    ...
    {
        let (res, mut refs) = hexplain__boomerang!(ctx, world, edict);
        edict.insert("not$boomerang", format!("{:?}", res));
        refs.push("not$boomerang");
        (!res, refs)
    }
}
pub fn explain_not_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
    ...
    {
        let (res, mut refs) = hexplain__climb!(ctx, world, edict);
        edict.insert("not$climb", format!("{:?}", res));
        refs.push("not$climb");
        (!res, refs)
    }
}
...
pub fn explain_not_invoke_hook_and___not_invoke_grab_or_not_anuman(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
    // not $hook and (not $grab or not Anuman)
    {
        ...
        if !left.0 {
            ...
            let mut right = ({
                let mut left = {
                    let (res, mut refs) = hexplain__grab!(ctx, world, edict);
                    edict.insert("not$grab", format!("{:?}", res));
                    refs.push("not$grab");
                    (!res, refs)
                };
                if left.0 {
...
pub fn explain_not_invoke_hook_and_not_anuman(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_invoke_hook_and_not_invoke_climb_and___not_invoke_grab_or_not_anuman(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_invoke_hook_and_not_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_invoke_hook_and_not_invoke_grab_and_not_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_invoke_hook_and_not_invoke_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
    // not $hook and not $hover
    {
        ...
        if !left.0 {
            ...
            let mut right = {
                let (res, mut refs) = hexplain__hover!(ctx, world, edict);
                edict.insert("not$hover", format!("{:?}", res));
                refs.push("not$hover");
                (!res, refs)
            };
            left.1.append(&mut right.1);
...
pub fn explain_not_invoke_hook_and_not_invoke_hover_and_not_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_invoke_hook_and_not_underwater_movement(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_invoke_hook_or_not_invoke_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_invoke_hookhover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
    ...
    {
        let (res, mut refs) = hexplain__hookhover!(ctx, world, edict);
        edict.insert("not$hookhover", format!("{:?}", res));
        refs.push("not$hookhover");
        (!res, refs)
    }
}
pub fn explain_not_invoke_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_invoke_hover_and_not_invoke_spin(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
    // not $hover and not $spin
    {
        ...
        if !left.0 {
            ...
            let mut right = {
                let (res, mut refs) = hexplain__spin!(ctx, world, edict);
                edict.insert("not$spin", format!("{:?}", res));
                refs.push("not$spin");
                (!res, refs)
            };
            left.1.append(&mut right.1);
...
pub fn explain_not_invoke_infinite_climb_or_not_slingshot_hook(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
    // not $infinite_climb or not Slingshot_Hook
    {
        let mut left = {
            let (res, mut refs) = hexplain__infinite_climb!(ctx, world, edict);
            edict.insert("not$infinite_climb", format!("{:?}", res));
            refs.push("not$infinite_climb");
            (!res, refs)
        };
        if left.0 {
            left
...
pub fn explain_not_invoke_spin(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_invoke_spin_and_not_invoke_hookhover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_invoke_spinhover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
    ...
    {
        let (res, mut refs) = hexplain__spinhover!(ctx, world, edict);
        edict.insert("not$spinhover", format!("{:?}", res));
        refs.push("not$spinhover");
        (!res, refs)
    }
}
...
pub fn explain_not_slingshot_hook_and_not_drone_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_slingshot_hook_or_not_drone_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_slingshot_hook_or_not_slingshot_weapon(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_uhrum_annuna_corridor_block(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_uhrum_east_lake_block(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_underwater_movement(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_underwater_movement_and_not_invoke_hook(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_not_underwater_movement_or_not_slingshot_hook_or_not_drone_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_slingshot_hook_and___slingshot_weapon_or_slingshot_charge(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_slingshot_hook_and___slingshot_weapon_or_slingshot_charge_and_drone_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_slingshot_hook_or___underwater_movement_and_drone_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_slingshot_weapon_and_drone_hover_and_not_drone_melee_damage_3(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_slingshot_weapon_and_not_drone_melee_damage_3(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_uhrum_annuna_corridor_block_or_invoke_block_clip_escape(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_uhrum_east_lake_block_or___invoke_block_clip_and_slingshot_hook(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_uhrum_waterfalls_block_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_underwater_movement_and___invoke_hook_or___invoke_grab_and_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_underwater_movement_and___invoke_hook_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_underwater_movement_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_underwater_movement_and___invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_underwater_movement_or___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_underwater_movement_or___invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_underwater_movement_or_drone_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_underwater_movement_or_invoke_hook(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_underwater_movement_or_invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_underwater_movement_or_invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_underwater_movement_or_invoke_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn explain_underwater_movement_or_slingshot_hook_or_drone_hover(
    ctx: &Context,
    world: &World,
    edict: &mut FxHashMap<&'static str, String>,
) -> (bool, Vec<&'static str>) {
...
pub fn observe_access___invoke_grab_and_invoke_climb_or___invoke_hook_and_invoke_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access___invoke_infinite_climb_and_slingshot_hook_or___invoke_climb_and_invoke_grab_and_anuman(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access___slingshot_hook_and_slingshot_weapon_or_drone_melee_damage(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_amagi__main_area__ctx__combo_and___invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
    ...
    ({
        ...
        ctx.amagi__main_area__ctx__combo()
    } && ((hobserve__hook!(ctx, world, full_obs) || hobserve__grab!(ctx, world, full_obs))
...
pub fn observe_access_amagi_stronghold_boulder_1_and_underwater_movement_and___invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_annuna__east_bridge__ctx__combo_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_annuna__west_bridge__ctx__doors_opened_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_annuna_east_bridge_gate_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_annuna_east_bridge_gate_and_nanite_mist(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_anuman_or_invoke_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_ebih_hidden_portal_gate_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_ebih_interchange_gate_and_ebih_interchange_block_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_ebih_interchange_gate_and_not_ebih_interchange_block_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_giguna__carnelian__ctx__lower_susar_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_giguna__east_caverns__ctx__mid_susar_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_giguna__giguna_base__ctx__door_open_and___invoke_hook_or___invoke_grab_and_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_giguna_dual_path_switch_and___invoke_hook_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
    ...
    ({
        full_obs.observe_giguna_dual_path_switch();
        ctx.has(Item::Giguna_Dual_Path_Switch)
    } && (hobserve__hook!(ctx, world, full_obs) || hobserve__climb!(ctx, world, full_obs)))
}
pub fn observe_access_giguna_dual_path_switch_and___invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_giguna_gateway_block_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_giguna_gubi_and___invoke_boomerang_or_invoke_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
    ...
    } && (hobserve__boomerang!(ctx, world, full_obs) || hobserve__hover!(ctx, world, full_obs)))
}
...
pub fn observe_access_giguna_vertical_interchange_rock_and___invoke_hook_and_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_glacier_fortress_gate_and___invoke_hook_or_anuman_or_invoke_grab_or_invoke_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_climb_and_not_anuman(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_climb_or_invoke_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
    // $climb or $hover
    (hobserve__climb!(ctx, world, full_obs) || hobserve__hover!(ctx, world, full_obs))
}
...
pub fn observe_access_invoke_hook_or___anuman_and___invoke_grab_or_invoke_climb_or___invoke_grab_and_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or___invoke_grab_and_anuman_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or___invoke_grab_and_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or___underwater_movement_and_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or___underwater_movement_and_invoke_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or_anuman_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or_anuman_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or_anuman_or_invoke_grab_or_invoke_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or_anuman_or_invoke_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or_anuman_or_invoke_hover_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or_invoke_climb_or___invoke_grab_and_anuman(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or_invoke_grab_or_anuman(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or_invoke_hover_or___invoke_grab_and_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or_invoke_hover_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hook_or_invoke_hover_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hookhover_and___slingshot_weapon_or_slingshot_charge(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hover_or_anuman_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_hover_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
    // $hover or $climb
    (hobserve__hover!(ctx, world, full_obs) || hobserve__climb!(ctx, world, full_obs))
}
...
pub fn observe_access_invoke_hover_or_invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_invoke_spin_or_invoke_charge(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
    // $spin or $charge
    (hobserve__spin!(ctx, world, full_obs) || hobserve__charge!(ctx, world, full_obs))
}
pub fn observe_access_invoke_spin_or_invoke_hook(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
    // $spin or $hook
    (hobserve__spin!(ctx, world, full_obs) || hobserve__hook!(ctx, world, full_obs))
}
...
pub fn observe_access_invoke_spinhover_or_invoke_charge(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
    // $spinhover or $charge
    (hobserve__spinhover!(ctx, world, full_obs) || hobserve__charge!(ctx, world, full_obs))
}
...
pub fn observe_access_mode_eq_drone_and___ebih_waterfall_block_left_or_invoke_block_clip(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_mode_eq_drone_and___ebih_waterfall_block_left_or_invoke_hook(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_mode_eq_drone_and___ebih_waterfall_block_right_or_invoke_block_clip(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_mode_eq_drone_and___ebih_waterfall_block_right_or_invoke_hook(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_mode_eq_drone_and_not_anuman_and_not_slingshot_hook(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_mode_ne_drone_and_not_anuman(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_anuman(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_ebih__base_camp__ctx__left_platform_moved_and_____invoke_platform_and_invoke_hook_or_invoke_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_ebih__drone_room__ctx__platform_moved_and___invoke_hook_or_infect(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_ebih_waterfall_block_left(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_ebih_waterfall_block_right(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_giguna__ruins_west__ctx__kishib_handled_and___invoke_allegiance1_or_invoke_shockwave(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_allegiance1(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_boomerang(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_hook_and___not_invoke_grab_or_not_anuman(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_hook_and_not_anuman(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_hook_and_not_invoke_climb_and___not_invoke_grab_or_not_anuman(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_hook_and_not_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_hook_and_not_invoke_grab_and_not_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_hook_and_not_invoke_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_hook_and_not_invoke_hover_and_not_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_hook_and_not_underwater_movement(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_hook_or_not_invoke_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_hookhover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_hover_and_not_invoke_spin(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
    // not $hover and not $spin
    (hobserve__hover!(ctx, world, full_obs) && (hobserve__spin!(ctx, world, full_obs)))
}
pub fn observe_access_not_invoke_infinite_climb_or_not_slingshot_hook(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_spin(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_invoke_spin_and_not_invoke_hookhover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
    // not $spin and not $hookhover
    (hobserve__spin!(ctx, world, full_obs) && (hobserve__hookhover!(ctx, world, full_obs)))
}
pub fn observe_access_not_invoke_spinhover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_slingshot_hook_and_not_drone_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_slingshot_hook_or_not_drone_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_slingshot_hook_or_not_slingshot_weapon(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_uhrum_annuna_corridor_block(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_uhrum_east_lake_block(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_underwater_movement(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_underwater_movement_and_not_invoke_hook(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_underwater_movement_or_not_slingshot_hook_or_not_drone_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_not_wall_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_slingshot_hook_and___slingshot_weapon_or_slingshot_charge(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_slingshot_hook_and___slingshot_weapon_or_slingshot_charge_and_drone_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_slingshot_hook_or___underwater_movement_and_drone_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_slingshot_weapon_and_drone_hover_and_not_drone_melee_damage_3(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_slingshot_weapon_and_not_drone_melee_damage_3(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_uhrum_annuna_corridor_block_or_invoke_block_clip_escape(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_uhrum_east_lake_block_or___invoke_block_clip_and_slingshot_hook(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_uhrum_waterfalls_block_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_underwater_movement_and___invoke_hook_or___invoke_grab_and_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_underwater_movement_and___invoke_hook_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_underwater_movement_and___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_underwater_movement_and___invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_underwater_movement_or___invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_underwater_movement_or___invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_underwater_movement_or_drone_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_underwater_movement_or_invoke_hook(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_underwater_movement_or_invoke_hook_or_invoke_grab(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_underwater_movement_or_invoke_hook_or_invoke_grab_or_invoke_climb(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_underwater_movement_or_invoke_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
...
pub fn observe_access_underwater_movement_or_slingshot_hook_or_drone_hover(
    ctx: &Context,
    world: &World,
    full_obs: &mut FullObservation,
) -> bool {
