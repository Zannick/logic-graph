    ...
    fn observe_visit(&mut self, loc_id: LocationId) {
        match loc_id {
            ...
            LocationId::Amagi__West_Lake__Stronghold_Rear_Wall__Break_Left_Wall => {
                self.cbits3.insert(flags::ContextBits3::VISITED_AMAGI__WEST_LAKE__STRONGHOLD_REAR_WALL__BREAK_LEFT_WALL);
            ...
            LocationId::Annuna__Egg_Room__Cache__Shockwave_Flask => {
                ...
                self.cbits7
                    .insert(flags::ContextBits7::SKIPPED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK);
            }
