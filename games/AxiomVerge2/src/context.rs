...
pub mod flags {
    ...
    bitflags! {
        ...
        pub struct ContextBits1 : u32 {
            ...
            const GIGUNA__CLOUDS__CTX__PLATFORM_AND_PORTAL = 1 << 18;
            const GIGUNA__EAST_CAVERNS__CTX__DOOR_OPENED = 1 << 19;
            const GIGUNA__EAST_CAVERNS__CTX__COMBO_ENTERED = 1 << 20;
