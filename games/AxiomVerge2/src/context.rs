...
pub mod flags {
    ...
    bitflags! {
        ...
        pub struct ContextBits1 : u64 {
            ...
            const MAP__ANNUNA__VERTICAL_ROOM__SAVE = 0x8;
            const MAP__ANNUNA__FACTORY_ENTRANCE__SAVE = 0x10;
            const MAP__EBIH__BASE_CAMP__SAVE = 0x20;
            const MAP__EBIH__EBIH_WEST__MID_SAVE = 0x40;
            const MAP__EBIH__EBIH_WEST__UPPER_SAVE = 0x80;
            const MAP__EBIH__EBIH_WEST__LOWER_SAVE = 0x100;
            const MAP__GIGUNA_BREACH__PEAK__SAVE = 0x200;
            const MAP__GIGUNA_BREACH__SW_SAVE__SAVE = 0x400;
            const MAP__GIGUNA__GIGUNA_NORTHEAST__SAVE = 0x800;
            const MAP__GIGUNA__GIGUNA_BASE__SAVE = 0x1000;
            const MAP__GIGUNA__RUINS_WEST__SAVE = 0x2000;
            const MAP__GIGUNA__RUINS_TOP__SAVE = 0x4000;
            const MAP__IRIKAR_BREACH__SAVE_ROOM__SAVE = 0x8000;
            const MAP__IRIKAR_BREACH__GAUNTLET__SAVE = 0x10000;
            const MAP__IRIKAR_BREACH__BASEMENT_SAVE__SAVE = 0x20000;
            const MAP__IRIKAR__HUB__SAVE = 0x40000;
            const MAP__UHRUM__WEST_ENTRANCE__SAVE = 0x80000;
            const MAP__UHRUM__SAVE_ROOM__SAVE = 0x100000;
            const MAP__UHRUM__ANNUNA_CORRIDOR__SAVE = 0x200000;
            const AMAGI__MAIN_AREA__CTX__COMBO = 0x400000;
            const ANNUNA__WEST_BRIDGE__CTX__DOORS_OPENED = 0x800000;
            const ANNUNA__EAST_BRIDGE__CTX__COMBO = 0x1000000;
            const EBIH__BASE_CAMP__CTX__LEFT_PLATFORM_MOVED = 0x2000000;
            const EBIH__GRID_25_10_12__CTX__DOOR_OPEN = 0x4000000;
            const EBIH__WATERFALL__CTX__WEST_DOOR_OPEN = 0x8000000;
            const EBIH__EBIH_WEST__CTX__DOOR_OPEN = 0x10000000;
            const EBIH__EBIH_EAST__CTX__PLATFORM1_MOVED = 0x20000000;
            const EBIH__EBIH_EAST__CTX__PLATFORM2_MOVED = 0x40000000;
            const EBIH__DRONE_ROOM__CTX__PLATFORM_MOVED = 0x80000000;
            const EBIH__VERTICAL_INTERCHANGE__CTX__DOOR_OPEN = 0x100000000;
            const GIGUNA_BREACH__SW_SAVE__CTX__DOOR_OPENED = 0x200000000;
            const GIGUNA__GIGUNA_NORTHEAST__CTX__DOOR_OPENED = 0x400000000;
            const GIGUNA__CARNELIAN__CTX__DOOR_OPENED = 0x800000000;
            const GIGUNA__CARNELIAN__CTX__UPPER_SUSAR = 0x1000000000;
            const GIGUNA__CARNELIAN__CTX__LOWER_SUSAR = 0x2000000000;
            const GIGUNA__WEST_CAVERNS__CTX__EAST_SUSAR = 0x4000000000;
            const GIGUNA__GIGUNA_BASE__CTX__DOOR_OPEN = 0x8000000000;
            const GIGUNA__RUINS_WEST__CTX__KISHIB_HANDLED = 0x10000000000;
            const GIGUNA__RUINS_TOP__CTX__DOORS_OPEN = 0x20000000000;
            const GIGUNA__CLOUDS__CTX__PLATFORM_AND_PORTAL = 0x40000000000;
            const GIGUNA__EAST_CAVERNS__CTX__DOOR_OPENED = 0x80000000000;
            const GIGUNA__EAST_CAVERNS__CTX__COMBO_ENTERED = 0x100000000000;
            const GIGUNA__EAST_CAVERNS__CTX__UPPER_SUSAR = 0x200000000000;
            const GIGUNA__EAST_CAVERNS__CTX__MID_SUSAR = 0x400000000000;
            const GIGUNA__EAST_CAVERNS__CTX__LOWER_SUSAR = 0x800000000000;
            const GIGUNA__GATEWAY__CTX__DOOR_OPENED = 0x1000000000000;
            const IRIKAR__BASEMENT_PORTAL__CTX__PLATFORM_MOVED = 0x2000000000000;
            const BOOMERANG_STEERING = 0x4000000000000;
            const MAJOR_GLITCHES = 0x8000000000000;
            const MINOR_GLITCHES = 0x10000000000000;
            const AMAGI_DRAGON_EYE_PASSAGE = 0x20000000000000;
            const AMAGI_STRONGHOLD_BOULDER_1 = 0x40000000000000;
            const AMAGI_STRONGHOLD_BOULDER_2 = 0x80000000000000;
            const AMAGI_STRONGHOLD_WALL_1 = 0x100000000000000;
            const AMAGI_STRONGHOLD_WALL_2 = 0x200000000000000;
            const AMAGI_WEST_LAKE_SURFACE_WALL = 0x400000000000000;
            const AMASHILAMA = 0x800000000000000;
            const ANNUNA_EAST_BRIDGE_GATE = 0x1000000000000000;
            const ANNUNA_MIRROR_MATCH_SWITCH = 0x2000000000000000;
            const ANUMAN = 0x4000000000000000;
            const APOCALYPSE_BOMB = 0x8000000000000000;
        }
    }
    bitflags! {
        #[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
        pub struct ContextBits2 : u64 {
            const BIG_FLASK = 0x1;
            const BOOMERANG = 0x2;
            const BREACH_ATTRACTOR = 0x4;
            const BREACH_SIGHT = 0x8;
            const BRONZE_AXE = 0x10;
            const BUILDING_OF_THE_SCHOOL = 0x20;
            const COMMEMORATIVE_SPEECH = 0x40;
            const COMPANIES_LAYOFF = 0x80;
            const COMPASS = 0x100;
            const DANGEROUS_IDEAS = 0x200;
            const DEAR_ERNEST = 0x400;
            const DEFEAT_INDRA = 0x800;
            const DEFEAT_MUS_A_M20 = 0x1000;
            const DRONE_HOVER = 0x2000;
            const DRONE_MELEE_DAMAGE = 0x4000;
            const DRONE_MELEE_DAMAGE_2 = 0x8000;
            const DRONE_MELEE_SPEED = 0x10000;
            const DRONE_MELEE_SPEED_2 = 0x20000;
            const EBIH_ALU = 0x40000;
            const EBIH_INTERCHANGE_BLOCK = 0x80000;
            const EBIH_INTERCHANGE_GATE = 0x100000;
            const EBIH_WASTELAND_DOOR = 0x200000;
            const EBIH_WASTELAND_PASSAGE_H = 0x400000;
            const EBIH_WATERFALL_BLOCK_LEFT = 0x800000;
    ...
    bitflags! {
        ...
        pub struct ContextBits3 : u64 {
            ...
            const VISITED_AMAGI__MAIN_AREA__WAY_OFF_TO_THE_SIDE__ITEM = 0x100000000;
            const VISITED_AMAGI__WEST_LAKE__CAVERN_EYE__ITEM = 0x200000000;
            const VISITED_AMAGI__WEST_LAKE__CAVERN_REAR_PILLAR__BOSS_REWARD = 0x400000000;
            const VISITED_AMAGI__WEST_LAKE__CAVERN_REFILL_STATION__BREAK_WALL = 0x800000000;
            const VISITED_AMAGI__WEST_LAKE__CAVERN_REFILL_STATION__DEFEAT_MUS_A_M20 = 0x1000000000;
            const VISITED_AMAGI__WEST_LAKE__CAVERN_TEAR_DUCT__REMOTE_FLASK = 0x2000000000;
            const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_CEILING_LEFT__KNOCK_DOWN_LEFT_BOULDER = 0x4000000000;
            const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_CEILING_RIGHT__KNOCK_DOWN_RIGHT_BOULDER = 0x8000000000;
            const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_FRONT_DOOR__BREAK_WALL = 0x10000000000;
            const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_FRONT_ROOM__BREAK_WALL = 0x20000000000;
            const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__BREAK_WALL = 0x40000000000;
            const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__ITEM = 0x80000000000;
            const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_MIDDLE_COLUMN__BREAK_WALL = 0x100000000000;
            const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_REAR_WALL__BREAK_LEFT_WALL = 0x200000000000;
            const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_TOP__REMOTE_URN = 0x400000000000;
            const VISITED_AMAGI__WEST_LAKE__SURFACE_WALL_LEFT__BREAK_WALL = 0x800000000000;
            const VISITED_AMAGI__WEST_LAKE__SURFACE_WALL_RIGHT__BREAK_WALL = 0x1000000000000;
            const VISITED_ANNUNA__EAST_BRIDGE__BELOW_GATE_BUTTON__SWITCH_FROM_BELOW = 0x2000000000000;
            const VISITED_ANNUNA__EAST_BRIDGE__GATE_BUTTON__SWITCH = 0x4000000000000;
            const VISITED_ANNUNA__EAST_BRIDGE__TOWER_GATE__TABLET = 0x8000000000000;
            const VISITED_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM = 0x10000000000000;
            const VISITED_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH = 0x20000000000000;
            const VISITED_ANNUNA__MIRROR_MATCH__EAST_26_LOWER__REMOTE_FLASK = 0x40000000000000;
            const VISITED_ANNUNA__MIRROR_MATCH__EAST_26_UPPER__REMOTE_FLASK = 0x80000000000000;
            const VISITED_ANNUNA__MIRROR_MATCH__PLINTH__ITEM = 0x100000000000000;
            const VISITED_ANNUNA__MIRROR_MATCH__SAVE_POINT__FIGHT = 0x200000000000000;
            const VISITED_ANNUNA__MIRROR_MATCH__WAVING_DISTANCE__SHOCKWAVE_FLASK = 0x400000000000000;
            const VISITED_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP = 0x800000000000000;
            const VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM = 0x1000000000000000;
            const VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_EAST__BREAK_INNER_WALL = 0x2000000000000000;
            const VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_WEST__BREAK_INNER_WALL = 0x4000000000000000;
            const VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_EAST__BREAK_OUTER_WALL = 0x8000000000000000;
    ...
    bitflags! {
        ...
        pub struct ContextBits4 : u64 {
            const VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_WEST__BREAK_OUTER_WALL = 0x1;
            const VISITED_ANNUNA__SNIPER_VALLEY__TABLE__ITEM = 0x2;
            const VISITED_ANNUNA__WEST_BRIDGE__PLINTH__ITEM = 0x4;
            const VISITED_ANTARCTICA__BUILDING_2__BEHIND_BOXES__NOTE = 0x8;
            const VISITED_ANTARCTICA__POWER_ROOM__SWITCH__FLIP = 0x10;
            const VISITED_ANTARCTICA__SHED__INTERIOR__SHELF = 0x20;
            const VISITED_EBIH__BASE_CAMP__LEFT_PLATFORM_MOVED__ITEM_FROM_THE_SIDE = 0x40;
            const VISITED_EBIH__BASE_CAMP__TOP_PLATFORM__ITEM = 0x80;
            const VISITED_EBIH__BOSS_ROOM__BOSS__BOSS_REWARD = 0x100;
            const VISITED_EBIH__BOSS_ROOM__BOSS__FIGHT_ALU = 0x200;
            const VISITED_EBIH__BOSS_ROOM__BOSS__HACK_ALU = 0x400;
            const VISITED_EBIH__BOSS_ROOM__EAST_LEDGE__ITEM = 0x800;
            const VISITED_EBIH__BY_GARAGE__CRAWLSPACE__FRAGMENT = 0x1000;
            const VISITED_EBIH__DRONE_ROOM__ITEM__URN = 0x2000;
            const VISITED_EBIH__DRONE_ROOM__MIDDLE_PLATFORM__URN_QUICK_GRAB = 0x4000;
            const VISITED_EBIH__EBIH_EAST__CORNER__URN = 0x8000;
            const VISITED_EBIH__EBIH_EAST__DISPENSER__VEND = 0x10000;
            const VISITED_EBIH__EBIH_EAST__EAST_LEDGE__NOTE = 0x20000;
            const VISITED_EBIH__EBIH_EAST__LOWER_MOVING_PLATFORM__REMOTE_URN = 0x40000;
            const VISITED_EBIH__EBIH_WEST__ALCOVE__TABLET = 0x80000;
            const VISITED_EBIH__EBIH_WEST__BLOCK_LEFT__BREAK_BLOCK = 0x100000;
            const VISITED_EBIH__EBIH_WEST__BLOCK_RIGHT__BREAK_BLOCK = 0x200000;
            const VISITED_EBIH__GRID_25_10_12__EAST_10__REMOTE_BUSH = 0x400000;
            const VISITED_EBIH__GRID_25_10_12__HIDDEN_BUSH__BEHIND_BUSH = 0x800000;
            const VISITED_EBIH__GRID_25_2_6__PIT__ITEM = 0x1000000;
            const VISITED_EBIH__GRID_26_10_11__LEDGE__NOTE = 0x2000000;
            const VISITED_EBIH__VERTICAL_INTERCHANGE__SWITCH__ACTIVATE_SWITCH = 0x4000000;
            const VISITED_EBIH__WATERFALL__ALCOVE_LEFT__BLOCK_LEFT = 0x8000000;
            const VISITED_EBIH__WATERFALL__ALCOVE_RIGHT__BLOCK_RIGHT = 0x10000000;
            const VISITED_EBIH__WATERFALL__ALCOVE__BLOCK_LEFT = 0x20000000;
            const VISITED_EBIH__WATERFALL__ALCOVE__BLOCK_RIGHT = 0x40000000;
            const VISITED_EBIH__WATERFALL__ALCOVE__PEDESTAL = 0x80000000;
            const VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_THROUGH_WALL = 0x100000000;
            const VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL = 0x200000000;
            const VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL = 0x400000000;
            const VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL = 0x800000000;
            const VISITED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS = 0x1000000000;
            const VISITED_GIGUNA_BREACH__CHIMNEY__CACHE__FLASK = 0x2000000000;
            const VISITED_GIGUNA_BREACH__CUBBY__ROCKS__HEALTH = 0x4000000000;
            const VISITED_GIGUNA_BREACH__SLINGSHOT__RAVINE__URN = 0x8000000000;
            const VISITED_GIGUNA__ANTECHAMBER__STATUE_HEAD__TABLET = 0x10000000000;
            const VISITED_GIGUNA__CARNELIAN__VAULT__ITEM = 0x20000000000;
            const VISITED_GIGUNA__CLOUDS__CACHE__ITEM = 0x40000000000;
            const VISITED_GIGUNA__DUAL_PATH__BASE_OF_WALL__BREAK_WALL = 0x80000000000;
            const VISITED_GIGUNA__DUAL_PATH__BASE_OF_WALL__MIST_INTO_WALL = 0x100000000000;
            const VISITED_GIGUNA__DUAL_PATH__BELOW_LEFT_SWITCH__REMOTE_SWITCH = 0x200000000000;
            const VISITED_GIGUNA__DUAL_PATH__BELOW_RIGHT_SWITCH__REMOTE_SWITCH = 0x400000000000;
            const VISITED_GIGUNA__DUAL_PATH__LEFT_SWITCH__HIT_SWITCH = 0x800000000000;
            const VISITED_GIGUNA__DUAL_PATH__RIGHT_SWITCH__HIT_SWITCH = 0x1000000000000;
            const VISITED_GIGUNA__DUAL_PATH__WALL_SECRET__HEALTH = 0x2000000000000;
            const VISITED_GIGUNA__EAST_CAVERNS__HIDDEN_PASSAGE_CENTER__HIDDEN_FLASK = 0x4000000000000;
            const VISITED_GIGUNA__FAR_CORNER__GRASS__OBSCURED_ITEM = 0x8000000000000;
            const VISITED_GIGUNA__GATEWAY__BLOCK_LEFT__SHOCKWAVE = 0x10000000000000;
            const VISITED_GIGUNA__GATEWAY__BLOCK_RIGHT__SHOCKWAVE = 0x20000000000000;
            const VISITED_GIGUNA__GATEWAY__BUTTON__HIT_SWITCH = 0x40000000000000;
            const VISITED_GIGUNA__GATEWAY__FLASK_LEDGE__ITEM = 0x80000000000000;
            const VISITED_GIGUNA__GIGUNA_BASE__RUIN__ITEM = 0x100000000000000;
            const VISITED_GIGUNA__GIGUNA_BASE__TABLE__NEWS = 0x200000000000000;
            const VISITED_GIGUNA__GIGUNA_NORTHEAST__DOOR__REMOTE_FLASK = 0x400000000000000;
            const VISITED_GIGUNA__GIGUNA_NORTHEAST__GATE_BUTTON__OPEN_GATE = 0x800000000000000;
            const VISITED_GIGUNA__GIGUNA_NORTHEAST__GATE_RIGHT__REMOTE_BUTTON = 0x1000000000000000;
            const VISITED_GIGUNA__GIGUNA_NORTHEAST__VAULT__ITEM = 0x2000000000000000;
            const VISITED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__BOSS_REWARD = 0x4000000000000000;
            const VISITED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__FIGHT_GUBI = 0x8000000000000000;
    ...
    bitflags! {
        ...
        pub struct ContextBits5 : u64 {
            const VISITED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__HACK_GUBI = 0x1;
            const VISITED_GIGUNA__GUBI_LAIR__PEDESTAL__AXE = 0x2;
            const VISITED_GIGUNA__HARD_ROCK__ROCK_CENTER__TABLET = 0x4;
            const VISITED_GIGUNA__HARD_ROCK__ROCK_LEFT__ENTER_ROCK_AS_MIST = 0x8;
            const VISITED_GIGUNA__HARD_ROCK__ROCK_LEFT__SHOCKWAVE_BOULDER = 0x10;
            const VISITED_GIGUNA__HARD_ROCK__ROCK_RIGHT__ENTER_ROCK_AS_MIST = 0x20;
            const VISITED_GIGUNA__HARD_ROCK__ROCK_RIGHT__SHOCKWAVE_BOULDER = 0x40;
            const VISITED_GIGUNA__HELIPAD__TABLET_LEDGE__TABLET = 0x80;
            const VISITED_GIGUNA__LAMASSU__DEPOSIT__FLASK = 0x100;
            const VISITED_GIGUNA__RUINS_CENTER__TABLET__ITEM = 0x200;
            const VISITED_GIGUNA__RUINS_EAST__WAY_UP_HIGH__ITEM = 0x400;
            const VISITED_GIGUNA__RUINS_TOP__FLASK__FLASK = 0x800;
            const VISITED_GIGUNA__RUINS_TOP__SMALL_LEDGE__SHOCKWAVE_FLASK = 0x1000;
            const VISITED_GIGUNA__WASTELAND__DOOR_RIGHT__HEALTH = 0x2000;
            const VISITED_GIGUNA__WASTELAND__PASSAGE_CACHE__CLEAR_HORIZONTAL_PASSAGE_MANUALLY = 0x4000;
            const VISITED_GIGUNA__WASTELAND__PASSAGE_CACHE__MIST_THROUGH_HORIZONTAL_PASSAGE = 0x8000;
            const VISITED_GIGUNA__WASTELAND__PASSAGE_EAST__CLEAR_HORIZONTAL_PASSAGE_MANUALLY = 0x10000;
            const VISITED_GIGUNA__WASTELAND__PASSAGE_EAST__MIST_THROUGH_HORIZONTAL_PASSAGE = 0x20000;
            const VISITED_GIGUNA__WEST_CAVERNS__BUSH__ITEM = 0x40000;
            const VISITED_GIGUNA__WEST_CAVERNS__CACHE__ITEM = 0x80000;
            const VISITED_GIGUNA__WEST_TOWER__TOP__TABLET = 0x100000;
            const VISITED_GLACIER__APOCALYPSE_ENTRY__TERMINAL__ESCAPE = 0x200000;
            const VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__ITEM = 0x400000;
            const VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__SWITCH = 0x800000;
            const VISITED_GLACIER__COMPASS_ROOM__CENTER__TABLE = 0x1000000;
            const VISITED_GLACIER__LEDGE_GRAB_ROOM__CLIFF_BOTTOM__QUICK_GRAB = 0x2000000;
            const VISITED_GLACIER__LEDGE_GRAB_ROOM__PEDESTAL__ITEM = 0x4000000;
            const VISITED_GLACIER__THE_BIG_DROP__WATER_SURFACE__DROWN = 0x8000000;
            const VISITED_GLACIER__VERTICAL_ROOM__PEAK__FLASK = 0x10000000;
            const VISITED_GLACIER__VERTICAL_ROOM__UNDER_SWITCH__SWITCH = 0x20000000;
            const VISITED_INTERIOR__BUILDING_INTERIOR__CORNER__URN = 0x40000000;
            const VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__REMOTE_URN = 0x80000000;
            const VISITED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE = 0x100000000;
            const VISITED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH = 0x200000000;
            const VISITED_INTERIOR__GARAGE__BOXES__UNDER_BOXES = 0x400000000;
            const VISITED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE = 0x800000000;
            const VISITED_INTERIOR__TENT_INTERIOR__DESK__NOTE = 0x1000000000;
            const VISITED_IRIKAR_BREACH__GAUNTLET__HIDDEN_PATH_REWARD__ITEM = 0x2000000000;
            const VISITED_IRIKAR_BREACH__HOVER_ROOM__BOTTOM__ITEM = 0x4000000000;
            const VISITED_IRIKAR_BREACH__WORM_RAVE__CORNER__ITEM = 0x8000000000;
            const VISITED_IRIKAR__ABANDONED_ROOM__CORNER_CORE__CORE = 0x10000000000;
            const VISITED_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP = 0x20000000000;
            const VISITED_IRIKAR__BOSS_ROOM__BULLS_FEET__BOSS_REWARD = 0x40000000000;
            const VISITED_IRIKAR__BOSS_ROOM__BULLS_FEET__DEFEAT_GUDAM = 0x80000000000;
            const VISITED_IRIKAR__BOSS_ROOM__BULLS_FEET__SHOCKWAVE_GUDAM = 0x100000000000;
            const VISITED_IRIKAR__BOSS_ROOM__HEALTHY_ROOFTOP__HEALTH = 0x200000000000;
            const VISITED_IRIKAR__EAST_ROOFTOPS__TOP_ROOFTOP__TABLET = 0x400000000000;
            const VISITED_IRIKAR__HUB__DAGGER_ALTAR__WEAPON = 0x800000000000;
            const VISITED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__MIST_INTO_WALL = 0x1000000000000;
            const VISITED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__SHOCKWAVE_WALL = 0x2000000000000;
            const VISITED_IRIKAR__HUB__ROYAL_STORAGE_IN_WALL__ITEM = 0x4000000000000;
            const VISITED_IRIKAR__HUB__SAT_TOWER_TOP_LEDGE__TABLET = 0x8000000000000;
            const VISITED_IRIKAR__LAMASSU__DESK__ITEM = 0x10000000000000;
            const VISITED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN = 0x20000000000000;
            const VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_1 = 0x40000000000000;
            const VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_2 = 0x80000000000000;
            const VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_3 = 0x100000000000000;
            const VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_1 = 0x200000000000000;
            const VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_2 = 0x400000000000000;
            const VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_3 = 0x800000000000000;
            const VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_1 = 0x1000000000000000;
            const VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_2 = 0x2000000000000000;
            const VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_3 = 0x4000000000000000;
            const VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_1 = 0x8000000000000000;
            const ALL_VISIT_FLAGS = 0xffffffffffffffff;
        }
    }
    bitflags! {
        ...
        pub struct ContextBits6 : u64 {
            const VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_2 = 0x1;
            const VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_3 = 0x2;
            const VISITED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_1 = 0x4;
            const VISITED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_2 = 0x8;
            const VISITED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_3 = 0x10;
            const VISITED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_1 = 0x20;
            const VISITED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_2 = 0x40;
            const VISITED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_3 = 0x80;
            const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_1 = 0x100;
            const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_2 = 0x200;
            const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_3 = 0x400;
            const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_1 = 0x800;
            const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_2 = 0x1000;
            const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_3 = 0x2000;
            const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_SPEED_1 = 0x4000;
            const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_SPEED_2 = 0x8000;
            const VISITED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_1 = 0x10000;
            const VISITED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_2 = 0x20000;
            const VISITED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_3 = 0x40000;
            const VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_1 = 0x80000;
            const VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_2 = 0x100000;
            const VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_3 = 0x200000;
            const VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_4 = 0x400000;
            const VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_5 = 0x800000;
            const VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__MIST_UPGRADE = 0x1000000;
            const VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_EAST__DISLODGE_BLOCK = 0x2000000;
            const VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_WEST__DISLODGE_BLOCK = 0x4000000;
            const VISITED_UHRUM__ANNUNA_CORRIDOR__EAST_CUBBY__TABLET = 0x8000000;
            const VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN = 0x10000000;
            const VISITED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM = 0x20000000;
            const VISITED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN = 0x40000000;
            const VISITED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX = 0x80000000;
            const VISITED_UHRUM__SIEGE_CORRIDOR__POND__ITEM = 0x100000000;
            const VISITED_UHRUM__SIEGE_CORRIDOR__UPPER_ROCK_ITEM__URN = 0x200000000;
            const VISITED_UHRUM__SIEGE_CORRIDOR__WESTERN_CACHE__CORE = 0x400000000;
            const VISITED_UHRUM__WATERFALLS__ABOVE_BLOCK__BLOCK = 0x800000000;
            const VISITED_UHRUM__WATERFALLS__BARRIER_EAST__CHARGE_THROUGH_WALL = 0x1000000000;
            const VISITED_UHRUM__WATERFALLS__BARRIER_EAST__MIST_THROUGH_WALL = 0x2000000000;
            const VISITED_UHRUM__WATERFALLS__BARRIER_EAST__SPIN_THROUGH_WALL = 0x4000000000;
            const VISITED_UHRUM__WATERFALLS__BARRIER_WEST__CHARGE_THROUGH_WALL = 0x8000000000;
            const VISITED_UHRUM__WATERFALLS__BARRIER_WEST__MIST_THROUGH_WALL = 0x10000000000;
            const VISITED_UHRUM__WATERFALLS__BARRIER_WEST__SPIN_THROUGH_WALL = 0x20000000000;
            const VISITED_UHRUM__WATERFALLS__BELOW_BLOCK__SHOCKWAVE_BLOCK = 0x40000000000;
            const VISITED_UHRUM__WATERFALLS__CEILING_CACHE__FLASK = 0x80000000000;
            const VISITED_UHRUM__WATERFALLS__EAST_26__BLOCK = 0x100000000000;
            const VISITED_UHRUM__WATERFALLS__WEST_WATER_NOOK__TABLET = 0x200000000000;
            const VISITED_UHRUM__WEST_ENTRANCE__GATE_SWITCH__OPEN_GATE = 0x400000000000;
            const VISITED_UHRUM__WEST_ENTRANCE__INNER_DAIS__ITEM = 0x800000000000;
            const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__CHARGE_THROUGH_WALL = 0x1000000000000;
            const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__MIST_THROUGH_WALL = 0x2000000000000;
            const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__SPIN_THROUGH_WALL = 0x4000000000000;
            const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__CHARGE_THROUGH_WALL = 0x8000000000000;
            const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__MIST_THROUGH_WALL = 0x10000000000000;
            const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__SPIN_THROUGH_WALL = 0x20000000000000;
            const VISITED_UHRUM__WEST_ENTRANCE__SAND__REFILL = 0x40000000000000;
            const VISITED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__CHARGE_THROUGH_WALL = 0x80000000000000;
            const VISITED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__MIST_THROUGH_WALL = 0x100000000000000;
            const VISITED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__SPIN_THROUGH_WALL = 0x200000000000000;
            const VISITED_UHRUM__WEST_ENTRANCE__UPPER_WALL_WEST__MIST_THROUGH_WALL = 0x400000000000000;
            const SKIPPED_AMAGI__LIRU_ROOM__SHRINE__ITEM = 0x800000000000000;
            const SKIPPED_AMAGI__MAIN_AREA__WAY_OFF_TO_THE_SIDE__ITEM = 0x1000000000000000;
            const SKIPPED_AMAGI__WEST_LAKE__CAVERN_EYE__ITEM = 0x2000000000000000;
            const SKIPPED_AMAGI__WEST_LAKE__CAVERN_REAR_PILLAR__BOSS_REWARD = 0x4000000000000000;
            const SKIPPED_AMAGI__WEST_LAKE__CAVERN_REFILL_STATION__BREAK_WALL = 0x8000000000000000;
            const ALL_VISIT_FLAGS = 0x7ffffffffffffff;
            const ALL_SKIP_FLAGS = 0xf800000000000000;
        }
    }
    bitflags! {
        #[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
        pub struct ContextBits7 : u64 {
            const SKIPPED_AMAGI__WEST_LAKE__CAVERN_REFILL_STATION__DEFEAT_MUS_A_M20 = 0x1;
            const SKIPPED_AMAGI__WEST_LAKE__CAVERN_TEAR_DUCT__REMOTE_FLASK = 0x2;
            const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_CEILING_LEFT__KNOCK_DOWN_LEFT_BOULDER = 0x4;
            const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_CEILING_RIGHT__KNOCK_DOWN_RIGHT_BOULDER = 0x8;
            const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_FRONT_DOOR__BREAK_WALL = 0x10;
            const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_FRONT_ROOM__BREAK_WALL = 0x20;
            const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__BREAK_WALL = 0x40;
            const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__ITEM = 0x80;
            const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_MIDDLE_COLUMN__BREAK_WALL = 0x100;
            const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_REAR_WALL__BREAK_LEFT_WALL = 0x200;
            const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_TOP__REMOTE_URN = 0x400;
            const SKIPPED_AMAGI__WEST_LAKE__SURFACE_WALL_LEFT__BREAK_WALL = 0x800;
            const SKIPPED_AMAGI__WEST_LAKE__SURFACE_WALL_RIGHT__BREAK_WALL = 0x1000;
            const SKIPPED_ANNUNA__EAST_BRIDGE__BELOW_GATE_BUTTON__SWITCH_FROM_BELOW = 0x2000;
            const SKIPPED_ANNUNA__EAST_BRIDGE__GATE_BUTTON__SWITCH = 0x4000;
            const SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_GATE__TABLET = 0x8000;
            const SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM = 0x10000;
            const SKIPPED_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH = 0x20000;
            const SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_LOWER__REMOTE_FLASK = 0x40000;
            const SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_UPPER__REMOTE_FLASK = 0x80000;
            const SKIPPED_ANNUNA__MIRROR_MATCH__PLINTH__ITEM = 0x100000;
            const SKIPPED_ANNUNA__MIRROR_MATCH__SAVE_POINT__FIGHT = 0x200000;
            const SKIPPED_ANNUNA__MIRROR_MATCH__WAVING_DISTANCE__SHOCKWAVE_FLASK = 0x400000;
            const SKIPPED_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP = 0x800000;
            const SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM = 0x1000000;
            const SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_EAST__BREAK_INNER_WALL = 0x2000000;
            const SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_WEST__BREAK_INNER_WALL = 0x4000000;
            const SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_EAST__BREAK_OUTER_WALL = 0x8000000;
            const SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_WEST__BREAK_OUTER_WALL = 0x10000000;
            const SKIPPED_ANNUNA__SNIPER_VALLEY__TABLE__ITEM = 0x20000000;
            const SKIPPED_ANNUNA__WEST_BRIDGE__PLINTH__ITEM = 0x40000000;
            const SKIPPED_ANTARCTICA__BUILDING_2__BEHIND_BOXES__NOTE = 0x80000000;
            const SKIPPED_ANTARCTICA__POWER_ROOM__SWITCH__FLIP = 0x100000000;
            const SKIPPED_ANTARCTICA__SHED__INTERIOR__SHELF = 0x200000000;
            const SKIPPED_EBIH__BASE_CAMP__LEFT_PLATFORM_MOVED__ITEM_FROM_THE_SIDE = 0x400000000;
            const SKIPPED_EBIH__BASE_CAMP__TOP_PLATFORM__ITEM = 0x800000000;
            const SKIPPED_EBIH__BOSS_ROOM__BOSS__BOSS_REWARD = 0x1000000000;
            const SKIPPED_EBIH__BOSS_ROOM__BOSS__FIGHT_ALU = 0x2000000000;
            const SKIPPED_EBIH__BOSS_ROOM__BOSS__HACK_ALU = 0x4000000000;
            const SKIPPED_EBIH__BOSS_ROOM__EAST_LEDGE__ITEM = 0x8000000000;
            const SKIPPED_EBIH__BY_GARAGE__CRAWLSPACE__FRAGMENT = 0x10000000000;
            const SKIPPED_EBIH__DRONE_ROOM__ITEM__URN = 0x20000000000;
            const SKIPPED_EBIH__DRONE_ROOM__MIDDLE_PLATFORM__URN_QUICK_GRAB = 0x40000000000;
            const SKIPPED_EBIH__EBIH_EAST__CORNER__URN = 0x80000000000;
            const SKIPPED_EBIH__EBIH_EAST__DISPENSER__VEND = 0x100000000000;
            const SKIPPED_EBIH__EBIH_EAST__EAST_LEDGE__NOTE = 0x200000000000;
            const SKIPPED_EBIH__EBIH_EAST__LOWER_MOVING_PLATFORM__REMOTE_URN = 0x400000000000;
            const SKIPPED_EBIH__EBIH_WEST__ALCOVE__TABLET = 0x800000000000;
            const SKIPPED_EBIH__EBIH_WEST__BLOCK_LEFT__BREAK_BLOCK = 0x1000000000000;
            const SKIPPED_EBIH__EBIH_WEST__BLOCK_RIGHT__BREAK_BLOCK = 0x2000000000000;
            const SKIPPED_EBIH__GRID_25_10_12__EAST_10__REMOTE_BUSH = 0x4000000000000;
            const SKIPPED_EBIH__GRID_25_10_12__HIDDEN_BUSH__BEHIND_BUSH = 0x8000000000000;
            const SKIPPED_EBIH__GRID_25_2_6__PIT__ITEM = 0x10000000000000;
            const SKIPPED_EBIH__GRID_26_10_11__LEDGE__NOTE = 0x20000000000000;
            const SKIPPED_EBIH__VERTICAL_INTERCHANGE__SWITCH__ACTIVATE_SWITCH = 0x40000000000000;
            const SKIPPED_EBIH__WATERFALL__ALCOVE_LEFT__BLOCK_LEFT = 0x80000000000000;
            const SKIPPED_EBIH__WATERFALL__ALCOVE_RIGHT__BLOCK_RIGHT = 0x100000000000000;
            const SKIPPED_EBIH__WATERFALL__ALCOVE__BLOCK_LEFT = 0x200000000000000;
            const SKIPPED_EBIH__WATERFALL__ALCOVE__BLOCK_RIGHT = 0x400000000000000;
            const SKIPPED_EBIH__WATERFALL__ALCOVE__PEDESTAL = 0x800000000000000;
            const SKIPPED_EBIH__WATERFALL__WALL_LEFT__BREAK_THROUGH_WALL = 0x1000000000000000;
            const SKIPPED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL = 0x2000000000000000;
            const SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL = 0x4000000000000000;
            const SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL = 0x8000000000000000;
    ...
    bitflags! {
        ...
        pub struct ContextBits8 : u64 {
            const SKIPPED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS = 0x1;
            const SKIPPED_GIGUNA_BREACH__CHIMNEY__CACHE__FLASK = 0x2;
            const SKIPPED_GIGUNA_BREACH__CUBBY__ROCKS__HEALTH = 0x4;
            const SKIPPED_GIGUNA_BREACH__SLINGSHOT__RAVINE__URN = 0x8;
            const SKIPPED_GIGUNA__ANTECHAMBER__STATUE_HEAD__TABLET = 0x10;
            ...
            const SKIPPED_INTERIOR__BUILDING_INTERIOR__CORNER__URN = 0x400000000000000;
            const SKIPPED_INTERIOR__BUILDING_INTERIOR__ENTRY__REMOTE_URN = 0x800000000000000;
            const SKIPPED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE = 0x1000000000000000;
            const SKIPPED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH = 0x2000000000000000;
            const SKIPPED_INTERIOR__GARAGE__BOXES__UNDER_BOXES = 0x4000000000000000;
            const SKIPPED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE = 0x8000000000000000;
            const ALL_SKIP_FLAGS = 0xffffffffffffffff;
        }
    }
    bitflags! {
        ...
        pub struct ContextBits9 : u64 {
            const SKIPPED_INTERIOR__TENT_INTERIOR__DESK__NOTE = 0x1;
            const SKIPPED_IRIKAR_BREACH__GAUNTLET__HIDDEN_PATH_REWARD__ITEM = 0x2;
            const SKIPPED_IRIKAR_BREACH__HOVER_ROOM__BOTTOM__ITEM = 0x4;
            const SKIPPED_IRIKAR_BREACH__WORM_RAVE__CORNER__ITEM = 0x8;
            const SKIPPED_IRIKAR__ABANDONED_ROOM__CORNER_CORE__CORE = 0x10;
            const SKIPPED_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP = 0x20;
            ...
            const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_3 = 0x100000000;
            const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_1 = 0x200000000;
            const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_2 = 0x400000000;
            const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_3 = 0x800000000;
            const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_1 = 0x1000000000;
            const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_2 = 0x2000000000;
            const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_3 = 0x4000000000;
            const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_1 = 0x8000000000;
            const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_2 = 0x10000000000;
            const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_3 = 0x20000000000;
            const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_SPEED_1 = 0x40000000000;
            const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_SPEED_2 = 0x80000000000;
            const SKIPPED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_1 = 0x100000000000;
            const SKIPPED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_2 = 0x200000000000;
            const SKIPPED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_3 = 0x400000000000;
            const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_1 = 0x800000000000;
            const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_2 = 0x1000000000000;
            const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_3 = 0x2000000000000;
            const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_4 = 0x4000000000000;
            const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_5 = 0x8000000000000;
            const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__MIST_UPGRADE = 0x10000000000000;
            const SKIPPED_UHRUM__ANNUNA_CORRIDOR__BLOCK_EAST__DISLODGE_BLOCK = 0x20000000000000;
            const SKIPPED_UHRUM__ANNUNA_CORRIDOR__BLOCK_WEST__DISLODGE_BLOCK = 0x40000000000000;
            const SKIPPED_UHRUM__ANNUNA_CORRIDOR__EAST_CUBBY__TABLET = 0x80000000000000;
            const SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN = 0x100000000000000;
            const SKIPPED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM = 0x200000000000000;
            const SKIPPED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN = 0x400000000000000;
...
impl context::Ctx for Context {
    ...
    fn reset(&mut self, loc_id: LocationId) {
        match loc_id {
            ...
            LocationId::Interior__Tent_Interior__Desk__Note => {
                ...
                self.cbits9
                    .remove(flags::ContextBits9::SKIPPED_INTERIOR__TENT_INTERIOR__DESK__NOTE);
            }
            LocationId::Interior__Garage__Boxes__Under_Boxes => {
                self.cbits5
    ...
    fn diff(&self, old: &Context) -> String {
        ...
        let n = self
            .cbits5
            .contains(flags::ContextBits5::VISITED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__HACK_GUBI);
        let p = old
            .cbits5
            .contains(flags::ContextBits5::VISITED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__HACK_GUBI);
        if n != p {
        ...
        let n = self
            .cbits6
            .contains(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_2);
        let p = old
            .cbits6
            .contains(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_2);
        if n != p {
        ...
        let n = self.cbits7.contains(
            flags::ContextBits7::SKIPPED_AMAGI__WEST_LAKE__CAVERN_REFILL_STATION__DEFEAT_MUS_A_M20,
        );
        ...
        let n = self.cbits8.contains(
            flags::ContextBits8::SKIPPED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS,
        );
        ...
        let n = self
            .cbits9
            .contains(flags::ContextBits9::SKIPPED_INTERIOR__TENT_INTERIOR__DESK__NOTE);
        let p = old
            .cbits9
            .contains(flags::ContextBits9::SKIPPED_INTERIOR__TENT_INTERIOR__DESK__NOTE);
        if n != p {
        ...
        let n = self.cbits10.contains(
            flags::ContextBits10::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__CHARGE_THROUGH_WALL,
        );
