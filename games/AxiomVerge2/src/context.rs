...
pub fn flipside(spot_id: SpotId) -> SpotId {
    match spot_id {
        ...
        SpotId::Giguna_Breach__Pink_Clouds__Quick_Entry => SpotId::Giguna__Clouds__Platform_Early,
        SpotId::Giguna__Clouds__Cache => SpotId::Giguna_Breach__Pink_Clouds__Corner,
        SpotId::Giguna__Clouds__Platform_Early => SpotId::Giguna_Breach__Pink_Clouds__Quick_Entry,
