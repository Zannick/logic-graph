...
bitflags!{
    ...
    pub struct ContextBits1 : u64 {
        ...
        const EBIH__TRUCK_GATE__CTX__DOOR_OPEN = 0x2000000000;
        const EBIH__GRID_25_10_12__CTX__DOOR_OPEN = 0x4000000000;
        const EBIH__WATERFALL__CTX__WEST_DOOR_OPEN = 0x8000000000;
        const EBIH__EBIH_WEST__CTX__DOOR_OPEN = 0x10000000000;
        const EBIH__EBIH_EAST__CTX__PLATFORM1_MOVED = 0x20000000000;
        const EBIH__EBIH_EAST__CTX__PLATFORM2_MOVED = 0x40000000000;
        const EBIH__DRONE_ROOM__CTX__PLATFORM_MOVED = 0x80000000000;
        const EBIH__VERTICAL_INTERCHANGE__CTX__DOOR_OPEN = 0x100000000000;
        const GIGUNA_BREACH__SW_SAVE__CTX__DOOR_OPENED = 0x200000000000;
        const GIGUNA__GIGUNA_NORTHEAST__CTX__DOOR_OPENED = 0x400000000000;
        const GIGUNA__CARNELIAN__CTX__DOOR_OPENED = 0x800000000000;
        const GIGUNA__CARNELIAN__CTX__UPPER_SUSAR = 0x1000000000000;
        const GIGUNA__CARNELIAN__CTX__LOWER_SUSAR = 0x2000000000000;
        const GIGUNA__WEST_CAVERNS__CTX__EAST_SUSAR = 0x4000000000000;
        const GIGUNA__GIGUNA_BASE__CTX__DOOR_OPEN = 0x8000000000000;
        const GIGUNA__RUINS_WEST__CTX__KISHIB_HANDLED = 0x10000000000000;
        const GIGUNA__RUINS_TOP__CTX__DOORS_OPEN = 0x20000000000000;
        const GIGUNA__CLOUDS__CTX__PLATFORM = 0x40000000000000;
        const GIGUNA__EAST_CAVERNS__CTX__DOOR_OPENED = 0x80000000000000;
        const GIGUNA__EAST_CAVERNS__CTX__COMBO_ENTERED = 0x100000000000000;
        const GIGUNA__EAST_CAVERNS__CTX__UPPER_SUSAR = 0x200000000000000;
        const GIGUNA__EAST_CAVERNS__CTX__MID_SUSAR = 0x400000000000000;
        const GIGUNA__EAST_CAVERNS__CTX__LOWER_SUSAR = 0x800000000000000;
        const GIGUNA__GATEWAY__CTX__DOOR_OPENED = 0x1000000000000000;
        const GLACIER__THE_BIG_DROP__CTX__BRIDGE_OPEN = 0x2000000000000000;
        const GLACIER__VERTICAL_ROOM__CTX__UPPER_GATESTONE = 0x4000000000000000;
        const GLACIER__VERTICAL_ROOM__CTX__LOWER_GATESTONES = 0x8000000000000000;
    }
}
bitflags!{
    #[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
    pub struct ContextBits2 : u64 {
        const IRIKAR__BASEMENT_PORTAL__CTX__PLATFORM_MOVED = 0x1;
        const IRIKAR__MIDWEST__CTX__LEFT_PLATFORM = 0x2;
        const IRIKAR__MIDWEST__CTX__RIGHT_PLATFORM = 0x4;
        ...
        const ANNUNA_EAST_BRIDGE_GATE = 0x400;
        const ANNUNA_MIRROR_MATCH_SWITCH = 0x800;
        const ANNUNA_VERTICAL_ROOM_GATE = 0x1000;
        const ANUMAN = 0x2000;
        const APOCALYPSE_BOMB = 0x4000;
        const APOCALYPSE_SEALS_WALL = 0x8000;
        const BEWARE_THE_PATTERNMIND = 0x10000;
        const BOOMERANG = 0x20000;
        const BOOMERANG_UPGRADE = 0x40000;
        const BREACH_ATTRACTOR = 0x80000;
        const BREACH_SIGHT = 0x100000;
        const BRONZE_AXE = 0x200000;
        const BUILDING_OF_THE_SCHOOL = 0x400000;
        const COMMEMORATIVE_SPEECH = 0x800000;
        const COMPANIES_LAYOFF = 0x1000000;
        const COMPASS = 0x2000000;
        const DANGEROUS_IDEAS = 0x4000000;
        const DEAR_ERNEST = 0x8000000;
        const DEFEAT_INDRA = 0x10000000;
        const DEFEAT_MUS_A_M20 = 0x20000000;
        const DESTRUCTION_POGROM = 0x40000000;
        const DR_GLORIA = 0x80000000;
        const DRONE_HOVER = 0x100000000;
        const DRONE_MELEE_DAMAGE = 0x200000000;
        const DRONE_MELEE_DAMAGE_2 = 0x400000000;
        const DRONE_MELEE_SPEED = 0x800000000;
        const DRONE_MELEE_SPEED_2 = 0x1000000000;
        const EBIH_ALU = 0x2000000000;
        const EBIH_INTERCHANGE_BLOCK = 0x4000000000;
        const EBIH_INTERCHANGE_GATE = 0x8000000000;
        const EBIH_WALLED_OFF_WALL = 0x10000000000;
        const EBIH_WASTELAND_DOOR = 0x20000000000;
        const EBIH_WASTELAND_PASSAGE_H = 0x40000000000;
        const EBIH_WATERFALL_BLOCK_LEFT = 0x80000000000;
        const EBIH_WATERFALL_BLOCK_RIGHT = 0x100000000000;
        const EBIH_WATERFALL_WALL = 0x200000000000;
        const EBIH_WEST_BLOCK = 0x400000000000;
        const ESCAPE = 0x800000000000;
        const EXIT_BREACH = 0x1000000000000;
        const EYE_RING = 0x2000000000000;
        const FAMILY_TRAGEDY = 0x4000000000000;
        const FAST_TRAVEL = 0x8000000000000;
        const FORBIDDEN_KNOWLEDGE = 0x10000000000000;
        const FREEDOM_FROM_AANSUR = 0x20000000000000;
        const GIGUNA_BOULDER = 0x40000000000000;
        const GIGUNA_DUAL_PATH_SWITCH = 0x80000000000000;
        const GIGUNA_DUAL_PATH_WALL = 0x100000000000000;
        const GIGUNA_GATEWAY_BLOCK = 0x200000000000000;
        const GIGUNA_GATEWAY_GATE = 0x400000000000000;
        const GIGUNA_GUBI = 0x800000000000000;
        const GIGUNA_NORTHEAST_GATE = 0x1000000000000000;
        const GLACIER_BIG_DROP_ROCK = 0x2000000000000000;
        const GLACIER_SEA_BURIAL_ROCK = 0x4000000000000000;
        const GOODBYE = 0x8000000000000000;
    }
}
bitflags!{
    #[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
    pub struct ContextBits3 : u64 {
        const HAMMOND_AUTH = 0x1;
        const HEALTH_UPGRADE = 0x2;
        const HEALTH_UPGRADE_2 = 0x4;
        const HEALTH_UPGRADE_3 = 0x8;
        const HEALTH_UPGRADE_4 = 0x10;
        const HERETICS_TABLET = 0x20;
        const ICE_AXE = 0x40;
        const INFECT = 0x80;
        const INFECT_L1 = 0x100;
        const INFECT_L2 = 0x200;
        const INFECT_L3 = 0x400;
        const INFECTION_RANGE = 0x800;
        const INFECTION_RANGE_2 = 0x1000;
        const INFECTION_RANGE_3 = 0x2000;
        const INFECTION_SPEED = 0x4000;
        const IRIKAR_GUDAM = 0x8000;
        const IRIKAR_ROYAL_STORAGE_WALL = 0x10000;
        const LAMENT_FOR_FOOLS = 0x20000;
        const LEDGE_GRAB = 0x40000;
        const LETTER_FROM_TRACE = 0x80000;
        const MELEE_DAMAGE = 0x100000;
        const MELEE_DAMAGE_2 = 0x200000;
        const MELEE_SPEED = 0x400000;
        const MELEE_SPEED_2 = 0x800000;
        const MIST_UPGRADE = 0x1000000;
        const NANITE_MIST = 0x2000000;
        ...
        const POWER_MATRIX = 0x80000000;
        const RANGED_DAMAGE = 0x100000000;
        const RANGED_DAMAGE_2 = 0x200000000;
        const RANGED_SPEED = 0x400000000;
        const RANGED_SPEED_2 = 0x800000000;
        ...
        const SIUNA_STORAGE_WALL = 0x40000000000;
        const SLINGSHOT_CHARGE = 0x80000000000;
        const SLINGSHOT_HOOK = 0x100000000000;
        const SLINGSHOT_WEAPON = 0x200000000000;
        const SNIPER_VALLEY_ROCK_1 = 0x400000000000;
        const SNIPER_VALLEY_ROCK_2 = 0x800000000000;
        const STATION_POWER = 0x1000000000000;
        const STORM_BOMB = 0x2000000000000;
        const SUSPENSION_BRIDGE = 0x4000000000000;
        const SWITCH_36_11 = 0x8000000000000;
        const SWITCH_40_12 = 0x10000000000000;
        const TERMINAL_BREAKTHROUGH_1 = 0x20000000000000;
        const TERMINAL_BREAKTHROUGH_2 = 0x40000000000000;
        const THE_ETERNAL_ARM = 0x80000000000000;
        const THE_IDEAL_KIENGIR = 0x100000000000000;
        const THE_STUDENT = 0x200000000000000;
        const UHRUM_ANNUNA_CORRIDOR_BLOCK = 0x400000000000000;
        const UHRUM_WATERFALL_WALL = 0x800000000000000;
        const UHRUM_WATERFALLS_BLOCK = 0x1000000000000000;
        const UHRUM_WEST_ENTRANCE_GATE = 0x2000000000000000;
        const UHRUM_WEST_ENTRANCE_LOWER_WALL = 0x4000000000000000;
        const UHRUM_WEST_ENTRANCE_UPPER_WALL = 0x8000000000000000;
    }
}
bitflags!{
    #[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
    pub struct ContextBits4 : u64 {
        const UNDER_SIEGE = 0x1;
        const UNDERWATER_MOVEMENT = 0x2;
        const WALL_CLIMB = 0x4;
        const VISITED_AMAGI_DRAGON_EYE_FLASK = 0x8;
        const VISITED_AMAGI_STRONGHOLD_BOULDER_2 = 0x10;
        const VISITED_AMAGI_STRONGHOLD_LEFT_WALL = 0x20;
        const VISITED_AMAGI_STRONGHOLD_WALL_1 = 0x40;
        const VISITED_AMAGI_STRONGHOLD_WALL_2 = 0x80;
        const VISITED_AMAGI_WEST_LAKE_SURFACE_WALL = 0x100;
        const VISITED_ANNUNA_EAST_BRIDGE_GATE = 0x200;
        const VISITED_ANNUNA_MIRROR_MATCH_FLASK = 0x400;
        const VISITED_ANUMAN = 0x800;
        const VISITED_APOCALYPSE_BOMB = 0x1000;
        const VISITED_APOCALYPSE_SEALS_WALL = 0x2000;
        const VISITED_BREACH_SIGHT = 0x4000;
        const VISITED_EBIH_ALU = 0x8000;
        const VISITED_EBIH_BASE_CAMP_FRAGMENT = 0x10000;
        const VISITED_EBIH_BUSH_FLASK = 0x20000;
        const VISITED_EBIH_WALLED_OFF_WALL = 0x40000;
        const VISITED_EBIH_WASTELAND_PASSAGE_H = 0x80000;
        const VISITED_EBIH_WATERFALL_BLOCK_LEFT = 0x100000;
        const VISITED_EBIH_WATERFALL_BLOCK_RIGHT = 0x200000;
        const VISITED_EBIH_WATERFALL_WALL = 0x400000;
        const VISITED_EBIH_WEST_BLOCK = 0x800000;
        const VISITED_EGG_ROOM_FLASK = 0x1000000;
        const VISITED_ESCAPE = 0x2000000;
        const VISITED_FAST_TRAVEL = 0x4000000;
        const VISITED_FILTER_TELEPORTER_FLASK = 0x8000000;
        const VISITED_GIGUNA_BOULDER = 0x10000000;
        const VISITED_GIGUNA_DUAL_PATH_SWITCH = 0x20000000;
        const VISITED_GIGUNA_DUAL_PATH_WALL = 0x40000000;
        const VISITED_GIGUNA_GATEWAY_BLOCK = 0x80000000;
        const VISITED_GIGUNA_GUBI = 0x100000000;
        const VISITED_GIGUNA_NORTHEAST_FLASK = 0x200000000;
        const VISITED_GIGUNA_NORTHEAST_GATE = 0x400000000;
        const VISITED_GIGUNA_TOP_FLASK = 0x800000000;
        const VISITED_GLACIER_40_8_FLASK = 0x1000000000;
        const VISITED_GLACIER_BIG_DROP_ROCK = 0x2000000000;
        const VISITED_GLACIER_DOCK_FLASK = 0x4000000000;
        const VISITED_GLACIER_SEA_BURIAL_ROCK = 0x8000000000;
        const VISITED_HAMMONDS_NOTE = 0x10000000000;
        const VISITED_INFECT = 0x20000000000;
        const VISITED_IRIKAR_GUDAM = 0x40000000000;
        const VISITED_IRIKAR_MIDWEST_FLASK = 0x80000000000;
        const VISITED_IRIKAR_ROYAL_STORAGE_FLASK = 0x100000000000;
        const VISITED_IRIKAR_ROYAL_STORAGE_WALL = 0x200000000000;
        const VISITED_IRIKAR_WELL_FLASK = 0x400000000000;
        const VISITED_LEDGE_GRAB = 0x800000000000;
        const VISITED_LOC_AMAGI_BREACH__EAST_ENTRANCE__UPPER_SLOPE__ITEM = 0x1000000000000;
        const VISITED_LOC_AMAGI__EAST_LAKE__FOOT__TABLET = 0x2000000000000;
        const VISITED_LOC_AMAGI__LIRU_ROOM__SHRINE__ITEM = 0x4000000000000;
        const VISITED_LOC_AMAGI__MAIN_AREA__WAY_OFF_TO_THE_SIDE__ITEM = 0x8000000000000;
        const VISITED_LOC_AMAGI__WEST_LAKE__CAVERN_REAR_PILLAR__BOSS_REWARD = 0x10000000000000;
        const VISITED_LOC_AMAGI__WEST_LAKE__CAVERN_REFILL_STATION__BREAK_WALL = 0x20000000000000;
        const VISITED_LOC_AMAGI__WEST_LAKE__CAVERN_REFILL_STATION__DEFEAT_MUS_A_M20 = 0x40000000000000;
        const VISITED_LOC_AMAGI__WEST_LAKE__STRONGHOLD_CEILING_LEFT__KNOCK_DOWN_LEFT_BOULDER = 0x80000000000000;
        const VISITED_LOC_ANNUNA__EAST_BRIDGE__BELOW_GATE_BUTTON__SWITCH_FROM_BELOW = 0x100000000000000;
        const VISITED_LOC_ANNUNA__EAST_BRIDGE__TOWER_GATE__TABLET = 0x200000000000000;
        const VISITED_LOC_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM = 0x400000000000000;
        const VISITED_LOC_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET = 0x800000000000000;
        const VISITED_LOC_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH = 0x1000000000000000;
        const VISITED_LOC_ANNUNA__MIRROR_MATCH__SAVE_POINT__FIGHT = 0x2000000000000000;
        const VISITED_LOC_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP = 0x4000000000000000;
        const VISITED_LOC_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM = 0x8000000000000000;
        const ALL_VISIT_FLAGS = 0xfffffffffffffff8;
    }
}
bitflags!{
    #[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
    pub struct ContextBits5 : u64 {
        const VISITED_LOC_ANNUNA__SNIPER_VALLEY__TABLE__ITEM = 0x1;
        const VISITED_LOC_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL = 0x2;
        const VISITED_LOC_ANNUNA__TWISTY_PASSAGES__NORTHWEST_ALCOVE__REFILL = 0x4;
        const VISITED_LOC_ANNUNA__TWISTY_PASSAGES__TOP__TABLET = 0x8;
        const VISITED_LOC_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP = 0x10;
        const VISITED_LOC_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON = 0x20;
        const VISITED_LOC_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM = 0x40;
        const VISITED_LOC_ANNUNA__VERTICAL_ROOM__UPPER_CACHE__TABLET = 0x80;
        const VISITED_LOC_ANNUNA__WEST_BRIDGE__PLINTH__ITEM = 0x100;
        const VISITED_LOC_ANNUNA__WEST_CLIMB__CACHE__ITEM = 0x200;
        const VISITED_LOC_ANTARCTICA__POWER_ROOM__SWITCH__FLIP = 0x400;
        const VISITED_LOC_ANTARCTICA__SHED__INTERIOR__SHELF = 0x800;
        const VISITED_LOC_EBIH__BOSS_ROOM__BOSS__BOSS_REWARD = 0x1000;
        const VISITED_LOC_EBIH__BOSS_ROOM__EAST_LEDGE__ITEM = 0x2000;
        const VISITED_LOC_EBIH__BY_GARAGE__CRAWLSPACE__FRAGMENT = 0x4000;
        const VISITED_LOC_EBIH__EBIH_EAST__DISPENSER__VEND = 0x8000;
        const VISITED_LOC_EBIH__EBIH_EAST__EAST_LEDGE__NOTE = 0x10000;
        const VISITED_LOC_EBIH__EBIH_WEST__ALCOVE__TABLET = 0x20000;
        const VISITED_LOC_EBIH__GRID_25_2_6__PIT__ITEM = 0x40000;
        const VISITED_LOC_EBIH__GRID_26_10_11__LEDGE__NOTE = 0x80000;
        const VISITED_LOC_EBIH__GUARDED_HEALTH__FAR_WEST__REFILL = 0x100000;
        const VISITED_LOC_EBIH__GUARDED_HEALTH__WEST_BASIN__HEALTH = 0x200000;
        ...
        const VISITED_LOC_GLACIER__PEAK__BIRDS_EYE__ITEM = 0x400000000000000;
...
bitflags!{
    ...
    pub struct ContextBits6 : u64 {
        ...
        const VISITED_LOC_IRIKAR__BASEMENT_PIPES__HIGH_PIPE__TABLET = 0x200;
        const VISITED_LOC_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP = 0x400;
        const VISITED_LOC_IRIKAR__BOSS_ROOM__BULLS_FEET__BOSS_REWARD = 0x800;
        const VISITED_LOC_IRIKAR__BOSS_ROOM__HEALTHY_ROOFTOP__HEALTH = 0x1000;
        const VISITED_LOC_IRIKAR__EAST_ROOFTOPS__TOP_ROOFTOP__TABLET = 0x2000;
        const VISITED_LOC_IRIKAR__HUB__DAGGER_ALTAR__WEAPON = 0x4000;
        const VISITED_LOC_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__MIST_INTO_WALL = 0x8000;
        const VISITED_LOC_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__UPGRADED_MIST_INTO_WALL = 0x10000;
        const VISITED_LOC_IRIKAR__HUB__SW_BUILDING_TOP_PLATFORM__POWER_CORE = 0x20000;
        const VISITED_LOC_IRIKAR__HUB__SAT_TOWER_TOP_LEDGE__TABLET = 0x40000;
        const VISITED_LOC_IRIKAR__LAMASSU__DESK__ITEM = 0x80000;
        const VISITED_LOC_IRIKAR__MIDWEST__TABLET_PLATFORM__TABLET = 0x100000;
