...
bitflags!{
    ...
    pub struct ContextBits3 : u64 {
        ...
        const REMOTE_DRONE = 0x100000;
        const RESEARCHERS_MISSING = 0x200000;
        const SEPARATION = 0x400000;
        const SHOCKWAVE = 0x800000;
        const SLINGSHOT_CHARGE = 0x1000000;
        const SLINGSHOT_HOOK = 0x2000000;
        const SLINGSHOT_WEAPON = 0x4000000;
        const SNIPER_VALLEY_ROCK_1 = 0x8000000;
        const SNIPER_VALLEY_ROCK_2 = 0x10000000;
        const STATION_POWER = 0x20000000;
        const STORM_BOMB = 0x40000000;
        const SUSPENSION_BRIDGE = 0x80000000;
        const SWITCH_36_11 = 0x100000000;
        const SWITCH_40_12 = 0x200000000;
        const TERMINAL_BREAKTHROUGH_1 = 0x400000000;
        const TERMINAL_BREAKTHROUGH_2 = 0x800000000;
        const THE_IDEAL_KIENGIR = 0x1000000000;
        const UHRUM_ANNUNA_CORRIDOR_BLOCK = 0x2000000000;
        const UHRUM_WATERFALL_WALL = 0x4000000000;
        const UHRUM_WATERFALLS_BLOCK = 0x8000000000;
        const UHRUM_WEST_ENTRANCE_GATE = 0x10000000000;
        const UHRUM_WEST_ENTRANCE_LOWER_WALL = 0x20000000000;
        const UHRUM_WEST_ENTRANCE_UPPER_WALL = 0x40000000000;
        const UNDER_SIEGE = 0x80000000000;
        const UNDERWATER_MOVEMENT = 0x100000000000;
        const WALL_CLIMB = 0x200000000000;
        const WATER_MOVEMENT = 0x400000000000;
        const VISITED_AMAGI__LIRU_ROOM__SHRINE__ITEM = 0x800000000000;
        const VISITED_AMAGI__MAIN_AREA__WAY_OFF_TO_THE_SIDE__ITEM = 0x1000000000000;
        const VISITED_AMAGI__WEST_LAKE__CAVERN_EYE__ITEM = 0x2000000000000;
        const VISITED_AMAGI__WEST_LAKE__CAVERN_REAR_PILLAR__BOSS_REWARD = 0x4000000000000;
        const VISITED_AMAGI__WEST_LAKE__CAVERN_REFILL_STATION__BREAK_WALL = 0x8000000000000;
        const VISITED_AMAGI__WEST_LAKE__CAVERN_REFILL_STATION__DEFEAT_MUS_A_M20 = 0x10000000000000;
        const VISITED_AMAGI__WEST_LAKE__CAVERN_TEAR_DUCT__REMOTE_FLASK = 0x20000000000000;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_CEILING_LEFT__KNOCK_DOWN_LEFT_BOULDER = 0x40000000000000;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_CEILING_RIGHT__KNOCK_DOWN_RIGHT_BOULDER = 0x80000000000000;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_FRONT_DOOR__BREAK_WALL = 0x100000000000000;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_FRONT_ROOM__BREAK_WALL = 0x200000000000000;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__BREAK_WALL = 0x400000000000000;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__ITEM = 0x800000000000000;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_MIDDLE_COLUMN__BREAK_WALL = 0x1000000000000000;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_REAR_WALL__BREAK_LEFT_WALL = 0x2000000000000000;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_TOP__REMOTE_URN = 0x4000000000000000;
        const VISITED_AMAGI__WEST_LAKE__SURFACE_WALL_LEFT__BREAK_WALL = 0x8000000000000000;
        const ALL_VISIT_FLAGS = 0xffff800000000000;
    }
}
bitflags!{
    #[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
    pub struct ContextBits4 : u64 {
        const VISITED_AMAGI__WEST_LAKE__SURFACE_WALL_RIGHT__BREAK_WALL = 0x1;
        const VISITED_ANNUNA__APOCALYPSE__CENTER_SCAFFOLD_WEST__BOSS_FIGHT = 0x2;
        const VISITED_ANNUNA__APOCALYPSE__CENTER_SCAFFOLD_WEST__FILL_IT_UP = 0x4;
        const VISITED_ANNUNA__EAST_BRIDGE__BELOW_GATE_BUTTON__SWITCH_FROM_BELOW = 0x8;
        const VISITED_ANNUNA__EAST_BRIDGE__GATE_BUTTON__SWITCH = 0x10;
        const VISITED_ANNUNA__EAST_BRIDGE__TOWER_GATE__TABLET = 0x20;
        const VISITED_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM = 0x40;
        const VISITED_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH = 0x80;
        const VISITED_ANNUNA__MIRROR_MATCH__EAST_26_LOWER__REMOTE_FLASK = 0x100;
        const VISITED_ANNUNA__MIRROR_MATCH__EAST_26_UPPER__REMOTE_FLASK = 0x200;
        const VISITED_ANNUNA__MIRROR_MATCH__PLINTH__ITEM = 0x400;
        const VISITED_ANNUNA__MIRROR_MATCH__SAVE_POINT__FIGHT = 0x800;
        const VISITED_ANNUNA__MIRROR_MATCH__WAVING_DISTANCE__SHOCKWAVE_FLASK = 0x1000;
        const VISITED_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP = 0x2000;
        const VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM = 0x4000;
        const VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_EAST__BREAK_INNER_WALL = 0x8000;
        const VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_WEST__BREAK_INNER_WALL = 0x10000;
        const VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_EAST__BREAK_OUTER_WALL = 0x20000;
        const VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_WEST__BREAK_OUTER_WALL = 0x40000;
        const VISITED_ANNUNA__SNIPER_VALLEY__TABLE__ITEM = 0x80000;
        const VISITED_ANNUNA__TWISTY_PASSAGES__NORTHWEST_ALCOVE__REFILL = 0x100000;
        const VISITED_ANNUNA__TWISTY_PASSAGES__TOP__TABLET = 0x200000;
        const VISITED_ANNUNA__WEST_BRIDGE__PLINTH__ITEM = 0x400000;
        const VISITED_ANNUNA__WEST_CLIMB__CACHE__ITEM = 0x800000;
        const VISITED_ANTARCTICA__BUILDING_2__BEHIND_BOXES__NOTE = 0x1000000;
        const VISITED_ANTARCTICA__POWER_ROOM__SWITCH__FLIP = 0x2000000;
        const VISITED_ANTARCTICA__SHED__INTERIOR__SHELF = 0x4000000;
        const VISITED_EBIH__BASE_CAMP__LEFT_PLATFORM_MOVED__ITEM_FROM_THE_SIDE = 0x8000000;
        const VISITED_EBIH__BASE_CAMP__TOP_PLATFORM__ITEM = 0x10000000;
        const VISITED_EBIH__BOSS_ROOM__BOSS__BOSS_REWARD = 0x20000000;
        const VISITED_EBIH__BOSS_ROOM__BOSS__FIGHT_ALU = 0x40000000;
        const VISITED_EBIH__BOSS_ROOM__BOSS__HACK_ALU = 0x80000000;
        const VISITED_EBIH__BOSS_ROOM__EAST_LEDGE__ITEM = 0x100000000;
        const VISITED_EBIH__BY_GARAGE__CRAWLSPACE__FRAGMENT = 0x200000000;
        const VISITED_EBIH__DRONE_ROOM__ITEM__URN = 0x400000000;
        const VISITED_EBIH__DRONE_ROOM__ITEM__URN_COLLECTION_SKIP = 0x800000000;
        const VISITED_EBIH__DRONE_ROOM__ITEM__URN_FAST_TRAVEL = 0x1000000000;
        const VISITED_EBIH__DRONE_ROOM__MIDDLE_PLATFORM__URN_QUICK_GRAB = 0x2000000000;
        const VISITED_EBIH__EBIH_EAST__CORNER__URN = 0x4000000000;
        const VISITED_EBIH__EBIH_EAST__DISPENSER__VEND = 0x8000000000;
        const VISITED_EBIH__EBIH_EAST__EAST_LEDGE__NOTE = 0x10000000000;
        const VISITED_EBIH__EBIH_EAST__LOWER_MOVING_PLATFORM__REMOTE_URN = 0x20000000000;
        const VISITED_EBIH__EBIH_WEST__ALCOVE__TABLET = 0x40000000000;
        const VISITED_EBIH__EBIH_WEST__BLOCK_LEFT__BREAK_BLOCK = 0x80000000000;
        const VISITED_EBIH__EBIH_WEST__BLOCK_RIGHT__BREAK_BLOCK = 0x100000000000;
        const VISITED_EBIH__GRID_25_10_12__EAST_10__REMOTE_BUSH = 0x200000000000;
        const VISITED_EBIH__GRID_25_10_12__HIDDEN_BUSH__BEHIND_BUSH = 0x400000000000;
        const VISITED_EBIH__GRID_25_2_6__PIT__ITEM = 0x800000000000;
        const VISITED_EBIH__GRID_26_10_11__LEDGE__NOTE = 0x1000000000000;
        const VISITED_EBIH__VERTICAL_INTERCHANGE__SWITCH__ACTIVATE_SWITCH = 0x2000000000000;
        const VISITED_EBIH__WATERFALL__ALCOVE_LEFT__BLOCK_LEFT = 0x4000000000000;
        const VISITED_EBIH__WATERFALL__ALCOVE_RIGHT__BLOCK_RIGHT = 0x8000000000000;
        const VISITED_EBIH__WATERFALL__ALCOVE__BLOCK_LEFT = 0x10000000000000;
        const VISITED_EBIH__WATERFALL__ALCOVE__BLOCK_RIGHT = 0x20000000000000;
        const VISITED_EBIH__WATERFALL__ALCOVE__PEDESTAL = 0x40000000000000;
        const VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_THROUGH_WALL = 0x80000000000000;
        const VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL = 0x100000000000000;
        const VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL = 0x200000000000000;
        const VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL = 0x400000000000000;
        const VISITED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS = 0x800000000000000;
        const VISITED_GIGUNA_BREACH__CHIMNEY__CACHE__FLASK = 0x1000000000000000;
        const VISITED_GIGUNA_BREACH__CUBBY__ROCKS__HEALTH = 0x2000000000000000;
        const VISITED_GIGUNA_BREACH__SLINGSHOT__RAVINE__URN = 0x4000000000000000;
        const VISITED_GIGUNA__ANTECHAMBER__STATUE_HEAD__TABLET = 0x8000000000000000;
...
bitflags!{
    ...
    pub struct ContextBits5 : u64 {
        const VISITED_GIGUNA__CARNELIAN__VAULT__ITEM = 0x1;
        const VISITED_GIGUNA__CLOUDS__CACHE__ITEM = 0x2;
        const VISITED_GIGUNA__DUAL_PATH__BASE_OF_WALL__BREAK_WALL = 0x4;
        const VISITED_GIGUNA__DUAL_PATH__BASE_OF_WALL__MIST_INTO_WALL = 0x8;
        const VISITED_GIGUNA__DUAL_PATH__BELOW_LEFT_SWITCH__REMOTE_SWITCH = 0x10;
        const VISITED_GIGUNA__DUAL_PATH__BELOW_RIGHT_SWITCH__REMOTE_SWITCH = 0x20;
        const VISITED_GIGUNA__DUAL_PATH__LEFT_SWITCH__HIT_SWITCH = 0x40;
        const VISITED_GIGUNA__DUAL_PATH__RIGHT_SWITCH__HIT_SWITCH = 0x80;
        const VISITED_GIGUNA__DUAL_PATH__WALL_SECRET__HEALTH = 0x100;
        const VISITED_GIGUNA__EAST_CAVERNS__HIDDEN_PASSAGE_CENTER__HIDDEN_FLASK = 0x200;
        const VISITED_GIGUNA__FAR_CORNER__GRASS__OBSCURED_ITEM = 0x400;
        const VISITED_GIGUNA__GATEWAY__BLOCK_LEFT__SHOCKWAVE = 0x800;
        const VISITED_GIGUNA__GATEWAY__BLOCK_RIGHT__SHOCKWAVE = 0x1000;
        const VISITED_GIGUNA__GATEWAY__BUTTON__HIT_SWITCH = 0x2000;
        const VISITED_GIGUNA__GATEWAY__FLASK_LEDGE__ITEM = 0x4000;
        const VISITED_GIGUNA__GIGUNA_BASE__RUIN__ITEM = 0x8000;
        const VISITED_GIGUNA__GIGUNA_BASE__TABLE__NEWS = 0x10000;
        const VISITED_GIGUNA__GIGUNA_NORTHEAST__DOOR__REMOTE_FLASK = 0x20000;
        const VISITED_GIGUNA__GIGUNA_NORTHEAST__GATE_BUTTON__OPEN_GATE = 0x40000;
        const VISITED_GIGUNA__GIGUNA_NORTHEAST__GATE_RIGHT__REMOTE_BUTTON = 0x80000;
        const VISITED_GIGUNA__GIGUNA_NORTHEAST__VAULT__ITEM = 0x100000;
        const VISITED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__BOSS_REWARD = 0x200000;
        const VISITED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__FIGHT_GUBI = 0x400000;
        const VISITED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__HACK_GUBI = 0x800000;
        const VISITED_GIGUNA__GUBI_LAIR__PEDESTAL__AXE = 0x1000000;
        const VISITED_GIGUNA__HARD_ROCK__ROCK_CENTER__TABLET = 0x2000000;
        const VISITED_GIGUNA__HARD_ROCK__ROCK_LEFT__ENTER_ROCK_AS_MIST = 0x4000000;
        const VISITED_GIGUNA__HARD_ROCK__ROCK_LEFT__SHOCKWAVE_BOULDER = 0x8000000;
        const VISITED_GIGUNA__HARD_ROCK__ROCK_RIGHT__ENTER_ROCK_AS_MIST = 0x10000000;
        const VISITED_GIGUNA__HARD_ROCK__ROCK_RIGHT__SHOCKWAVE_BOULDER = 0x20000000;
        const VISITED_GIGUNA__HELIPAD__TABLET_LEDGE__TABLET = 0x40000000;
        const VISITED_GIGUNA__LAMASSU__DEPOSIT__FLASK = 0x80000000;
        const VISITED_GIGUNA__RUINS_CENTER__TABLET__ITEM = 0x100000000;
        const VISITED_GIGUNA__RUINS_EAST__WAY_UP_HIGH__ITEM = 0x200000000;
        const VISITED_GIGUNA__RUINS_TOP__FLASK__FLASK = 0x400000000;
        const VISITED_GIGUNA__RUINS_TOP__SMALL_LEDGE__SHOCKWAVE_FLASK = 0x800000000;
        const VISITED_GIGUNA__WASTELAND__DOOR_RIGHT__HEALTH = 0x1000000000;
        const VISITED_GIGUNA__WASTELAND__PASSAGE_CACHE__CLEAR_HORIZONTAL_PASSAGE_MANUALLY = 0x2000000000;
        const VISITED_GIGUNA__WASTELAND__PASSAGE_CACHE__MIST_THROUGH_HORIZONTAL_PASSAGE = 0x4000000000;
        const VISITED_GIGUNA__WASTELAND__PASSAGE_EAST__CLEAR_HORIZONTAL_PASSAGE_MANUALLY = 0x8000000000;
        const VISITED_GIGUNA__WASTELAND__PASSAGE_EAST__MIST_THROUGH_HORIZONTAL_PASSAGE = 0x10000000000;
        const VISITED_GIGUNA__WEST_CAVERNS__BUSH__ITEM = 0x20000000000;
        const VISITED_GIGUNA__WEST_CAVERNS__CACHE__ITEM = 0x40000000000;
        const VISITED_GIGUNA__WEST_TOWER__TOP__TABLET = 0x80000000000;
        const VISITED_GLACIER__APOCALYPSE_ENTRY__GRATE_LEDGE__ESCAPE = 0x100000000000;
        const VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__ITEM = 0x200000000000;
        const VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__SWITCH = 0x400000000000;
        const VISITED_GLACIER__COMPASS_ROOM__CENTER__TABLE = 0x800000000000;
        const VISITED_GLACIER__LEDGE_GRAB_ROOM__CLIFF_BOTTOM__QUICK_GRAB = 0x1000000000000;
        const VISITED_GLACIER__LEDGE_GRAB_ROOM__PEDESTAL__ITEM = 0x2000000000000;
        const VISITED_GLACIER__THE_BIG_DROP__WATER_SURFACE__DROWN = 0x4000000000000;
        const VISITED_GLACIER__VERTICAL_ROOM__PEAK__FLASK = 0x8000000000000;
        const VISITED_GLACIER__VERTICAL_ROOM__UNDER_SWITCH__SWITCH = 0x10000000000000;
        const VISITED_INTERIOR__BUILDING_INTERIOR__CORNER__URN = 0x20000000000000;
        const VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__REMOTE_URN = 0x40000000000000;
        const VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP = 0x80000000000000;
        const VISITED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE = 0x100000000000000;
        const VISITED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH = 0x200000000000000;
        const VISITED_INTERIOR__GARAGE__BOXES__UNDER_BOXES = 0x400000000000000;
        const VISITED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE = 0x800000000000000;
        const VISITED_INTERIOR__TENT_INTERIOR__DESK__NOTE = 0x1000000000000000;
...
bitflags!{
    ...
    pub struct ContextBits6 : u64 {
        ...
        const VISITED_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP = 0x2;
        ...
        const VISITED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_COLLECTION_SKIP = 0x4000;
        const VISITED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_FAST_TRAVEL = 0x8000;
        const VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_1 = 0x10000;
        const VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_2 = 0x20000;
        const VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_3 = 0x40000;
        const VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_1 = 0x80000;
        const VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_2 = 0x100000;
        const VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_3 = 0x200000;
        const VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_1 = 0x400000;
        const VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_2 = 0x800000;
        const VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_3 = 0x1000000;
        const VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_1 = 0x2000000;
        const VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_2 = 0x4000000;
        const VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_3 = 0x8000000;
        const VISITED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_1 = 0x10000000;
        const VISITED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_2 = 0x20000000;
        const VISITED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_3 = 0x40000000;
        const VISITED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_1 = 0x80000000;
        const VISITED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_2 = 0x100000000;
        const VISITED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_3 = 0x200000000;
        const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_1 = 0x400000000;
        const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_2 = 0x800000000;
        const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_3 = 0x1000000000;
        const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_1 = 0x2000000000;
        const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_2 = 0x4000000000;
        const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_3 = 0x8000000000;
        const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_SPEED_1 = 0x10000000000;
        const VISITED_MENU__UPGRADE_MENU__INFECTION__INFECTION_SPEED_2 = 0x20000000000;
        const VISITED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_1 = 0x40000000000;
        const VISITED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_2 = 0x80000000000;
        const VISITED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_3 = 0x100000000000;
        const VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_1 = 0x200000000000;
        const VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_2 = 0x400000000000;
        const VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_3 = 0x800000000000;
        const VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_4 = 0x1000000000000;
        const VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_5 = 0x2000000000000;
        const VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__MIST_UPGRADE = 0x4000000000000;
        const VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_EAST__DISLODGE_BLOCK = 0x8000000000000;
        const VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_WEST__DISLODGE_BLOCK = 0x10000000000000;
        const VISITED_UHRUM__ANNUNA_CORRIDOR__EAST_CUBBY__TABLET = 0x20000000000000;
        const VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN = 0x40000000000000;
        const VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP = 0x80000000000000;
        const VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL = 0x100000000000000;
        const VISITED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM = 0x200000000000000;
        const VISITED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN = 0x400000000000000;
        const VISITED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX = 0x800000000000000;
        const VISITED_UHRUM__SIEGE_CORRIDOR__POND__ITEM = 0x1000000000000000;
        const VISITED_UHRUM__SIEGE_CORRIDOR__UPPER_ROCK_ITEM__URN = 0x2000000000000000;
        const VISITED_UHRUM__SIEGE_CORRIDOR__WESTERN_CACHE__CORE = 0x4000000000000000;
        const VISITED_UHRUM__WATERFALLS__ABOVE_BLOCK__BLOCK = 0x8000000000000000;
        const ALL_VISIT_FLAGS = 0xffffffffffffffff;
    }
}
bitflags!{
    ...
    pub struct ContextBits7 : u64 {
        const VISITED_UHRUM__WATERFALLS__BARRIER_EAST__CHARGE_THROUGH_WALL = 0x1;
        const VISITED_UHRUM__WATERFALLS__BARRIER_EAST__MIST_THROUGH_WALL = 0x2;
        const VISITED_UHRUM__WATERFALLS__BARRIER_EAST__SPIN_THROUGH_WALL = 0x4;
        const VISITED_UHRUM__WATERFALLS__BARRIER_WEST__CHARGE_THROUGH_WALL = 0x8;
        const VISITED_UHRUM__WATERFALLS__BARRIER_WEST__MIST_THROUGH_WALL = 0x10;
        const VISITED_UHRUM__WATERFALLS__BARRIER_WEST__SPIN_THROUGH_WALL = 0x20;
        const VISITED_UHRUM__WATERFALLS__BELOW_BLOCK__SHOCKWAVE_BLOCK = 0x40;
        const VISITED_UHRUM__WATERFALLS__CEILING_CACHE__FLASK = 0x80;
        const VISITED_UHRUM__WATERFALLS__EAST_26__BLOCK = 0x100;
        const VISITED_UHRUM__WATERFALLS__WEST_WATER_NOOK__TABLET = 0x200;
        const VISITED_UHRUM__WEST_ENTRANCE__GATE_SWITCH__OPEN_GATE = 0x400;
        const VISITED_UHRUM__WEST_ENTRANCE__INNER_DAIS__ITEM = 0x800;
        const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__CHARGE_THROUGH_WALL = 0x1000;
        const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__MIST_THROUGH_WALL = 0x2000;
        const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__SPIN_THROUGH_WALL = 0x4000;
        const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__CHARGE_THROUGH_WALL = 0x8000;
        const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__MIST_THROUGH_WALL = 0x10000;
        const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__SPIN_THROUGH_WALL = 0x20000;
        const VISITED_UHRUM__WEST_ENTRANCE__SAND__REFILL = 0x40000;
        const VISITED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__CHARGE_THROUGH_WALL = 0x80000;
        const VISITED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__MIST_THROUGH_WALL = 0x100000;
        const VISITED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__SPIN_THROUGH_WALL = 0x200000;
        const VISITED_UHRUM__WEST_ENTRANCE__UPPER_WALL_WEST__MIST_THROUGH_WALL = 0x400000;
        const SKIPPED_AMAGI__LIRU_ROOM__SHRINE__ITEM = 0x800000;
        const SKIPPED_AMAGI__MAIN_AREA__WAY_OFF_TO_THE_SIDE__ITEM = 0x1000000;
        const SKIPPED_AMAGI__WEST_LAKE__CAVERN_EYE__ITEM = 0x2000000;
        const SKIPPED_AMAGI__WEST_LAKE__CAVERN_REAR_PILLAR__BOSS_REWARD = 0x4000000;
        const SKIPPED_AMAGI__WEST_LAKE__CAVERN_REFILL_STATION__BREAK_WALL = 0x8000000;
        const SKIPPED_AMAGI__WEST_LAKE__CAVERN_REFILL_STATION__DEFEAT_MUS_A_M20 = 0x10000000;
        const SKIPPED_AMAGI__WEST_LAKE__CAVERN_TEAR_DUCT__REMOTE_FLASK = 0x20000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_CEILING_LEFT__KNOCK_DOWN_LEFT_BOULDER = 0x40000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_CEILING_RIGHT__KNOCK_DOWN_RIGHT_BOULDER = 0x80000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_FRONT_DOOR__BREAK_WALL = 0x100000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_FRONT_ROOM__BREAK_WALL = 0x200000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__BREAK_WALL = 0x400000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__ITEM = 0x800000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_MIDDLE_COLUMN__BREAK_WALL = 0x1000000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_REAR_WALL__BREAK_LEFT_WALL = 0x2000000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_TOP__REMOTE_URN = 0x4000000000;
        const SKIPPED_AMAGI__WEST_LAKE__SURFACE_WALL_LEFT__BREAK_WALL = 0x8000000000;
        const SKIPPED_AMAGI__WEST_LAKE__SURFACE_WALL_RIGHT__BREAK_WALL = 0x10000000000;
        const SKIPPED_ANNUNA__APOCALYPSE__CENTER_SCAFFOLD_WEST__BOSS_FIGHT = 0x20000000000;
        const SKIPPED_ANNUNA__APOCALYPSE__CENTER_SCAFFOLD_WEST__FILL_IT_UP = 0x40000000000;
        const SKIPPED_ANNUNA__EAST_BRIDGE__BELOW_GATE_BUTTON__SWITCH_FROM_BELOW = 0x80000000000;
        const SKIPPED_ANNUNA__EAST_BRIDGE__GATE_BUTTON__SWITCH = 0x100000000000;
        const SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_GATE__TABLET = 0x200000000000;
        const SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM = 0x400000000000;
        const SKIPPED_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH = 0x800000000000;
        const SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_LOWER__REMOTE_FLASK = 0x1000000000000;
        const SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_UPPER__REMOTE_FLASK = 0x2000000000000;
        const SKIPPED_ANNUNA__MIRROR_MATCH__PLINTH__ITEM = 0x4000000000000;
        const SKIPPED_ANNUNA__MIRROR_MATCH__SAVE_POINT__FIGHT = 0x8000000000000;
        const SKIPPED_ANNUNA__MIRROR_MATCH__WAVING_DISTANCE__SHOCKWAVE_FLASK = 0x10000000000000;
        const SKIPPED_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP = 0x20000000000000;
        const SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM = 0x40000000000000;
        const SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_EAST__BREAK_INNER_WALL = 0x80000000000000;
        const SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_WEST__BREAK_INNER_WALL = 0x100000000000000;
        const SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_EAST__BREAK_OUTER_WALL = 0x200000000000000;
        const SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_WEST__BREAK_OUTER_WALL = 0x400000000000000;
        const SKIPPED_ANNUNA__SNIPER_VALLEY__TABLE__ITEM = 0x800000000000000;
        const SKIPPED_ANNUNA__TWISTY_PASSAGES__NORTHWEST_ALCOVE__REFILL = 0x1000000000000000;
        const SKIPPED_ANNUNA__TWISTY_PASSAGES__TOP__TABLET = 0x2000000000000000;
        const SKIPPED_ANNUNA__WEST_BRIDGE__PLINTH__ITEM = 0x4000000000000000;
        const SKIPPED_ANNUNA__WEST_CLIMB__CACHE__ITEM = 0x8000000000000000;
        const ALL_VISIT_FLAGS = 0x7fffff;
        const ALL_SKIP_FLAGS = 0xffffffffff800000;
    }
}
bitflags!{
    #[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
    pub struct ContextBits8 : u64 {
        const SKIPPED_ANTARCTICA__BUILDING_2__BEHIND_BOXES__NOTE = 0x1;
        const SKIPPED_ANTARCTICA__POWER_ROOM__SWITCH__FLIP = 0x2;
        const SKIPPED_ANTARCTICA__SHED__INTERIOR__SHELF = 0x4;
        const SKIPPED_EBIH__BASE_CAMP__LEFT_PLATFORM_MOVED__ITEM_FROM_THE_SIDE = 0x8;
        const SKIPPED_EBIH__BASE_CAMP__TOP_PLATFORM__ITEM = 0x10;
        const SKIPPED_EBIH__BOSS_ROOM__BOSS__BOSS_REWARD = 0x20;
        const SKIPPED_EBIH__BOSS_ROOM__BOSS__FIGHT_ALU = 0x40;
        const SKIPPED_EBIH__BOSS_ROOM__BOSS__HACK_ALU = 0x80;
        const SKIPPED_EBIH__BOSS_ROOM__EAST_LEDGE__ITEM = 0x100;
        const SKIPPED_EBIH__BY_GARAGE__CRAWLSPACE__FRAGMENT = 0x200;
        const SKIPPED_EBIH__DRONE_ROOM__ITEM__URN = 0x400;
        const SKIPPED_EBIH__DRONE_ROOM__ITEM__URN_COLLECTION_SKIP = 0x800;
        const SKIPPED_EBIH__DRONE_ROOM__ITEM__URN_FAST_TRAVEL = 0x1000;
...
bitflags!{
    ...
    pub struct ContextBits9 : u64 {
        ...
        const SKIPPED_GLACIER__APOCALYPSE_ENTRY__GRATE_LEDGE__ESCAPE = 0x100000;
        ...
        const SKIPPED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP = 0x80000000;
        const SKIPPED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE = 0x100000000;
        const SKIPPED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH = 0x200000000;
        const SKIPPED_INTERIOR__GARAGE__BOXES__UNDER_BOXES = 0x400000000;
        const SKIPPED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE = 0x800000000;
        const SKIPPED_INTERIOR__TENT_INTERIOR__DESK__NOTE = 0x1000000000;
        const SKIPPED_IRIKAR_BREACH__GAUNTLET__HIDDEN_PATH_REWARD__ITEM = 0x2000000000;
        const SKIPPED_IRIKAR_BREACH__HOVER_ROOM__BOTTOM__ITEM = 0x4000000000;
        const SKIPPED_IRIKAR_BREACH__WORM_RAVE__CORNER__ITEM = 0x8000000000;
        const SKIPPED_IRIKAR__ABANDONED_ROOM__CORNER_CORE__CORE = 0x10000000000;
        const SKIPPED_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP = 0x20000000000;
        ...
        const SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_COLLECTION_SKIP = 0x40000000000000;
        const SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_FAST_TRAVEL = 0x80000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_1 = 0x100000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_2 = 0x200000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_3 = 0x400000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_1 = 0x800000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_2 = 0x1000000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_3 = 0x2000000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_1 = 0x4000000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_2 = 0x8000000000000000;
        const ALL_SKIP_FLAGS = 0xffffffffffffffff;
    }
}
bitflags!{
    ...
    pub struct ContextBits10 : u64 {
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_3 = 0x1;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_1 = 0x2;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_2 = 0x4;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_3 = 0x8;
        const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_1 = 0x10;
        const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_2 = 0x20;
        const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_3 = 0x40;
        const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_1 = 0x80;
        const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_2 = 0x100;
        const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_3 = 0x200;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_1 = 0x400;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_2 = 0x800;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_3 = 0x1000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_1 = 0x2000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_2 = 0x4000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_3 = 0x8000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_SPEED_1 = 0x10000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_SPEED_2 = 0x20000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_1 = 0x40000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_2 = 0x80000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_3 = 0x100000;
        const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_1 = 0x200000;
        const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_2 = 0x400000;
        const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_3 = 0x800000;
        const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_4 = 0x1000000;
        const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_5 = 0x2000000;
        const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__MIST_UPGRADE = 0x4000000;
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__BLOCK_EAST__DISLODGE_BLOCK = 0x8000000;
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__BLOCK_WEST__DISLODGE_BLOCK = 0x10000000;
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__EAST_CUBBY__TABLET = 0x20000000;
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN = 0x40000000;
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP = 0x80000000;
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL = 0x100000000;
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM = 0x200000000;
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN = 0x400000000;
        const SKIPPED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX = 0x800000000;
        const SKIPPED_UHRUM__SIEGE_CORRIDOR__POND__ITEM = 0x1000000000;
        const SKIPPED_UHRUM__SIEGE_CORRIDOR__UPPER_ROCK_ITEM__URN = 0x2000000000;
        const SKIPPED_UHRUM__SIEGE_CORRIDOR__WESTERN_CACHE__CORE = 0x4000000000;
        const SKIPPED_UHRUM__WATERFALLS__ABOVE_BLOCK__BLOCK = 0x8000000000;
        const SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__CHARGE_THROUGH_WALL = 0x10000000000;
        const SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__MIST_THROUGH_WALL = 0x20000000000;
        const SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__SPIN_THROUGH_WALL = 0x40000000000;
        const SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__CHARGE_THROUGH_WALL = 0x80000000000;
        const SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__MIST_THROUGH_WALL = 0x100000000000;
        const SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__SPIN_THROUGH_WALL = 0x200000000000;
        const SKIPPED_UHRUM__WATERFALLS__BELOW_BLOCK__SHOCKWAVE_BLOCK = 0x400000000000;
        const SKIPPED_UHRUM__WATERFALLS__CEILING_CACHE__FLASK = 0x800000000000;
        const SKIPPED_UHRUM__WATERFALLS__EAST_26__BLOCK = 0x1000000000000;
        const SKIPPED_UHRUM__WATERFALLS__WEST_WATER_NOOK__TABLET = 0x2000000000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__GATE_SWITCH__OPEN_GATE = 0x4000000000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__INNER_DAIS__ITEM = 0x8000000000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__CHARGE_THROUGH_WALL = 0x10000000000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__MIST_THROUGH_WALL = 0x20000000000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__SPIN_THROUGH_WALL = 0x40000000000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__CHARGE_THROUGH_WALL = 0x80000000000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__MIST_THROUGH_WALL = 0x100000000000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__SPIN_THROUGH_WALL = 0x200000000000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__SAND__REFILL = 0x400000000000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__CHARGE_THROUGH_WALL = 0x800000000000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__MIST_THROUGH_WALL = 0x1000000000000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__SPIN_THROUGH_WALL = 0x2000000000000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_WEST__MIST_THROUGH_WALL = 0x4000000000000000;
        const ALL_SKIP_FLAGS = 0x7fffffffffffffff;
    }
}
}
...
impl context::Ctx for Context {
        ...
        match loc_id {
            ...
            LocationId::Annuna__Twisty_Passages__Top__Tablet =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__TWISTY_PASSAGES__TOP__TABLET) {
                    self.cbits7.insert(flags::ContextBits7::SKIPPED_ANNUNA__TWISTY_PASSAGES__TOP__TABLET);
                }
            }
            ...
            LocationId::Annuna__West_Climb__Cache__Item =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__WEST_CLIMB__CACHE__ITEM) {
                    self.cbits7.insert(flags::ContextBits7::SKIPPED_ANNUNA__WEST_CLIMB__CACHE__ITEM);
                }
            }
    ...
    fn reset(&mut self, loc_id: LocationId) {
        match loc_id {
            ...
            LocationId::Annuna__Twisty_Passages__Top__Tablet => {
                ...
                self.cbits7.remove(flags::ContextBits7::SKIPPED_ANNUNA__TWISTY_PASSAGES__TOP__TABLET);
            }
            LocationId::Annuna__Twisty_Passages__Northwest_Alcove__Refill => {
            ...
            LocationId::Annuna__West_Climb__Cache__Item => {
                ...
                self.cbits7.remove(flags::ContextBits7::SKIPPED_ANNUNA__WEST_CLIMB__CACHE__ITEM);
            }
            LocationId::Annuna__Apocalypse__Center_Scaffold_West__Boss_Fight => {
            ...
            LocationId::Giguna__Gubi_Lair__Center_Platform__Hack_Gubi => {
                ...
                self.cbits8.remove(flags::ContextBits8::SKIPPED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__HACK_GUBI);
            }
            LocationId::Giguna__Gubi_Lair__Center_Platform__Fight_Gubi => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__FIGHT_GUBI);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__FIGHT_GUBI);
            }
            LocationId::Giguna__Gubi_Lair__Center_Platform__Boss_Reward => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__BOSS_REWARD);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__BOSS_REWARD);
            }
            LocationId::Giguna__Gubi_Lair__Pedestal__Axe => {
            ...
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Speed_3 => {
                ...
                self.cbits9.remove(flags::ContextBits9::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_3);
            }
            LocationId::Menu__Upgrade_Menu__Combat__Ranged_Damage_1 => {
                self.cbits6.remove(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_1);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_1);
            }
            LocationId::Menu__Upgrade_Menu__Combat__Ranged_Damage_2 => {
                self.cbits6.remove(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_2);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_2);
            }
            LocationId::Menu__Upgrade_Menu__Combat__Ranged_Damage_3 => {
    ...
    fn todo(&self, loc_id: LocationId) -> bool {
        match loc_id {
            ...
            LocationId::Annuna__Twisty_Passages__Top__Tablet => {
                ...
                && !self.cbits7.contains(flags::ContextBits7::SKIPPED_ANNUNA__TWISTY_PASSAGES__TOP__TABLET)
            }
            LocationId::Annuna__Twisty_Passages__Northwest_Alcove__Refill => {
            ...
            LocationId::Annuna__West_Climb__Cache__Item => {
                ...
                && !self.cbits7.contains(flags::ContextBits7::SKIPPED_ANNUNA__WEST_CLIMB__CACHE__ITEM)
            }
            LocationId::Annuna__Apocalypse__Center_Scaffold_West__Boss_Fight => {
    ...
    // bitflags
        ...
        let n = self.cbits7.contains(flags::ContextBits7::SKIPPED_ANNUNA__TWISTY_PASSAGES__TOP__TABLET);
        let p = old.cbits7.contains(flags::ContextBits7::SKIPPED_ANNUNA__TWISTY_PASSAGES__TOP__TABLET);
        if n != p {
        ...
        let n = self.cbits7.contains(flags::ContextBits7::SKIPPED_ANNUNA__WEST_CLIMB__CACHE__ITEM);
        let p = old.cbits7.contains(flags::ContextBits7::SKIPPED_ANNUNA__WEST_CLIMB__CACHE__ITEM);
        if n != p {
        ...
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__BOSS_REWARD);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__BOSS_REWARD);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__BOSS_REWARD", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__FIGHT_GUBI);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__FIGHT_GUBI);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__FIGHT_GUBI", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__HACK_GUBI);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__HACK_GUBI);
        if n != p {
        ...
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_3);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_3);
        if n != p {
            list.push(format!("{}SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_3", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_1);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_1);
        if n != p {
            list.push(format!("{}SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_1", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_2);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_2);
        if n != p {
        ...
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__SPIN_THROUGH_WALL);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__SPIN_THROUGH_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__SPIN_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_WEST__MIST_THROUGH_WALL);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_WEST__MIST_THROUGH_WALL);
        if n != p {
