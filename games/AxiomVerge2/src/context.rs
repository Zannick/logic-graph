...
bitflags!{
    ...
    pub struct ContextBits1 : u64 {
        ...
        const MAP__ANNUNA__FINAL_SAVE__SAVE = 0x100;
        const MAP__EBIH__BASE_CAMP__SAVE = 0x200;
        const MAP__EBIH__WATERFALL__AXE = 0x400;
        ...
        const MAP__EBIH__DRONE_ROOM__URN = 0x4000;
        ...
        const MAP__GLACIER__REVIVAL__SAVE = 0x200000;
        const MAP__IRIKAR_BREACH__SAVE_ROOM__SAVE = 0x400000;
        const MAP__IRIKAR_BREACH__GAUNTLET__SAVE = 0x800000;
        const MAP__IRIKAR_BREACH__BASEMENT_SAVE__SAVE = 0x1000000;
        const MAP__IRIKAR__HUB__SAVE = 0x2000000;
        const MAP__IRIKAR__SIGHT_ROOM__URN = 0x4000000;
        const MAP__UHRUM__WEST_ENTRANCE__SAVE = 0x8000000;
        const MAP__UHRUM__SAVE_ROOM__SAVE = 0x10000000;
        const MAP__UHRUM__ANNUNA_CORRIDOR__SAVE = 0x20000000;
        const MAP__UHRUM__ANNUNA_CORRIDOR__URN = 0x40000000;
        const AMAGI__MAIN_AREA__CTX__COMBO = 0x80000000;
        const ANNUNA__WEST_BRIDGE__CTX__DOORS_OPENED = 0x100000000;
        const ANNUNA__EAST_BRIDGE__CTX__COMBO = 0x200000000;
        const ANNUNA__VERTICAL_ROOM__CTX__DOOR_OPENED = 0x400000000;
        const ANNUNA__WEST_CLIMB__CTX__DOOR_OPENED = 0x800000000;
        const EBIH__BASE_CAMP__CTX__LEFT_PLATFORM_MOVED = 0x1000000000;
        const EBIH__GRID_25_10_12__CTX__DOOR_OPEN = 0x2000000000;
        const EBIH__WATERFALL__CTX__WEST_DOOR_OPEN = 0x4000000000;
        const EBIH__EBIH_WEST__CTX__DOOR_OPEN = 0x8000000000;
        const EBIH__EBIH_EAST__CTX__PLATFORM1_MOVED = 0x10000000000;
        const EBIH__EBIH_EAST__CTX__PLATFORM2_MOVED = 0x20000000000;
        const EBIH__DRONE_ROOM__CTX__PLATFORM_MOVED = 0x40000000000;
        const EBIH__VERTICAL_INTERCHANGE__CTX__DOOR_OPEN = 0x80000000000;
        const GIGUNA_BREACH__SW_SAVE__CTX__DOOR_OPENED = 0x100000000000;
        const GIGUNA__GIGUNA_NORTHEAST__CTX__DOOR_OPENED = 0x200000000000;
        const GIGUNA__CARNELIAN__CTX__DOOR_OPENED = 0x400000000000;
        const GIGUNA__CARNELIAN__CTX__UPPER_SUSAR = 0x800000000000;
        const GIGUNA__CARNELIAN__CTX__LOWER_SUSAR = 0x1000000000000;
        const GIGUNA__WEST_CAVERNS__CTX__EAST_SUSAR = 0x2000000000000;
        const GIGUNA__GIGUNA_BASE__CTX__DOOR_OPEN = 0x4000000000000;
        const GIGUNA__RUINS_WEST__CTX__KISHIB_HANDLED = 0x8000000000000;
        const GIGUNA__RUINS_TOP__CTX__DOORS_OPEN = 0x10000000000000;
        const GIGUNA__CLOUDS__CTX__PLATFORM_AND_PORTAL = 0x20000000000000;
        const GIGUNA__EAST_CAVERNS__CTX__DOOR_OPENED = 0x40000000000000;
        const GIGUNA__EAST_CAVERNS__CTX__COMBO_ENTERED = 0x80000000000000;
        const GIGUNA__EAST_CAVERNS__CTX__UPPER_SUSAR = 0x100000000000000;
        const GIGUNA__EAST_CAVERNS__CTX__MID_SUSAR = 0x200000000000000;
        const GIGUNA__EAST_CAVERNS__CTX__LOWER_SUSAR = 0x400000000000000;
        const GIGUNA__GATEWAY__CTX__DOOR_OPENED = 0x800000000000000;
        const IRIKAR__BASEMENT_PORTAL__CTX__PLATFORM_MOVED = 0x1000000000000000;
        const AMAGI_DRAGON_EYE_PASSAGE = 0x2000000000000000;
        const AMAGI_STRONGHOLD_BOULDER_1 = 0x4000000000000000;
        const AMAGI_STRONGHOLD_BOULDER_2 = 0x8000000000000000;
    }
}
bitflags!{
    #[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
    pub struct ContextBits2 : u64 {
        ...
        const ANNUNA_EAST_BRIDGE_GATE = 0x10;
        const ANNUNA_MIRROR_MATCH_SWITCH = 0x20;
        const ANNUNA_VERTICAL_ROOM_GATE = 0x40;
        const ANUMAN = 0x80;
        const ANUNNA_VERTICAL_ROOM_GATE = 0x100;
        const APOCALYPSE_BOMB = 0x200;
        const BIG_FLASK = 0x400;
        const BOOMERANG = 0x800;
        const BOOMERANG_UPGRADE = 0x1000;
        ...
        const COMPASS = 0x80000;
        const DANGEROUS_IDEAS = 0x100000;
        const DEAR_ERNEST = 0x200000;
        const DEFEAT_INDRA = 0x400000;
        const DEFEAT_MUS_A_M20 = 0x800000;
        const DESTRUCTION_POGROM = 0x1000000;
        const DRONE_HOVER = 0x2000000;
        const DRONE_MELEE_DAMAGE = 0x4000000;
        const DRONE_MELEE_DAMAGE_2 = 0x8000000;
        const DRONE_MELEE_SPEED = 0x10000000;
        const DRONE_MELEE_SPEED_2 = 0x20000000;
        const EBIH_ALU = 0x40000000;
        const EBIH_INTERCHANGE_BLOCK = 0x80000000;
        const EBIH_INTERCHANGE_GATE = 0x100000000;
        const EBIH_WASTELAND_DOOR = 0x200000000;
        const EBIH_WASTELAND_PASSAGE_H = 0x400000000;
        const EBIH_WATERFALL_BLOCK_LEFT = 0x800000000;
        const EBIH_WATERFALL_BLOCK_RIGHT = 0x1000000000;
        const EBIH_WATERFALL_WALL = 0x2000000000;
        const EBIH_WEST_BLOCK = 0x4000000000;
        const ESCAPE = 0x8000000000;
        const EXIT_BREACH = 0x10000000000;
        const EYE_RING = 0x20000000000;
        const FAMILY_TRAGEDY = 0x40000000000;
        const FAST_TRAVEL = 0x80000000000;
        const GIGUNA_BOULDER = 0x100000000000;
        const GIGUNA_DUAL_PATH_SWITCH = 0x200000000000;
        const GIGUNA_DUAL_PATH_WALL = 0x400000000000;
        const GIGUNA_GATEWAY_BLOCK = 0x800000000000;
        const GIGUNA_GATEWAY_GATE = 0x1000000000000;
        const GIGUNA_GUBI = 0x2000000000000;
        const GIGUNA_NORTHEAST_GATE = 0x4000000000000;
        const HAMMOND_AUTH = 0x8000000000000;
        const HEALTH_NODE = 0x10000000000000;
        const HEALTH_UPGRADE = 0x20000000000000;
        const HEALTH_UPGRADE_2 = 0x40000000000000;
        const HEALTH_UPGRADE_3 = 0x80000000000000;
        const HEALTH_UPGRADE_4 = 0x100000000000000;
        const HERETICS_TABLET = 0x200000000000000;
        const HOVER = 0x400000000000000;
        const ICE_AXE = 0x800000000000000;
        const INFECT = 0x1000000000000000;
        const INFECT_L1 = 0x2000000000000000;
        const INFECT_L2 = 0x4000000000000000;
        const INFECT_L3 = 0x8000000000000000;
    }
}
bitflags!{
    #[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
    pub struct ContextBits3 : u64 {
        const INFECTION_RANGE = 0x1;
        const INFECTION_RANGE_2 = 0x2;
        const INFECTION_RANGE_3 = 0x4;
        const INFECTION_SPEED = 0x8;
        const IRIKAR_GUDAM = 0x10;
        const IRIKAR_ROYAL_STORAGE_WALL = 0x20;
        const LAMENT_FOR_FOOLS = 0x40;
        const LEDGE_GRAB = 0x80;
        const LETTER_FROM_TRACE = 0x100;
        const MELEE_DAMAGE = 0x200;
        const MELEE_DAMAGE_2 = 0x400;
        const MELEE_SPEED = 0x800;
        const MELEE_SPEED_2 = 0x1000;
        const MIST_UPGRADE = 0x2000;
        const NANITE_MIST = 0x4000;
        const NANO_LATTICE_2 = 0x8000;
        const NANO_POINTS = 0x10000;
        const NANO_POINTS_2 = 0x20000;
        const PLAGUE_OF_THOUGHTS = 0x40000;
        const POWER_MATRIX = 0x80000;
        const RANGED_DAMAGE = 0x100000;
        const RANGED_DAMAGE_2 = 0x200000;
        const RANGED_SPEED = 0x400000;
        const RANGED_SPEED_2 = 0x800000;
        const RECORD_LOSSES = 0x1000000;
        const REMOTE_BOOMERANG = 0x2000000;
        const REMOTE_DRONE = 0x4000000;
        const RESEARCHERS_MISSING = 0x8000000;
        const SEPARATION = 0x10000000;
        const SHOCKWAVE = 0x20000000;
        const SLINGSHOT_CHARGE = 0x40000000;
        const SLINGSHOT_HOOK = 0x80000000;
        const SLINGSHOT_WEAPON = 0x100000000;
        const SNIPER_VALLEY_ROCK_1 = 0x200000000;
        const SNIPER_VALLEY_ROCK_2 = 0x400000000;
        const STATION_POWER = 0x800000000;
        const STORM_BOMB = 0x1000000000;
        const SUSPENSION_BRIDGE = 0x2000000000;
        const SWITCH_36_11 = 0x4000000000;
        const SWITCH_40_12 = 0x8000000000;
        const TERMINAL_BREAKTHROUGH_1 = 0x10000000000;
        const TERMINAL_BREAKTHROUGH_2 = 0x20000000000;
        const THE_ETERNAL_ARM = 0x40000000000;
        const THE_IDEAL_KIENGIR = 0x80000000000;
        const UHRUM_ANNUNA_CORRIDOR_BLOCK = 0x100000000000;
        const UHRUM_WATERFALL_WALL = 0x200000000000;
        const UHRUM_WATERFALLS_BLOCK = 0x400000000000;
        const UHRUM_WEST_ENTRANCE_GATE = 0x800000000000;
        const UHRUM_WEST_ENTRANCE_LOWER_WALL = 0x1000000000000;
        const UHRUM_WEST_ENTRANCE_UPPER_WALL = 0x2000000000000;
        const UNDER_SIEGE = 0x4000000000000;
        const UNDERWATER_MOVEMENT = 0x8000000000000;
        const WALL_CLIMB = 0x10000000000000;
        const WATER_MOVEMENT = 0x20000000000000;
        const VISITED_AMAGI__LIRU_ROOM__SHRINE__ITEM = 0x40000000000000;
        const VISITED_AMAGI__MAIN_AREA__WAY_OFF_TO_THE_SIDE__ITEM = 0x80000000000000;
        const VISITED_AMAGI__WEST_LAKE__CAVERN_EYE__ITEM = 0x100000000000000;
        const VISITED_AMAGI__WEST_LAKE__CAVERN_REAR_PILLAR__BOSS_REWARD = 0x200000000000000;
        const VISITED_AMAGI__WEST_LAKE__CAVERN_REFILL_STATION__BREAK_WALL = 0x400000000000000;
        const VISITED_AMAGI__WEST_LAKE__CAVERN_REFILL_STATION__DEFEAT_MUS_A_M20 = 0x800000000000000;
        const VISITED_AMAGI__WEST_LAKE__CAVERN_TEAR_DUCT__REMOTE_FLASK = 0x1000000000000000;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_CEILING_LEFT__KNOCK_DOWN_LEFT_BOULDER = 0x2000000000000000;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_CEILING_RIGHT__KNOCK_DOWN_RIGHT_BOULDER = 0x4000000000000000;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_FRONT_DOOR__BREAK_WALL = 0x8000000000000000;
        const ALL_VISIT_FLAGS = 0xffc0000000000000;
    }
}
bitflags!{
    #[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
    pub struct ContextBits4 : u64 {
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_FRONT_ROOM__BREAK_WALL = 0x1;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__BREAK_WALL = 0x2;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__ITEM = 0x4;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_MIDDLE_COLUMN__BREAK_WALL = 0x8;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_REAR_WALL__BREAK_LEFT_WALL = 0x10;
        const VISITED_AMAGI__WEST_LAKE__STRONGHOLD_TOP__REMOTE_URN = 0x20;
        const VISITED_AMAGI__WEST_LAKE__SURFACE_WALL_LEFT__BREAK_WALL = 0x40;
        const VISITED_AMAGI__WEST_LAKE__SURFACE_WALL_RIGHT__BREAK_WALL = 0x80;
        const VISITED_ANNUNA__APOCALYPSE__CENTER_SCAFFOLD_WEST__BOSS_FIGHT = 0x100;
        const VISITED_ANNUNA__APOCALYPSE__CENTER_SCAFFOLD_WEST__FILL_IT_UP = 0x200;
        const VISITED_ANNUNA__EAST_BRIDGE__BELOW_GATE_BUTTON__SWITCH_FROM_BELOW = 0x400;
        const VISITED_ANNUNA__EAST_BRIDGE__GATE_BUTTON__SWITCH = 0x800;
        const VISITED_ANNUNA__EAST_BRIDGE__TOWER_GATE__TABLET = 0x1000;
        const VISITED_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM = 0x2000;
        const VISITED_ANNUNA__EGG_ROOM__CACHE__FLASK = 0x4000;
        const VISITED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK = 0x8000;
        const VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__REMOTE_BOOMERANG_FLASK = 0x10000;
        const VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__SHOCKWAVE_FROM_OUTSIDE = 0x20000;
        const VISITED_ANNUNA__EGG_ROOM__SECOND_EGG__REMOTE_BOOMERANG_FLASK = 0x40000;
        const VISITED_ANNUNA__FILTER_TELEPORTER__DOOR_LEDGE__SHOCKWAVE_FLASK = 0x80000;
        const VISITED_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET = 0x100000;
        const VISITED_ANNUNA__FILTER_TELEPORTER__SHAFT_BOTTOM__FLASK = 0x200000;
        const VISITED_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH = 0x400000;
        const VISITED_ANNUNA__MIRROR_MATCH__EAST_26_LOWER__REMOTE_FLASK = 0x800000;
        const VISITED_ANNUNA__MIRROR_MATCH__EAST_26_UPPER__REMOTE_FLASK = 0x1000000;
        const VISITED_ANNUNA__MIRROR_MATCH__PLINTH__ITEM = 0x2000000;
        const VISITED_ANNUNA__MIRROR_MATCH__SAVE_POINT__FIGHT = 0x4000000;
        const VISITED_ANNUNA__MIRROR_MATCH__WAVING_DISTANCE__SHOCKWAVE_FLASK = 0x8000000;
        const VISITED_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP = 0x10000000;
        const VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM = 0x20000000;
        const VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_EAST__BREAK_INNER_WALL = 0x40000000;
        const VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_WEST__BREAK_INNER_WALL = 0x80000000;
        const VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_EAST__BREAK_OUTER_WALL = 0x100000000;
        const VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_WEST__BREAK_OUTER_WALL = 0x200000000;
        const VISITED_ANNUNA__SNIPER_VALLEY__TABLE__ITEM = 0x400000000;
        const VISITED_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL = 0x800000000;
        const VISITED_ANNUNA__TWISTY_PASSAGES__NORTHWEST_ALCOVE__REFILL = 0x1000000000;
        const VISITED_ANNUNA__TWISTY_PASSAGES__TOP__TABLET = 0x2000000000;
        const VISITED_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP = 0x4000000000;
        const VISITED_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON = 0x8000000000;
        const VISITED_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM = 0x10000000000;
        const VISITED_ANNUNA__WEST_BRIDGE__PLINTH__ITEM = 0x20000000000;
        const VISITED_ANNUNA__WEST_CLIMB__CACHE__ITEM = 0x40000000000;
        const VISITED_ANTARCTICA__BUILDING_2__BEHIND_BOXES__NOTE = 0x80000000000;
        const VISITED_ANTARCTICA__POWER_ROOM__SWITCH__FLIP = 0x100000000000;
        const VISITED_ANTARCTICA__SHED__INTERIOR__SHELF = 0x200000000000;
        const VISITED_EBIH__BASE_CAMP__LEFT_PLATFORM_MOVED__ITEM_FROM_THE_SIDE = 0x400000000000;
        const VISITED_EBIH__BASE_CAMP__TOP_PLATFORM__ITEM = 0x800000000000;
        const VISITED_EBIH__BOSS_ROOM__BOSS__BOSS_REWARD = 0x1000000000000;
        const VISITED_EBIH__BOSS_ROOM__BOSS__FIGHT_ALU = 0x2000000000000;
        const VISITED_EBIH__BOSS_ROOM__BOSS__HACK_ALU = 0x4000000000000;
        const VISITED_EBIH__BOSS_ROOM__EAST_LEDGE__ITEM = 0x8000000000000;
        const VISITED_EBIH__BY_GARAGE__CRAWLSPACE__FRAGMENT = 0x10000000000000;
        const VISITED_EBIH__DRONE_ROOM__ITEM__URN = 0x20000000000000;
        const VISITED_EBIH__DRONE_ROOM__ITEM__URN_COLLECTION_SKIP = 0x40000000000000;
        const VISITED_EBIH__DRONE_ROOM__ITEM__URN_FAST_TRAVEL = 0x80000000000000;
        const VISITED_EBIH__DRONE_ROOM__MIDDLE_PLATFORM__URN_QUICK_GRAB = 0x100000000000000;
        const VISITED_EBIH__EBIH_EAST__CORNER__URN = 0x200000000000000;
        const VISITED_EBIH__EBIH_EAST__DISPENSER__VEND = 0x400000000000000;
        const VISITED_EBIH__EBIH_EAST__EAST_LEDGE__NOTE = 0x800000000000000;
        const VISITED_EBIH__EBIH_EAST__LOWER_MOVING_PLATFORM__REMOTE_URN = 0x1000000000000000;
        const VISITED_EBIH__EBIH_WEST__ALCOVE__TABLET = 0x2000000000000000;
        const VISITED_EBIH__EBIH_WEST__BLOCK_LEFT__BREAK_BLOCK = 0x4000000000000000;
        const VISITED_EBIH__EBIH_WEST__BLOCK_RIGHT__BREAK_BLOCK = 0x8000000000000000;
...
bitflags!{
    ...
    pub struct ContextBits5 : u64 {
        const VISITED_EBIH__GRID_25_10_12__EAST_10__REMOTE_BUSH = 0x1;
        const VISITED_EBIH__GRID_25_10_12__HIDDEN_BUSH__BEHIND_BUSH = 0x2;
        const VISITED_EBIH__GRID_25_2_6__PIT__ITEM = 0x4;
        const VISITED_EBIH__GRID_26_10_11__LEDGE__NOTE = 0x8;
        const VISITED_EBIH__VERTICAL_INTERCHANGE__SWITCH__ACTIVATE_SWITCH = 0x10;
        const VISITED_EBIH__WATERFALL__ALCOVE_LEFT__BLOCK_LEFT = 0x20;
        const VISITED_EBIH__WATERFALL__ALCOVE_RIGHT__BLOCK_RIGHT = 0x40;
        const VISITED_EBIH__WATERFALL__ALCOVE__BLOCK_LEFT = 0x80;
        const VISITED_EBIH__WATERFALL__ALCOVE__BLOCK_RIGHT = 0x100;
        const VISITED_EBIH__WATERFALL__ALCOVE__PEDESTAL = 0x200;
        const VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_THROUGH_WALL = 0x400;
        const VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL = 0x800;
        const VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL = 0x1000;
        const VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL = 0x2000;
        const VISITED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS = 0x4000;
        const VISITED_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND = 0x8000;
...
bitflags!{
    ...
    pub struct ContextBits6 : u64 {
        const VISITED_GLACIER__APOCALYPSE_ENTRY__GRATE_LEDGE__ESCAPE = 0x1;
        ...
        const VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP = 0x800;
        ...
        const VISITED_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP = 0x200000;
        ...
        const VISITED_IRIKAR__LAMASSU__DESK__ITEM = 0x100000000;
        const VISITED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN = 0x200000000;
        const VISITED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_COLLECTION_SKIP = 0x400000000;
        const VISITED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_FAST_TRAVEL = 0x800000000;
...
bitflags!{
    ...
    pub struct ContextBits7 : u64 {
        ...
        const VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP = 0x800;
        const VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL = 0x1000;
        const VISITED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM = 0x2000;
        const VISITED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN = 0x4000;
        const VISITED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX = 0x8000;
        const VISITED_UHRUM__SIEGE_CORRIDOR__POND__ITEM = 0x10000;
        const VISITED_UHRUM__SIEGE_CORRIDOR__UPPER_ROCK_ITEM__URN = 0x20000;
        const VISITED_UHRUM__SIEGE_CORRIDOR__WESTERN_CACHE__CORE = 0x40000;
        const VISITED_UHRUM__WATERFALLS__ABOVE_BLOCK__BLOCK = 0x80000;
        const VISITED_UHRUM__WATERFALLS__BARRIER_EAST__CHARGE_THROUGH_WALL = 0x100000;
        const VISITED_UHRUM__WATERFALLS__BARRIER_EAST__MIST_THROUGH_WALL = 0x200000;
        const VISITED_UHRUM__WATERFALLS__BARRIER_EAST__SPIN_THROUGH_WALL = 0x400000;
        const VISITED_UHRUM__WATERFALLS__BARRIER_WEST__CHARGE_THROUGH_WALL = 0x800000;
        const VISITED_UHRUM__WATERFALLS__BARRIER_WEST__MIST_THROUGH_WALL = 0x1000000;
        const VISITED_UHRUM__WATERFALLS__BARRIER_WEST__SPIN_THROUGH_WALL = 0x2000000;
        const VISITED_UHRUM__WATERFALLS__BELOW_BLOCK__SHOCKWAVE_BLOCK = 0x4000000;
        const VISITED_UHRUM__WATERFALLS__CEILING_CACHE__FLASK = 0x8000000;
        const VISITED_UHRUM__WATERFALLS__EAST_26__BLOCK = 0x10000000;
        const VISITED_UHRUM__WATERFALLS__WEST_WATER_NOOK__TABLET = 0x20000000;
        const VISITED_UHRUM__WEST_ENTRANCE__GATE_SWITCH__OPEN_GATE = 0x40000000;
        const VISITED_UHRUM__WEST_ENTRANCE__INNER_DAIS__ITEM = 0x80000000;
        const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__CHARGE_THROUGH_WALL = 0x100000000;
        const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__MIST_THROUGH_WALL = 0x200000000;
        const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__SPIN_THROUGH_WALL = 0x400000000;
        const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__CHARGE_THROUGH_WALL = 0x800000000;
        const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__MIST_THROUGH_WALL = 0x1000000000;
        const VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__SPIN_THROUGH_WALL = 0x2000000000;
        const VISITED_UHRUM__WEST_ENTRANCE__SAND__REFILL = 0x4000000000;
        const VISITED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__CHARGE_THROUGH_WALL = 0x8000000000;
        const VISITED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__MIST_THROUGH_WALL = 0x10000000000;
        const VISITED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__SPIN_THROUGH_WALL = 0x20000000000;
        const VISITED_UHRUM__WEST_ENTRANCE__UPPER_WALL_WEST__MIST_THROUGH_WALL = 0x40000000000;
        const SKIPPED_AMAGI__LIRU_ROOM__SHRINE__ITEM = 0x80000000000;
        const SKIPPED_AMAGI__MAIN_AREA__WAY_OFF_TO_THE_SIDE__ITEM = 0x100000000000;
        const SKIPPED_AMAGI__WEST_LAKE__CAVERN_EYE__ITEM = 0x200000000000;
        const SKIPPED_AMAGI__WEST_LAKE__CAVERN_REAR_PILLAR__BOSS_REWARD = 0x400000000000;
        const SKIPPED_AMAGI__WEST_LAKE__CAVERN_REFILL_STATION__BREAK_WALL = 0x800000000000;
        const SKIPPED_AMAGI__WEST_LAKE__CAVERN_REFILL_STATION__DEFEAT_MUS_A_M20 = 0x1000000000000;
        const SKIPPED_AMAGI__WEST_LAKE__CAVERN_TEAR_DUCT__REMOTE_FLASK = 0x2000000000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_CEILING_LEFT__KNOCK_DOWN_LEFT_BOULDER = 0x4000000000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_CEILING_RIGHT__KNOCK_DOWN_RIGHT_BOULDER = 0x8000000000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_FRONT_DOOR__BREAK_WALL = 0x10000000000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_FRONT_ROOM__BREAK_WALL = 0x20000000000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__BREAK_WALL = 0x40000000000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__ITEM = 0x80000000000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_MIDDLE_COLUMN__BREAK_WALL = 0x100000000000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_REAR_WALL__BREAK_LEFT_WALL = 0x200000000000000;
        const SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_TOP__REMOTE_URN = 0x400000000000000;
        const SKIPPED_AMAGI__WEST_LAKE__SURFACE_WALL_LEFT__BREAK_WALL = 0x800000000000000;
        const SKIPPED_AMAGI__WEST_LAKE__SURFACE_WALL_RIGHT__BREAK_WALL = 0x1000000000000000;
        const SKIPPED_ANNUNA__APOCALYPSE__CENTER_SCAFFOLD_WEST__BOSS_FIGHT = 0x2000000000000000;
        const SKIPPED_ANNUNA__APOCALYPSE__CENTER_SCAFFOLD_WEST__FILL_IT_UP = 0x4000000000000000;
        const SKIPPED_ANNUNA__EAST_BRIDGE__BELOW_GATE_BUTTON__SWITCH_FROM_BELOW = 0x8000000000000000;
        const ALL_VISIT_FLAGS = 0x7ffffffffff;
        const ALL_SKIP_FLAGS = 0xfffff80000000000;
    }
}
bitflags!{
    #[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
    pub struct ContextBits8 : u64 {
        const SKIPPED_ANNUNA__EAST_BRIDGE__GATE_BUTTON__SWITCH = 0x1;
        const SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_GATE__TABLET = 0x2;
        const SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM = 0x4;
        const SKIPPED_ANNUNA__EGG_ROOM__CACHE__FLASK = 0x8;
        const SKIPPED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK = 0x10;
        const SKIPPED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__REMOTE_BOOMERANG_FLASK = 0x20;
        const SKIPPED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__SHOCKWAVE_FROM_OUTSIDE = 0x40;
        const SKIPPED_ANNUNA__EGG_ROOM__SECOND_EGG__REMOTE_BOOMERANG_FLASK = 0x80;
        const SKIPPED_ANNUNA__FILTER_TELEPORTER__DOOR_LEDGE__SHOCKWAVE_FLASK = 0x100;
        const SKIPPED_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET = 0x200;
        const SKIPPED_ANNUNA__FILTER_TELEPORTER__SHAFT_BOTTOM__FLASK = 0x400;
        const SKIPPED_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH = 0x800;
        const SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_LOWER__REMOTE_FLASK = 0x1000;
        const SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_UPPER__REMOTE_FLASK = 0x2000;
        const SKIPPED_ANNUNA__MIRROR_MATCH__PLINTH__ITEM = 0x4000;
        const SKIPPED_ANNUNA__MIRROR_MATCH__SAVE_POINT__FIGHT = 0x8000;
        const SKIPPED_ANNUNA__MIRROR_MATCH__WAVING_DISTANCE__SHOCKWAVE_FLASK = 0x10000;
        const SKIPPED_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP = 0x20000;
        const SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM = 0x40000;
        const SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_EAST__BREAK_INNER_WALL = 0x80000;
        const SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_WEST__BREAK_INNER_WALL = 0x100000;
        const SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_EAST__BREAK_OUTER_WALL = 0x200000;
        const SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_WEST__BREAK_OUTER_WALL = 0x400000;
        const SKIPPED_ANNUNA__SNIPER_VALLEY__TABLE__ITEM = 0x800000;
        const SKIPPED_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL = 0x1000000;
        const SKIPPED_ANNUNA__TWISTY_PASSAGES__NORTHWEST_ALCOVE__REFILL = 0x2000000;
        const SKIPPED_ANNUNA__TWISTY_PASSAGES__TOP__TABLET = 0x4000000;
        const SKIPPED_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP = 0x8000000;
        const SKIPPED_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON = 0x10000000;
        const SKIPPED_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM = 0x20000000;
        const SKIPPED_ANNUNA__WEST_BRIDGE__PLINTH__ITEM = 0x40000000;
        const SKIPPED_ANNUNA__WEST_CLIMB__CACHE__ITEM = 0x80000000;
        ...
        const SKIPPED_EBIH__DRONE_ROOM__ITEM__URN_COLLECTION_SKIP = 0x80000000000;
        const SKIPPED_EBIH__DRONE_ROOM__ITEM__URN_FAST_TRAVEL = 0x100000000000;
        const SKIPPED_EBIH__DRONE_ROOM__MIDDLE_PLATFORM__URN_QUICK_GRAB = 0x200000000000;
        const SKIPPED_EBIH__EBIH_EAST__CORNER__URN = 0x400000000000;
        const SKIPPED_EBIH__EBIH_EAST__DISPENSER__VEND = 0x800000000000;
        const SKIPPED_EBIH__EBIH_EAST__EAST_LEDGE__NOTE = 0x1000000000000;
        const SKIPPED_EBIH__EBIH_EAST__LOWER_MOVING_PLATFORM__REMOTE_URN = 0x2000000000000;
        const SKIPPED_EBIH__EBIH_WEST__ALCOVE__TABLET = 0x4000000000000;
        const SKIPPED_EBIH__EBIH_WEST__BLOCK_LEFT__BREAK_BLOCK = 0x8000000000000;
        const SKIPPED_EBIH__EBIH_WEST__BLOCK_RIGHT__BREAK_BLOCK = 0x10000000000000;
        const SKIPPED_EBIH__GRID_25_10_12__EAST_10__REMOTE_BUSH = 0x20000000000000;
        const SKIPPED_EBIH__GRID_25_10_12__HIDDEN_BUSH__BEHIND_BUSH = 0x40000000000000;
        const SKIPPED_EBIH__GRID_25_2_6__PIT__ITEM = 0x80000000000000;
        const SKIPPED_EBIH__GRID_26_10_11__LEDGE__NOTE = 0x100000000000000;
        const SKIPPED_EBIH__VERTICAL_INTERCHANGE__SWITCH__ACTIVATE_SWITCH = 0x200000000000000;
        const SKIPPED_EBIH__WATERFALL__ALCOVE_LEFT__BLOCK_LEFT = 0x400000000000000;
        const SKIPPED_EBIH__WATERFALL__ALCOVE_RIGHT__BLOCK_RIGHT = 0x800000000000000;
        const SKIPPED_EBIH__WATERFALL__ALCOVE__BLOCK_LEFT = 0x1000000000000000;
        const SKIPPED_EBIH__WATERFALL__ALCOVE__BLOCK_RIGHT = 0x2000000000000000;
        const SKIPPED_EBIH__WATERFALL__ALCOVE__PEDESTAL = 0x4000000000000000;
        const SKIPPED_EBIH__WATERFALL__WALL_LEFT__BREAK_THROUGH_WALL = 0x8000000000000000;
...
bitflags!{
    ...
    pub struct ContextBits9 : u64 {
        const SKIPPED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL = 0x1;
        const SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL = 0x2;
        const SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL = 0x4;
        const SKIPPED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS = 0x8;
        const SKIPPED_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND = 0x10;
        ...
        const SKIPPED_GLACIER__BOOMERANG_ROOM__PEDESTAL__ITEM = 0x40000000000000;
        const SKIPPED_GLACIER__BOOMERANG_ROOM__PEDESTAL__SWITCH = 0x80000000000000;
        const SKIPPED_GLACIER__COMPASS_ROOM__CENTER__TABLE = 0x100000000000000;
        const SKIPPED_GLACIER__LEDGE_GRAB_ROOM__CLIFF_BOTTOM__QUICK_GRAB = 0x200000000000000;
        const SKIPPED_GLACIER__LEDGE_GRAB_ROOM__PEDESTAL__ITEM = 0x400000000000000;
        const SKIPPED_GLACIER__THE_BIG_DROP__WATER_SURFACE__DROWN = 0x800000000000000;
        const SKIPPED_GLACIER__VERTICAL_ROOM__PEAK__FLASK = 0x1000000000000000;
        const SKIPPED_GLACIER__VERTICAL_ROOM__UNDER_SWITCH__SWITCH = 0x2000000000000000;
        const SKIPPED_INTERIOR__BUILDING_INTERIOR__CORNER__URN = 0x4000000000000000;
        const SKIPPED_INTERIOR__BUILDING_INTERIOR__ENTRY__REMOTE_URN = 0x8000000000000000;
        const ALL_SKIP_FLAGS = 0xffffffffffffffff;
    }
}
bitflags!{
    ...
    pub struct ContextBits10 : u64 {
        const SKIPPED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP = 0x1;
        const SKIPPED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE = 0x2;
        const SKIPPED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH = 0x4;
        const SKIPPED_INTERIOR__GARAGE__BOXES__UNDER_BOXES = 0x8;
        const SKIPPED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE = 0x10;
        const SKIPPED_INTERIOR__TENT_INTERIOR__DESK__NOTE = 0x20;
        ...
        const SKIPPED_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP = 0x400;
        const SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__BOSS_REWARD = 0x800;
        const SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__DEFEAT_GUDAM = 0x1000;
        const SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__SHOCKWAVE_GUDAM = 0x2000;
        const SKIPPED_IRIKAR__BOSS_ROOM__HEALTHY_ROOFTOP__HEALTH = 0x4000;
        const SKIPPED_IRIKAR__EAST_ROOFTOPS__TOP_ROOFTOP__TABLET = 0x8000;
        const SKIPPED_IRIKAR__HUB__DAGGER_ALTAR__WEAPON = 0x10000;
        const SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__MIST_INTO_WALL = 0x20000;
        const SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__SHOCKWAVE_WALL = 0x40000;
        const SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_IN_WALL__ITEM = 0x80000;
        const SKIPPED_IRIKAR__HUB__SAT_TOWER_TOP_LEDGE__TABLET = 0x100000;
        const SKIPPED_IRIKAR__LAMASSU__DESK__ITEM = 0x200000;
        const SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN = 0x400000;
        const SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_COLLECTION_SKIP = 0x800000;
        const SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_FAST_TRAVEL = 0x1000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_1 = 0x2000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_2 = 0x4000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_3 = 0x8000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_1 = 0x10000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_2 = 0x20000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_3 = 0x40000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_1 = 0x80000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_2 = 0x100000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_3 = 0x200000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_1 = 0x400000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_2 = 0x800000000;
        const SKIPPED_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_3 = 0x1000000000;
        const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_1 = 0x2000000000;
        const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_2 = 0x4000000000;
        const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_3 = 0x8000000000;
        const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_1 = 0x10000000000;
        const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_2 = 0x20000000000;
        const SKIPPED_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_3 = 0x40000000000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_1 = 0x80000000000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_2 = 0x100000000000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_3 = 0x200000000000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_1 = 0x400000000000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_2 = 0x800000000000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_3 = 0x1000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_SPEED_1 = 0x2000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__INFECTION_SPEED_2 = 0x4000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_1 = 0x8000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_2 = 0x10000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_3 = 0x20000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_1 = 0x40000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_2 = 0x80000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_3 = 0x100000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_4 = 0x200000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_5 = 0x400000000000000;
        const SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__MIST_UPGRADE = 0x800000000000000;
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__BLOCK_EAST__DISLODGE_BLOCK = 0x1000000000000000;
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__BLOCK_WEST__DISLODGE_BLOCK = 0x2000000000000000;
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__EAST_CUBBY__TABLET = 0x4000000000000000;
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN = 0x8000000000000000;
        const ALL_SKIP_FLAGS = 0xffffffffffffffff;
    }
}
bitflags!{
    ...
    pub struct ContextBits11 : u32 {
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP = 0x1;
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL = 0x2;
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM = 0x4;
        const SKIPPED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN = 0x8;
        const SKIPPED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX = 0x10;
        const SKIPPED_UHRUM__SIEGE_CORRIDOR__POND__ITEM = 0x20;
        const SKIPPED_UHRUM__SIEGE_CORRIDOR__UPPER_ROCK_ITEM__URN = 0x40;
        const SKIPPED_UHRUM__SIEGE_CORRIDOR__WESTERN_CACHE__CORE = 0x80;
        const SKIPPED_UHRUM__WATERFALLS__ABOVE_BLOCK__BLOCK = 0x100;
        const SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__CHARGE_THROUGH_WALL = 0x200;
        const SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__MIST_THROUGH_WALL = 0x400;
        const SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__SPIN_THROUGH_WALL = 0x800;
        const SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__CHARGE_THROUGH_WALL = 0x1000;
        const SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__MIST_THROUGH_WALL = 0x2000;
        const SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__SPIN_THROUGH_WALL = 0x4000;
        const SKIPPED_UHRUM__WATERFALLS__BELOW_BLOCK__SHOCKWAVE_BLOCK = 0x8000;
        const SKIPPED_UHRUM__WATERFALLS__CEILING_CACHE__FLASK = 0x10000;
        const SKIPPED_UHRUM__WATERFALLS__EAST_26__BLOCK = 0x20000;
        const SKIPPED_UHRUM__WATERFALLS__WEST_WATER_NOOK__TABLET = 0x40000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__GATE_SWITCH__OPEN_GATE = 0x80000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__INNER_DAIS__ITEM = 0x100000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__CHARGE_THROUGH_WALL = 0x200000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__MIST_THROUGH_WALL = 0x400000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__SPIN_THROUGH_WALL = 0x800000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__CHARGE_THROUGH_WALL = 0x1000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__MIST_THROUGH_WALL = 0x2000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__SPIN_THROUGH_WALL = 0x4000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__SAND__REFILL = 0x8000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__CHARGE_THROUGH_WALL = 0x10000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__MIST_THROUGH_WALL = 0x20000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__SPIN_THROUGH_WALL = 0x40000000;
        const SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_WEST__MIST_THROUGH_WALL = 0x80000000;
...
impl context::Ctx for Context {
    ...
    fn has(&self, item: Item) -> bool {
        match item {
            ...
            Item::Hammond_Auth => self.cbits2.contains(flags::ContextBits2::HAMMOND_AUTH),
    ...
    fn count(&self, item: Item) -> i16 {
        match item {
            ...
            Item::Hammond_Auth => self.cbits2.contains(flags::ContextBits2::HAMMOND_AUTH).into(),
            ...
            Item::The_Eternal_Arm => self.cbits3.contains(flags::ContextBits3::THE_ETERNAL_ARM).into(),
    ...
    fn visit(&mut self, loc_id: LocationId) {
        match loc_id {
            ...
            LocationId::Annuna__Vertical_Room__Plinth__Item => self.cbits4.insert(flags::ContextBits4::VISITED_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM),
            LocationId::Annuna__Vertical_Room__Gate_Button__Hit_Button => self.cbits4.insert(flags::ContextBits4::VISITED_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON),
            LocationId::Annuna__Upper_Hallway__Behind_Pedestal__Health_Pickup => self.cbits4.insert(flags::ContextBits4::VISITED_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP),
            LocationId::Annuna__Filter_Teleporter__Door_Ledge__Shockwave_Flask => self.cbits4.insert(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__DOOR_LEDGE__SHOCKWAVE_FLASK),
            LocationId::Annuna__Filter_Teleporter__Shaft_Bottom__Flask => self.cbits4.insert(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__SHAFT_BOTTOM__FLASK),
            LocationId::Annuna__Filter_Teleporter__Northeast_Cubby__Tablet => self.cbits4.insert(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET),
            LocationId::Annuna__Spider_Room__Healthy_Corner__Health_Refill => self.cbits4.insert(flags::ContextBits4::VISITED_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL),
            ...
            LocationId::Annuna__Egg_Room__Second_Egg__Remote_Boomerang_Flask => self.cbits4.insert(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__SECOND_EGG__REMOTE_BOOMERANG_FLASK),
            LocationId::Annuna__Egg_Room__Cache__Flask => self.cbits4.insert(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CACHE__FLASK),
            LocationId::Annuna__Egg_Room__Cache__Shockwave_Flask => self.cbits4.insert(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK),
            LocationId::Annuna__Egg_Room__Corner_Platform__Shockwave_from_Outside => self.cbits4.insert(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__SHOCKWAVE_FROM_OUTSIDE),
            LocationId::Annuna__Egg_Room__Corner_Platform__Remote_Boomerang_Flask => self.cbits4.insert(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__REMOTE_BOOMERANG_FLASK),
            ...
            LocationId::Filter__Core__Terminal_East__Authorize_Hammond => self.cbits5.insert(flags::ContextBits5::VISITED_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND),
            ...
            LocationId::Glacier__Compass_Room__Center__Table => self.cbits6.insert(flags::ContextBits6::VISITED_GLACIER__COMPASS_ROOM__CENTER__TABLE),
            LocationId::Glacier__The_Big_Drop__Water_Surface__Drown => self.cbits6.insert(flags::ContextBits6::VISITED_GLACIER__THE_BIG_DROP__WATER_SURFACE__DROWN),
            LocationId::Glacier__Vertical_Room__Under_Switch__Switch => self.cbits6.insert(flags::ContextBits6::VISITED_GLACIER__VERTICAL_ROOM__UNDER_SWITCH__SWITCH),
            LocationId::Glacier__Vertical_Room__Peak__Flask => self.cbits6.insert(flags::ContextBits6::VISITED_GLACIER__VERTICAL_ROOM__PEAK__FLASK),
            LocationId::Glacier__Boomerang_Room__Pedestal__Item => self.cbits6.insert(flags::ContextBits6::VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__ITEM),
            LocationId::Glacier__Boomerang_Room__Pedestal__Switch => self.cbits6.insert(flags::ContextBits6::VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__SWITCH),
            LocationId::Glacier__Ledge_Grab_Room__Cliff_Bottom__Quick_Grab => self.cbits6.insert(flags::ContextBits6::VISITED_GLACIER__LEDGE_GRAB_ROOM__CLIFF_BOTTOM__QUICK_GRAB),
            LocationId::Glacier__Ledge_Grab_Room__Pedestal__Item => self.cbits6.insert(flags::ContextBits6::VISITED_GLACIER__LEDGE_GRAB_ROOM__PEDESTAL__ITEM),
            LocationId::Glacier__Apocalypse_Entry__Grate_Ledge__Escape => self.cbits6.insert(flags::ContextBits6::VISITED_GLACIER__APOCALYPSE_ENTRY__GRATE_LEDGE__ESCAPE),
            LocationId::Interior__Bunker_Interior__Desk__Note => self.cbits6.insert(flags::ContextBits6::VISITED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE),
            LocationId::Interior__Building_Interior__Entry__Remote_Urn => self.cbits6.insert(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__REMOTE_URN),
            LocationId::Interior__Building_Interior__Entry__Urn_Collection_Skip => self.cbits6.insert(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP),
            LocationId::Interior__Building_Interior__Corner__Urn => self.cbits6.insert(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__CORNER__URN),
            LocationId::Interior__Tent_Interior__Desk__Note => self.cbits6.insert(flags::ContextBits6::VISITED_INTERIOR__TENT_INTERIOR__DESK__NOTE),
            LocationId::Interior__Garage__Boxes__Under_Boxes => self.cbits6.insert(flags::ContextBits6::VISITED_INTERIOR__GARAGE__BOXES__UNDER_BOXES),
            LocationId::Interior__Ebih_Cave__Entry__Health => self.cbits6.insert(flags::ContextBits6::VISITED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH),
            LocationId::Interior__Outpost_Interior__Bookshelf__Note => self.cbits6.insert(flags::ContextBits6::VISITED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE),
            ...
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_1 => self.cbits7.insert(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_1),
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_2 => self.cbits7.insert(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_2),
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_3 => self.cbits7.insert(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_3),
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_4 => self.cbits7.insert(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_4),
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_5 => self.cbits7.insert(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_5),
            LocationId::Menu__Upgrade_Menu__Physiology__Mist_Upgrade => self.cbits7.insert(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__MIST_UPGRADE),
            ...
            LocationId::Menu__Upgrade_Menu__Infection__Nano_Points_3 => self.cbits7.insert(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_3),
            ...
            LocationId::Uhrum__Siege_Corridor__Center_Box__Box => self.cbits7.insert(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX),
            ...
            LocationId::Uhrum__Siege_Corridor__Pond__Item => self.cbits7.insert(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__POND__ITEM),
            ...
            LocationId::Uhrum__Annuna_Corridor__Upper_Trees__Remote_Urn => self.cbits7.insert(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN),
            LocationId::Uhrum__Annuna_Corridor__Pedestal__Urn => self.cbits7.insert(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN),
            LocationId::Uhrum__Annuna_Corridor__Pedestal__Urn_Collection_Skip => self.cbits7.insert(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP),
            LocationId::Uhrum__Annuna_Corridor__Pedestal__Urn_Fast_Travel => self.cbits7.insert(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL),
            LocationId::Uhrum__Annuna_Corridor__Block_West__Dislodge_Block => self.cbits7.insert(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_WEST__DISLODGE_BLOCK),
            LocationId::Uhrum__Annuna_Corridor__Block_East__Dislodge_Block => self.cbits7.insert(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_EAST__DISLODGE_BLOCK),
            LocationId::Uhrum__Annuna_Corridor__East_Cubby__Tablet => self.cbits7.insert(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__EAST_CUBBY__TABLET),
            LocationId::Uhrum__Annuna_Corridor__Statue__Item => self.cbits7.insert(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM),
        }
    }
        ...
        match loc_id {
            ...
            LocationId::Annuna__Mirror_Match__Save_Point__Fight =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__SAVE_POINT__FIGHT) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__SAVE_POINT__FIGHT);
                }
            }
            LocationId::Annuna__Mirror_Match__Below_Switch__Hit_Switch =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH);
                }
            }
            LocationId::Annuna__Mirror_Match__Plinth__Item =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__PLINTH__ITEM) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__PLINTH__ITEM);
                }
            }
            LocationId::Annuna__Mirror_Match__Waving_Distance__Shockwave_Flask =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__WAVING_DISTANCE__SHOCKWAVE_FLASK) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__WAVING_DISTANCE__SHOCKWAVE_FLASK);
                }
            }
            LocationId::Annuna__Mirror_Match__East_26_Lower__Remote_Flask =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__EAST_26_LOWER__REMOTE_FLASK) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_LOWER__REMOTE_FLASK);
                }
            }
            LocationId::Annuna__Mirror_Match__East_26_Upper__Remote_Flask =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__EAST_26_UPPER__REMOTE_FLASK) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_UPPER__REMOTE_FLASK);
                }
            }
            ...
            LocationId::Annuna__East_Bridge__Gate_Button__Switch =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EAST_BRIDGE__GATE_BUTTON__SWITCH) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__EAST_BRIDGE__GATE_BUTTON__SWITCH);
                }
            }
            ...
            LocationId::Annuna__East_Bridge__Tower_Gate__Tablet =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EAST_BRIDGE__TOWER_GATE__TABLET) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_GATE__TABLET);
                }
            }
            LocationId::Annuna__East_Bridge__Tower_Secret__Item =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM);
                }
            }
            LocationId::Annuna__Sniper_Valley__Bridge_End__Health_Pickup =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP);
                }
            }
            LocationId::Annuna__Sniper_Valley__Table__Item =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__TABLE__ITEM) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__TABLE__ITEM);
                }
            }
            LocationId::Annuna__Sniper_Valley__Cavern_Outer_Rock_West__Break_Outer_Wall =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_WEST__BREAK_OUTER_WALL) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_WEST__BREAK_OUTER_WALL);
                }
            }
            LocationId::Annuna__Sniper_Valley__Cavern_Outer_Rock_East__Break_Outer_Wall =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_EAST__BREAK_OUTER_WALL) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_EAST__BREAK_OUTER_WALL);
                }
            }
            LocationId::Annuna__Sniper_Valley__Cavern_Inner_Rock_West__Break_Inner_Wall =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_WEST__BREAK_INNER_WALL) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_WEST__BREAK_INNER_WALL);
                }
            }
            LocationId::Annuna__Sniper_Valley__Cavern_Inner_Rock_East__Break_Inner_Wall =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_EAST__BREAK_INNER_WALL) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_EAST__BREAK_INNER_WALL);
                }
            }
            LocationId::Annuna__Sniper_Valley__Cavern_Cache__Item =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM);
                }
            }
            LocationId::Annuna__Vertical_Room__Plinth__Item =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM);
                }
            }
            LocationId::Annuna__Vertical_Room__Gate_Button__Hit_Button =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON);
                }
            }
            LocationId::Annuna__Upper_Hallway__Behind_Pedestal__Health_Pickup =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP);
                }
            }
            LocationId::Annuna__Filter_Teleporter__Door_Ledge__Shockwave_Flask =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__DOOR_LEDGE__SHOCKWAVE_FLASK) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__FILTER_TELEPORTER__DOOR_LEDGE__SHOCKWAVE_FLASK);
                }
            }
            LocationId::Annuna__Filter_Teleporter__Shaft_Bottom__Flask =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__SHAFT_BOTTOM__FLASK) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__FILTER_TELEPORTER__SHAFT_BOTTOM__FLASK);
                }
            }
            LocationId::Annuna__Filter_Teleporter__Northeast_Cubby__Tablet =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET);
                }
            }
            LocationId::Annuna__Spider_Room__Healthy_Corner__Health_Refill =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL);
                }
            }
            ...
            LocationId::Annuna__Twisty_Passages__Northwest_Alcove__Refill =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__TWISTY_PASSAGES__NORTHWEST_ALCOVE__REFILL) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__TWISTY_PASSAGES__NORTHWEST_ALCOVE__REFILL);
                }
            }
            ...
            LocationId::Annuna__Egg_Room__Second_Egg__Remote_Boomerang_Flask =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__SECOND_EGG__REMOTE_BOOMERANG_FLASK) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__SECOND_EGG__REMOTE_BOOMERANG_FLASK);
                }
            }
            LocationId::Annuna__Egg_Room__Cache__Flask =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CACHE__FLASK) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CACHE__FLASK);
                }
            }
            LocationId::Annuna__Egg_Room__Cache__Shockwave_Flask =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK);
                }
            }
            LocationId::Annuna__Egg_Room__Corner_Platform__Shockwave_from_Outside =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__SHOCKWAVE_FROM_OUTSIDE) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__SHOCKWAVE_FROM_OUTSIDE);
                }
            }
            LocationId::Annuna__Egg_Room__Corner_Platform__Remote_Boomerang_Flask =>  {
                if !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__REMOTE_BOOMERANG_FLASK) {
                    self.cbits8.insert(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__REMOTE_BOOMERANG_FLASK);
                }
            }
            ...
            LocationId::Ebih__Waterfall__Waterfall_Center_Center__Both_Blocks =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS);
                }
            }
            ...
            LocationId::Ebih__Waterfall__Wall_Right__Break_Wall =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL);
                }
            }
            LocationId::Ebih__Waterfall__Wall_Right__Break_Through_Wall =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL);
                }
            }
            LocationId::Ebih__Waterfall__Wall_Left__Break_Wall =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL);
                }
            }
            ...
            LocationId::Filter__Core__Terminal_East__Authorize_Hammond =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND);
                }
            }
            LocationId::Giguna_Breach__Chimney__Cache__Flask =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA_BREACH__CHIMNEY__CACHE__FLASK) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA_BREACH__CHIMNEY__CACHE__FLASK);
                }
            }
            LocationId::Giguna_Breach__Cubby__Rocks__Health =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA_BREACH__CUBBY__ROCKS__HEALTH) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA_BREACH__CUBBY__ROCKS__HEALTH);
                }
            }
            LocationId::Giguna_Breach__Slingshot__Ravine__Urn =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA_BREACH__SLINGSHOT__RAVINE__URN) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA_BREACH__SLINGSHOT__RAVINE__URN);
                }
            }
            LocationId::Giguna__Giguna_Northeast__Gate_Button__Open_Gate =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_NORTHEAST__GATE_BUTTON__OPEN_GATE) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__GATE_BUTTON__OPEN_GATE);
                }
            }
            LocationId::Giguna__Giguna_Northeast__Gate_Right__Remote_Button =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_NORTHEAST__GATE_RIGHT__REMOTE_BUTTON) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__GATE_RIGHT__REMOTE_BUTTON);
                }
            }
            LocationId::Giguna__Giguna_Northeast__Door__Remote_Flask =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_NORTHEAST__DOOR__REMOTE_FLASK) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__DOOR__REMOTE_FLASK);
                }
            }
            LocationId::Giguna__Giguna_Northeast__Vault__Item =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_NORTHEAST__VAULT__ITEM) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__VAULT__ITEM);
                }
            }
            LocationId::Giguna__Carnelian__Vault__Item =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__CARNELIAN__VAULT__ITEM) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__CARNELIAN__VAULT__ITEM);
                }
            }
            ...
            LocationId::Giguna__Giguna_Base__Ruin__Item =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_BASE__RUIN__ITEM) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_BASE__RUIN__ITEM);
                }
            }
            LocationId::Giguna__Giguna_Base__Table__News =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_BASE__TABLE__NEWS) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_BASE__TABLE__NEWS);
                }
            }
            ...
            LocationId::Giguna__Far_Corner__Grass__Obscured_Item =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__FAR_CORNER__GRASS__OBSCURED_ITEM) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__FAR_CORNER__GRASS__OBSCURED_ITEM);
                }
            }
            ...
            LocationId::Giguna__Clouds__Cache__Item =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__CLOUDS__CACHE__ITEM) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__CLOUDS__CACHE__ITEM);
                }
            }
            ...
            LocationId::Giguna__Dual_Path__Below_Left_Switch__Remote_Switch =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__BELOW_LEFT_SWITCH__REMOTE_SWITCH) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BELOW_LEFT_SWITCH__REMOTE_SWITCH);
                }
            }
            LocationId::Giguna__Dual_Path__Left_Switch__Hit_Switch =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__LEFT_SWITCH__HIT_SWITCH) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__LEFT_SWITCH__HIT_SWITCH);
                }
            }
            LocationId::Giguna__Dual_Path__Base_of_Wall__Break_Wall =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__BASE_OF_WALL__BREAK_WALL) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BASE_OF_WALL__BREAK_WALL);
                }
            }
            LocationId::Giguna__Dual_Path__Base_of_Wall__Mist_into_Wall =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__BASE_OF_WALL__MIST_INTO_WALL) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BASE_OF_WALL__MIST_INTO_WALL);
                }
            }
            LocationId::Giguna__Dual_Path__Wall_Secret__Health =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__WALL_SECRET__HEALTH) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__WALL_SECRET__HEALTH);
                }
            }
            LocationId::Giguna__Dual_Path__Right_Switch__Hit_Switch =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__RIGHT_SWITCH__HIT_SWITCH) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__RIGHT_SWITCH__HIT_SWITCH);
                }
            }
            LocationId::Giguna__Dual_Path__Below_Right_Switch__Remote_Switch =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__BELOW_RIGHT_SWITCH__REMOTE_SWITCH) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BELOW_RIGHT_SWITCH__REMOTE_SWITCH);
                }
            }
            ...
            LocationId::Giguna__East_Caverns__Hidden_Passage_Center__Hidden_Flask =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__EAST_CAVERNS__HIDDEN_PASSAGE_CENTER__HIDDEN_FLASK) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__EAST_CAVERNS__HIDDEN_PASSAGE_CENTER__HIDDEN_FLASK);
                }
            }
            LocationId::Giguna__Gateway__Block_Left__Shockwave =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GATEWAY__BLOCK_LEFT__SHOCKWAVE) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__BLOCK_LEFT__SHOCKWAVE);
                }
            }
            LocationId::Giguna__Gateway__Block_Right__Shockwave =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GATEWAY__BLOCK_RIGHT__SHOCKWAVE) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__BLOCK_RIGHT__SHOCKWAVE);
                }
            }
            LocationId::Giguna__Gateway__Flask_Ledge__Item =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GATEWAY__FLASK_LEDGE__ITEM) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__FLASK_LEDGE__ITEM);
                }
            }
            LocationId::Giguna__Gateway__Button__Hit_Switch =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GATEWAY__BUTTON__HIT_SWITCH) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__BUTTON__HIT_SWITCH);
                }
            }
            LocationId::Giguna__Antechamber__Statue_Head__Tablet =>  {
                if !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__ANTECHAMBER__STATUE_HEAD__TABLET) {
                    self.cbits9.insert(flags::ContextBits9::SKIPPED_GIGUNA__ANTECHAMBER__STATUE_HEAD__TABLET);
                }
            }
            ...
            LocationId::Glacier__Compass_Room__Center__Table =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__COMPASS_ROOM__CENTER__TABLE) {
            ...
            LocationId::Glacier__The_Big_Drop__Water_Surface__Drown =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__THE_BIG_DROP__WATER_SURFACE__DROWN) {
            ...
            LocationId::Glacier__Vertical_Room__Under_Switch__Switch =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__VERTICAL_ROOM__UNDER_SWITCH__SWITCH) {
            ...
            LocationId::Glacier__Vertical_Room__Peak__Flask =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__VERTICAL_ROOM__PEAK__FLASK) {
            ...
            LocationId::Glacier__Boomerang_Room__Pedestal__Item =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__ITEM) {
            ...
            LocationId::Glacier__Boomerang_Room__Pedestal__Switch =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__SWITCH) {
            ...
            LocationId::Glacier__Ledge_Grab_Room__Cliff_Bottom__Quick_Grab =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__LEDGE_GRAB_ROOM__CLIFF_BOTTOM__QUICK_GRAB) {
            ...
            LocationId::Glacier__Ledge_Grab_Room__Pedestal__Item =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__LEDGE_GRAB_ROOM__PEDESTAL__ITEM) {
            ...
            LocationId::Glacier__Apocalypse_Entry__Grate_Ledge__Escape =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__APOCALYPSE_ENTRY__GRATE_LEDGE__ESCAPE) {
            ...
            LocationId::Interior__Bunker_Interior__Desk__Note =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE);
                }
            }
            LocationId::Interior__Building_Interior__Entry__Remote_Urn =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__REMOTE_URN) {
            ...
            LocationId::Interior__Building_Interior__Entry__Urn_Collection_Skip =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP);
                }
            }
            LocationId::Interior__Building_Interior__Corner__Urn =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__CORNER__URN) {
            ...
            LocationId::Interior__Tent_Interior__Desk__Note =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__TENT_INTERIOR__DESK__NOTE) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_INTERIOR__TENT_INTERIOR__DESK__NOTE);
                }
            }
            LocationId::Interior__Garage__Boxes__Under_Boxes =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__GARAGE__BOXES__UNDER_BOXES) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_INTERIOR__GARAGE__BOXES__UNDER_BOXES);
                }
            }
            LocationId::Interior__Ebih_Cave__Entry__Health =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH);
                }
            }
            LocationId::Interior__Outpost_Interior__Bookshelf__Note =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE);
                }
            }
            LocationId::Irikar_Breach__Gauntlet__Hidden_Path_Reward__Item =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR_BREACH__GAUNTLET__HIDDEN_PATH_REWARD__ITEM) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR_BREACH__GAUNTLET__HIDDEN_PATH_REWARD__ITEM);
                }
            }
            LocationId::Irikar_Breach__Hover_Room__Bottom__Item =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR_BREACH__HOVER_ROOM__BOTTOM__ITEM) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR_BREACH__HOVER_ROOM__BOTTOM__ITEM);
                }
            }
            LocationId::Irikar_Breach__Worm_Rave__Corner__Item =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR_BREACH__WORM_RAVE__CORNER__ITEM) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR_BREACH__WORM_RAVE__CORNER__ITEM);
                }
            }
            LocationId::Irikar__Hub__Sat_Tower_Top_Ledge__Tablet =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__HUB__SAT_TOWER_TOP_LEDGE__TABLET) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__HUB__SAT_TOWER_TOP_LEDGE__TABLET);
                }
            }
            LocationId::Irikar__Hub__Dagger_Altar__Weapon =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__HUB__DAGGER_ALTAR__WEAPON) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__HUB__DAGGER_ALTAR__WEAPON);
                }
            }
            LocationId::Irikar__Hub__Royal_Storage_By_Wall__Shockwave_Wall =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__SHOCKWAVE_WALL) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__SHOCKWAVE_WALL);
                }
            }
            LocationId::Irikar__Hub__Royal_Storage_By_Wall__Mist_into_Wall =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__MIST_INTO_WALL) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__MIST_INTO_WALL);
                }
            }
            LocationId::Irikar__Hub__Royal_Storage_in_Wall__Item =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__HUB__ROYAL_STORAGE_IN_WALL__ITEM) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_IN_WALL__ITEM);
                }
            }
            LocationId::Irikar__Sight_Room__Item_Pedestal__Urn =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN);
                }
            }
            LocationId::Irikar__Sight_Room__Item_Pedestal__Urn_Collection_Skip =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_COLLECTION_SKIP) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_COLLECTION_SKIP);
                }
            }
            LocationId::Irikar__Sight_Room__Item_Pedestal__Urn_Fast_Travel =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_FAST_TRAVEL) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_FAST_TRAVEL);
                }
            }
            LocationId::Irikar__Abandoned_Room__Corner_Core__Core =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__ABANDONED_ROOM__CORNER_CORE__CORE) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__ABANDONED_ROOM__CORNER_CORE__CORE);
                }
            }
            LocationId::Irikar__Basement_Pipes__Left_Vertical_Pipe__Health_Pickup =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP);
                }
            }
            LocationId::Irikar__Boss_Room__Bulls_Feet__Defeat_Gudam =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__BOSS_ROOM__BULLS_FEET__DEFEAT_GUDAM) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__DEFEAT_GUDAM);
                }
            }
            LocationId::Irikar__Boss_Room__Bulls_Feet__Shockwave_Gudam =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__BOSS_ROOM__BULLS_FEET__SHOCKWAVE_GUDAM) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__SHOCKWAVE_GUDAM);
                }
            }
            LocationId::Irikar__Boss_Room__Bulls_Feet__Boss_Reward =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__BOSS_ROOM__BULLS_FEET__BOSS_REWARD) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__BOSS_REWARD);
                }
            }
            LocationId::Irikar__Boss_Room__Healthy_Rooftop__Health =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__BOSS_ROOM__HEALTHY_ROOFTOP__HEALTH) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__HEALTHY_ROOFTOP__HEALTH);
                }
            }
            LocationId::Irikar__East_Rooftops__Top_Rooftop__Tablet =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__EAST_ROOFTOPS__TOP_ROOFTOP__TABLET) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__EAST_ROOFTOPS__TOP_ROOFTOP__TABLET);
                }
            }
            LocationId::Irikar__Lamassu__Desk__Item =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__LAMASSU__DESK__ITEM) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_IRIKAR__LAMASSU__DESK__ITEM);
                }
            }
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_1 =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_1) {
            ...
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_2 =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_2) {
            ...
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_3 =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_3) {
            ...
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_4 =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_4) {
            ...
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_5 =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_5) {
            ...
            LocationId::Menu__Upgrade_Menu__Physiology__Mist_Upgrade =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__MIST_UPGRADE) {
            ...
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Damage_1 =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_1) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_1);
                }
            }
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Damage_2 =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_2) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_2);
                }
            }
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Damage_3 =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_3) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_3);
                }
            }
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Speed_1 =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_1) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_1);
                }
            }
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Speed_2 =>  {
                if !self.cbits6.contains(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_2) {
                    self.cbits10.insert(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_2);
                }
            }
            ...
            LocationId::Menu__Upgrade_Menu__Infection__Nano_Points_3 =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_3) {
            ...
            LocationId::Uhrum__West_Entrance__Inner_Dais__Item =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__INNER_DAIS__ITEM) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__INNER_DAIS__ITEM);
                }
            }
            LocationId::Uhrum__West_Entrance__Gate_Switch__Open_Gate =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__GATE_SWITCH__OPEN_GATE) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__GATE_SWITCH__OPEN_GATE);
                }
            }
            ...
            LocationId::Uhrum__West_Entrance__Upper_Wall_East__Charge_through_Wall =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__CHARGE_THROUGH_WALL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__CHARGE_THROUGH_WALL);
                }
            }
            ...
            LocationId::Uhrum__West_Entrance__Upper_Wall_East__Mist_through_Wall =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__MIST_THROUGH_WALL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__MIST_THROUGH_WALL);
                }
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_West__Charge_through_Wall =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__CHARGE_THROUGH_WALL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__CHARGE_THROUGH_WALL);
                }
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_West__Spin_through_Wall =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__SPIN_THROUGH_WALL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__SPIN_THROUGH_WALL);
                }
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_West__Mist_through_Wall =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__MIST_THROUGH_WALL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__MIST_THROUGH_WALL);
                }
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_East__Charge_through_Wall =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__CHARGE_THROUGH_WALL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__CHARGE_THROUGH_WALL);
                }
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_East__Spin_through_Wall =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__SPIN_THROUGH_WALL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__SPIN_THROUGH_WALL);
                }
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_East__Mist_through_Wall =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__MIST_THROUGH_WALL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__MIST_THROUGH_WALL);
                }
            }
            LocationId::Uhrum__West_Entrance__Sand__Refill =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__SAND__REFILL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__SAND__REFILL);
                }
            }
            LocationId::Uhrum__Siege_Corridor__Western_Cache__Core =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__WESTERN_CACHE__CORE) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__WESTERN_CACHE__CORE);
                }
            }
            LocationId::Uhrum__Siege_Corridor__Center_Box__Box =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX);
                }
            }
            LocationId::Uhrum__Siege_Corridor__Upper_Rock_Item__Urn =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__UPPER_ROCK_ITEM__URN) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__UPPER_ROCK_ITEM__URN);
                }
            }
            LocationId::Uhrum__Siege_Corridor__Pond__Item =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__POND__ITEM) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__POND__ITEM);
                }
            }
            LocationId::Uhrum__Waterfalls__Ceiling_Cache__Flask =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__CEILING_CACHE__FLASK) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__CEILING_CACHE__FLASK);
                }
            }
            LocationId::Uhrum__Waterfalls__Barrier_West__Charge_through_Wall =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_WEST__CHARGE_THROUGH_WALL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__CHARGE_THROUGH_WALL);
                }
            }
            LocationId::Uhrum__Waterfalls__Barrier_West__Spin_through_Wall =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_WEST__SPIN_THROUGH_WALL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__SPIN_THROUGH_WALL);
                }
            }
            LocationId::Uhrum__Waterfalls__Barrier_West__Mist_through_Wall =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_WEST__MIST_THROUGH_WALL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__MIST_THROUGH_WALL);
                }
            }
            LocationId::Uhrum__Waterfalls__Barrier_East__Charge_through_Wall =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_EAST__CHARGE_THROUGH_WALL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__CHARGE_THROUGH_WALL);
                }
            }
            LocationId::Uhrum__Waterfalls__Barrier_East__Spin_through_Wall =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_EAST__SPIN_THROUGH_WALL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__SPIN_THROUGH_WALL);
                }
            }
            LocationId::Uhrum__Waterfalls__Barrier_East__Mist_through_Wall =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_EAST__MIST_THROUGH_WALL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__MIST_THROUGH_WALL);
                }
            }
            LocationId::Uhrum__Waterfalls__Below_Block__Shockwave_Block =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BELOW_BLOCK__SHOCKWAVE_BLOCK) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BELOW_BLOCK__SHOCKWAVE_BLOCK);
                }
            }
            LocationId::Uhrum__Waterfalls__Above_Block__Block =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__ABOVE_BLOCK__BLOCK) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__ABOVE_BLOCK__BLOCK);
                }
            }
            LocationId::Uhrum__Waterfalls__East_26__Block =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__EAST_26__BLOCK) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__EAST_26__BLOCK);
                }
            }
            LocationId::Uhrum__Waterfalls__West_Water_Nook__Tablet =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__WEST_WATER_NOOK__TABLET) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__WEST_WATER_NOOK__TABLET);
                }
            }
            LocationId::Uhrum__Annuna_Corridor__Upper_Trees__Remote_Urn =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN);
                }
            }
            LocationId::Uhrum__Annuna_Corridor__Pedestal__Urn =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN) {
            ...
            LocationId::Uhrum__Annuna_Corridor__Pedestal__Urn_Collection_Skip =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP);
                }
            }
            LocationId::Uhrum__Annuna_Corridor__Pedestal__Urn_Fast_Travel =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL);
                }
            }
            LocationId::Uhrum__Annuna_Corridor__Block_West__Dislodge_Block =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_WEST__DISLODGE_BLOCK) {
            ...
            LocationId::Uhrum__Annuna_Corridor__Block_East__Dislodge_Block =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_EAST__DISLODGE_BLOCK) {
            ...
            LocationId::Uhrum__Annuna_Corridor__East_Cubby__Tablet =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__EAST_CUBBY__TABLET) {
            ...
            LocationId::Uhrum__Annuna_Corridor__Statue__Item =>  {
                if !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM) {
                    self.cbits11.insert(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM);
                }
            }
        }
    }
    fn reset(&mut self, loc_id: LocationId) {
        match loc_id {
            ...
            LocationId::Amagi__West_Lake__Stronghold_Item__Item => {
                self.cbits4.remove(flags::ContextBits4::VISITED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__ITEM);
                self.cbits7.remove(flags::ContextBits7::SKIPPED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__ITEM);
            }
            LocationId::Amagi__West_Lake__Stronghold_Item__Break_Wall => {
                self.cbits4.remove(flags::ContextBits4::VISITED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__BREAK_WALL);
            ...
            LocationId::Annuna__Mirror_Match__Save_Point__Fight => {
                ...
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__SAVE_POINT__FIGHT);
            }
            LocationId::Annuna__Mirror_Match__Below_Switch__Hit_Switch => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH);
            }
            LocationId::Annuna__Mirror_Match__Plinth__Item => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__PLINTH__ITEM);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__PLINTH__ITEM);
            }
            LocationId::Annuna__Mirror_Match__Waving_Distance__Shockwave_Flask => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__WAVING_DISTANCE__SHOCKWAVE_FLASK);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__WAVING_DISTANCE__SHOCKWAVE_FLASK);
            }
            LocationId::Annuna__Mirror_Match__East_26_Lower__Remote_Flask => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__EAST_26_LOWER__REMOTE_FLASK);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_LOWER__REMOTE_FLASK);
            }
            LocationId::Annuna__Mirror_Match__East_26_Upper__Remote_Flask => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__EAST_26_UPPER__REMOTE_FLASK);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_UPPER__REMOTE_FLASK);
            }
            LocationId::Annuna__West_Bridge__Plinth__Item => {
            ...
            LocationId::Annuna__East_Bridge__Gate_Button__Switch => {
                ...
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__EAST_BRIDGE__GATE_BUTTON__SWITCH);
            }
            LocationId::Annuna__East_Bridge__Below_Gate_Button__Switch_from_Below => {
            ...
            LocationId::Annuna__East_Bridge__Tower_Gate__Tablet => {
                ...
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_GATE__TABLET);
            }
            LocationId::Annuna__East_Bridge__Tower_Secret__Item => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM);
            }
            LocationId::Annuna__Sniper_Valley__Bridge_End__Health_Pickup => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP);
            }
            LocationId::Annuna__Sniper_Valley__Table__Item => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__TABLE__ITEM);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__TABLE__ITEM);
            }
            LocationId::Annuna__Sniper_Valley__Cavern_Outer_Rock_West__Break_Outer_Wall => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_WEST__BREAK_OUTER_WALL);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_WEST__BREAK_OUTER_WALL);
            }
            LocationId::Annuna__Sniper_Valley__Cavern_Outer_Rock_East__Break_Outer_Wall => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_EAST__BREAK_OUTER_WALL);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_EAST__BREAK_OUTER_WALL);
            }
            LocationId::Annuna__Sniper_Valley__Cavern_Inner_Rock_West__Break_Inner_Wall => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_WEST__BREAK_INNER_WALL);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_WEST__BREAK_INNER_WALL);
            }
            LocationId::Annuna__Sniper_Valley__Cavern_Inner_Rock_East__Break_Inner_Wall => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_EAST__BREAK_INNER_WALL);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_EAST__BREAK_INNER_WALL);
            }
            LocationId::Annuna__Sniper_Valley__Cavern_Cache__Item => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM);
            }
            LocationId::Annuna__Vertical_Room__Plinth__Item => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM);
            }
            LocationId::Annuna__Vertical_Room__Gate_Button__Hit_Button => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON);
            }
            LocationId::Annuna__Upper_Hallway__Behind_Pedestal__Health_Pickup => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP);
            }
            LocationId::Annuna__Filter_Teleporter__Door_Ledge__Shockwave_Flask => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__DOOR_LEDGE__SHOCKWAVE_FLASK);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__FILTER_TELEPORTER__DOOR_LEDGE__SHOCKWAVE_FLASK);
            }
            LocationId::Annuna__Filter_Teleporter__Shaft_Bottom__Flask => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__SHAFT_BOTTOM__FLASK);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__FILTER_TELEPORTER__SHAFT_BOTTOM__FLASK);
            }
            LocationId::Annuna__Filter_Teleporter__Northeast_Cubby__Tablet => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET);
            }
            LocationId::Annuna__Spider_Room__Healthy_Corner__Health_Refill => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL);
            }
            LocationId::Annuna__Twisty_Passages__Top__Tablet => {
            ...
            LocationId::Annuna__Twisty_Passages__Northwest_Alcove__Refill => {
                ...
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__TWISTY_PASSAGES__NORTHWEST_ALCOVE__REFILL);
            }
            LocationId::Annuna__West_Climb__Cache__Item => {
            ...
            LocationId::Annuna__Egg_Room__Second_Egg__Remote_Boomerang_Flask => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__SECOND_EGG__REMOTE_BOOMERANG_FLASK);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__SECOND_EGG__REMOTE_BOOMERANG_FLASK);
            }
            LocationId::Annuna__Egg_Room__Cache__Flask => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CACHE__FLASK);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CACHE__FLASK);
            }
            LocationId::Annuna__Egg_Room__Cache__Shockwave_Flask => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK);
            }
            LocationId::Annuna__Egg_Room__Corner_Platform__Shockwave_from_Outside => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__SHOCKWAVE_FROM_OUTSIDE);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__SHOCKWAVE_FROM_OUTSIDE);
            }
            LocationId::Annuna__Egg_Room__Corner_Platform__Remote_Boomerang_Flask => {
                self.cbits4.remove(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__REMOTE_BOOMERANG_FLASK);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__REMOTE_BOOMERANG_FLASK);
            }
            LocationId::Annuna__Apocalypse__Center_Scaffold_West__Boss_Fight => {
            ...
            LocationId::Ebih__Grid_25_10_12__East_10__Remote_Bush => {
                self.cbits5.remove(flags::ContextBits5::VISITED_EBIH__GRID_25_10_12__EAST_10__REMOTE_BUSH);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_EBIH__GRID_25_10_12__EAST_10__REMOTE_BUSH);
            }
            LocationId::Ebih__Grid_25_10_12__Hidden_Bush__Behind_Bush => {
                self.cbits5.remove(flags::ContextBits5::VISITED_EBIH__GRID_25_10_12__HIDDEN_BUSH__BEHIND_BUSH);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_EBIH__GRID_25_10_12__HIDDEN_BUSH__BEHIND_BUSH);
            }
            LocationId::Ebih__Waterfall__Alcove_Right__Block_Right => {
                self.cbits5.remove(flags::ContextBits5::VISITED_EBIH__WATERFALL__ALCOVE_RIGHT__BLOCK_RIGHT);
            ...
            LocationId::Ebih__Waterfall__Waterfall_Center_Center__Both_Blocks => {
                ...
                self.cbits9.remove(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS);
            }
            LocationId::Ebih__Waterfall__Alcove_Left__Block_Left => {
                self.cbits5.remove(flags::ContextBits5::VISITED_EBIH__WATERFALL__ALCOVE_LEFT__BLOCK_LEFT);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_EBIH__WATERFALL__ALCOVE_LEFT__BLOCK_LEFT);
            }
            LocationId::Ebih__Waterfall__Alcove__Pedestal => {
                self.cbits5.remove(flags::ContextBits5::VISITED_EBIH__WATERFALL__ALCOVE__PEDESTAL);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_EBIH__WATERFALL__ALCOVE__PEDESTAL);
            }
            LocationId::Ebih__Waterfall__Alcove__Block_Right => {
                self.cbits5.remove(flags::ContextBits5::VISITED_EBIH__WATERFALL__ALCOVE__BLOCK_RIGHT);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_EBIH__WATERFALL__ALCOVE__BLOCK_RIGHT);
            }
            LocationId::Ebih__Waterfall__Alcove__Block_Left => {
                self.cbits5.remove(flags::ContextBits5::VISITED_EBIH__WATERFALL__ALCOVE__BLOCK_LEFT);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_EBIH__WATERFALL__ALCOVE__BLOCK_LEFT);
            }
            LocationId::Ebih__Waterfall__Wall_Right__Break_Wall => {
                self.cbits5.remove(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL);
            }
            LocationId::Ebih__Waterfall__Wall_Right__Break_Through_Wall => {
                self.cbits5.remove(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL);
            }
            LocationId::Ebih__Waterfall__Wall_Left__Break_Wall => {
                self.cbits5.remove(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL);
            }
            LocationId::Ebih__Waterfall__Wall_Left__Break_Through_Wall => {
                self.cbits5.remove(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_THROUGH_WALL);
            ...
            LocationId::Ebih__Grid_25_2_6__Pit__Item => {
                self.cbits5.remove(flags::ContextBits5::VISITED_EBIH__GRID_25_2_6__PIT__ITEM);
                self.cbits8.remove(flags::ContextBits8::SKIPPED_EBIH__GRID_25_2_6__PIT__ITEM);
            }
            LocationId::Ebih__Grid_26_10_11__Ledge__Note => {
                self.cbits5.remove(flags::ContextBits5::VISITED_EBIH__GRID_26_10_11__LEDGE__NOTE);
            ...
            LocationId::Filter__Core__Terminal_East__Authorize_Hammond => {
                self.cbits5.remove(flags::ContextBits5::VISITED_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND);
            }
            LocationId::Giguna_Breach__Chimney__Cache__Flask => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA_BREACH__CHIMNEY__CACHE__FLASK);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA_BREACH__CHIMNEY__CACHE__FLASK);
            }
            LocationId::Giguna_Breach__Cubby__Rocks__Health => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA_BREACH__CUBBY__ROCKS__HEALTH);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA_BREACH__CUBBY__ROCKS__HEALTH);
            }
            LocationId::Giguna_Breach__Slingshot__Ravine__Urn => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA_BREACH__SLINGSHOT__RAVINE__URN);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA_BREACH__SLINGSHOT__RAVINE__URN);
            }
            LocationId::Giguna__Giguna_Northeast__Gate_Button__Open_Gate => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_NORTHEAST__GATE_BUTTON__OPEN_GATE);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__GATE_BUTTON__OPEN_GATE);
            }
            LocationId::Giguna__Giguna_Northeast__Gate_Right__Remote_Button => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_NORTHEAST__GATE_RIGHT__REMOTE_BUTTON);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__GATE_RIGHT__REMOTE_BUTTON);
            }
            LocationId::Giguna__Giguna_Northeast__Door__Remote_Flask => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_NORTHEAST__DOOR__REMOTE_FLASK);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__DOOR__REMOTE_FLASK);
            }
            LocationId::Giguna__Giguna_Northeast__Vault__Item => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_NORTHEAST__VAULT__ITEM);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__VAULT__ITEM);
            }
            LocationId::Giguna__Carnelian__Vault__Item => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__CARNELIAN__VAULT__ITEM);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__CARNELIAN__VAULT__ITEM);
            }
            LocationId::Giguna__West_Caverns__Cache__Item => {
            ...
            LocationId::Giguna__Giguna_Base__Ruin__Item => {
                ...
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_BASE__RUIN__ITEM);
            }
            LocationId::Giguna__Giguna_Base__Table__News => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_BASE__TABLE__NEWS);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_BASE__TABLE__NEWS);
            }
            LocationId::Giguna__Ruins_East__Way_Up_High__Item => {
            ...
            LocationId::Giguna__Far_Corner__Grass__Obscured_Item => {
                ...
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__FAR_CORNER__GRASS__OBSCURED_ITEM);
            }
            LocationId::Giguna__Helipad__Tablet_Ledge__Tablet => {
            ...
            LocationId::Giguna__Clouds__Cache__Item => {
                ...
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__CLOUDS__CACHE__ITEM);
            }
            LocationId::Giguna__Lamassu__Deposit__Flask => {
            ...
            LocationId::Giguna__Dual_Path__Below_Left_Switch__Remote_Switch => {
                ...
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BELOW_LEFT_SWITCH__REMOTE_SWITCH);
            }
            LocationId::Giguna__Dual_Path__Left_Switch__Hit_Switch => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__LEFT_SWITCH__HIT_SWITCH);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__LEFT_SWITCH__HIT_SWITCH);
            }
            LocationId::Giguna__Dual_Path__Base_of_Wall__Break_Wall => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__BASE_OF_WALL__BREAK_WALL);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BASE_OF_WALL__BREAK_WALL);
            }
            LocationId::Giguna__Dual_Path__Base_of_Wall__Mist_into_Wall => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__BASE_OF_WALL__MIST_INTO_WALL);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BASE_OF_WALL__MIST_INTO_WALL);
            }
            LocationId::Giguna__Dual_Path__Wall_Secret__Health => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__WALL_SECRET__HEALTH);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__WALL_SECRET__HEALTH);
            }
            LocationId::Giguna__Dual_Path__Right_Switch__Hit_Switch => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__RIGHT_SWITCH__HIT_SWITCH);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__RIGHT_SWITCH__HIT_SWITCH);
            }
            LocationId::Giguna__Dual_Path__Below_Right_Switch__Remote_Switch => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__BELOW_RIGHT_SWITCH__REMOTE_SWITCH);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BELOW_RIGHT_SWITCH__REMOTE_SWITCH);
            }
            LocationId::Giguna__Hard_Rock__Rock_Right__Shockwave_Boulder => {
            ...
            LocationId::Giguna__East_Caverns__Hidden_Passage_Center__Hidden_Flask => {
                ...
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__EAST_CAVERNS__HIDDEN_PASSAGE_CENTER__HIDDEN_FLASK);
            }
            LocationId::Giguna__Gateway__Block_Left__Shockwave => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__GATEWAY__BLOCK_LEFT__SHOCKWAVE);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__BLOCK_LEFT__SHOCKWAVE);
            }
            LocationId::Giguna__Gateway__Block_Right__Shockwave => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__GATEWAY__BLOCK_RIGHT__SHOCKWAVE);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__BLOCK_RIGHT__SHOCKWAVE);
            }
            LocationId::Giguna__Gateway__Flask_Ledge__Item => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__GATEWAY__FLASK_LEDGE__ITEM);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__FLASK_LEDGE__ITEM);
            }
            LocationId::Giguna__Gateway__Button__Hit_Switch => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__GATEWAY__BUTTON__HIT_SWITCH);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__BUTTON__HIT_SWITCH);
            }
            LocationId::Giguna__Antechamber__Statue_Head__Tablet => {
                self.cbits5.remove(flags::ContextBits5::VISITED_GIGUNA__ANTECHAMBER__STATUE_HEAD__TABLET);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GIGUNA__ANTECHAMBER__STATUE_HEAD__TABLET);
            }
            LocationId::Giguna__Gubi_Lair__Center_Platform__Hack_Gubi => {
            ...
            LocationId::Glacier__Compass_Room__Center__Table => {
                self.cbits6.remove(flags::ContextBits6::VISITED_GLACIER__COMPASS_ROOM__CENTER__TABLE);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GLACIER__COMPASS_ROOM__CENTER__TABLE);
            }
            LocationId::Glacier__The_Big_Drop__Water_Surface__Drown => {
                self.cbits6.remove(flags::ContextBits6::VISITED_GLACIER__THE_BIG_DROP__WATER_SURFACE__DROWN);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GLACIER__THE_BIG_DROP__WATER_SURFACE__DROWN);
            }
            LocationId::Glacier__Vertical_Room__Under_Switch__Switch => {
                self.cbits6.remove(flags::ContextBits6::VISITED_GLACIER__VERTICAL_ROOM__UNDER_SWITCH__SWITCH);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GLACIER__VERTICAL_ROOM__UNDER_SWITCH__SWITCH);
            }
            LocationId::Glacier__Vertical_Room__Peak__Flask => {
                self.cbits6.remove(flags::ContextBits6::VISITED_GLACIER__VERTICAL_ROOM__PEAK__FLASK);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GLACIER__VERTICAL_ROOM__PEAK__FLASK);
            }
            LocationId::Glacier__Boomerang_Room__Pedestal__Item => {
                self.cbits6.remove(flags::ContextBits6::VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__ITEM);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GLACIER__BOOMERANG_ROOM__PEDESTAL__ITEM);
            }
            LocationId::Glacier__Boomerang_Room__Pedestal__Switch => {
                self.cbits6.remove(flags::ContextBits6::VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__SWITCH);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GLACIER__BOOMERANG_ROOM__PEDESTAL__SWITCH);
            }
            LocationId::Glacier__Ledge_Grab_Room__Cliff_Bottom__Quick_Grab => {
                self.cbits6.remove(flags::ContextBits6::VISITED_GLACIER__LEDGE_GRAB_ROOM__CLIFF_BOTTOM__QUICK_GRAB);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GLACIER__LEDGE_GRAB_ROOM__CLIFF_BOTTOM__QUICK_GRAB);
            }
            LocationId::Glacier__Ledge_Grab_Room__Pedestal__Item => {
                self.cbits6.remove(flags::ContextBits6::VISITED_GLACIER__LEDGE_GRAB_ROOM__PEDESTAL__ITEM);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GLACIER__LEDGE_GRAB_ROOM__PEDESTAL__ITEM);
            }
            LocationId::Glacier__Apocalypse_Entry__Grate_Ledge__Escape => {
                self.cbits6.remove(flags::ContextBits6::VISITED_GLACIER__APOCALYPSE_ENTRY__GRATE_LEDGE__ESCAPE);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_GLACIER__APOCALYPSE_ENTRY__GRATE_LEDGE__ESCAPE);
            }
            LocationId::Interior__Bunker_Interior__Desk__Note => {
                self.cbits6.remove(flags::ContextBits6::VISITED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE);
            }
            LocationId::Interior__Building_Interior__Entry__Remote_Urn => {
                self.cbits6.remove(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__REMOTE_URN);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_INTERIOR__BUILDING_INTERIOR__ENTRY__REMOTE_URN);
            }
            LocationId::Interior__Building_Interior__Entry__Urn_Collection_Skip => {
                self.cbits6.remove(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP);
            }
            LocationId::Interior__Building_Interior__Corner__Urn => {
                self.cbits6.remove(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__CORNER__URN);
                self.cbits9.remove(flags::ContextBits9::SKIPPED_INTERIOR__BUILDING_INTERIOR__CORNER__URN);
            }
            LocationId::Interior__Tent_Interior__Desk__Note => {
                self.cbits6.remove(flags::ContextBits6::VISITED_INTERIOR__TENT_INTERIOR__DESK__NOTE);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_INTERIOR__TENT_INTERIOR__DESK__NOTE);
            }
            LocationId::Interior__Garage__Boxes__Under_Boxes => {
                self.cbits6.remove(flags::ContextBits6::VISITED_INTERIOR__GARAGE__BOXES__UNDER_BOXES);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_INTERIOR__GARAGE__BOXES__UNDER_BOXES);
            }
            LocationId::Interior__Ebih_Cave__Entry__Health => {
                self.cbits6.remove(flags::ContextBits6::VISITED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH);
            }
            LocationId::Interior__Outpost_Interior__Bookshelf__Note => {
                self.cbits6.remove(flags::ContextBits6::VISITED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE);
            }
            LocationId::Irikar_Breach__Gauntlet__Hidden_Path_Reward__Item => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR_BREACH__GAUNTLET__HIDDEN_PATH_REWARD__ITEM);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR_BREACH__GAUNTLET__HIDDEN_PATH_REWARD__ITEM);
            }
            LocationId::Irikar_Breach__Hover_Room__Bottom__Item => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR_BREACH__HOVER_ROOM__BOTTOM__ITEM);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR_BREACH__HOVER_ROOM__BOTTOM__ITEM);
            }
            LocationId::Irikar_Breach__Worm_Rave__Corner__Item => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR_BREACH__WORM_RAVE__CORNER__ITEM);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR_BREACH__WORM_RAVE__CORNER__ITEM);
            }
            LocationId::Irikar__Hub__Sat_Tower_Top_Ledge__Tablet => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__HUB__SAT_TOWER_TOP_LEDGE__TABLET);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__HUB__SAT_TOWER_TOP_LEDGE__TABLET);
            }
            LocationId::Irikar__Hub__Dagger_Altar__Weapon => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__HUB__DAGGER_ALTAR__WEAPON);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__HUB__DAGGER_ALTAR__WEAPON);
            }
            LocationId::Irikar__Hub__Royal_Storage_By_Wall__Shockwave_Wall => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__SHOCKWAVE_WALL);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__SHOCKWAVE_WALL);
            }
            LocationId::Irikar__Hub__Royal_Storage_By_Wall__Mist_into_Wall => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__MIST_INTO_WALL);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__MIST_INTO_WALL);
            }
            LocationId::Irikar__Hub__Royal_Storage_in_Wall__Item => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__HUB__ROYAL_STORAGE_IN_WALL__ITEM);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_IN_WALL__ITEM);
            }
            LocationId::Irikar__Sight_Room__Item_Pedestal__Urn => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN);
            }
            LocationId::Irikar__Sight_Room__Item_Pedestal__Urn_Collection_Skip => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_COLLECTION_SKIP);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_COLLECTION_SKIP);
            }
            LocationId::Irikar__Sight_Room__Item_Pedestal__Urn_Fast_Travel => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_FAST_TRAVEL);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_FAST_TRAVEL);
            }
            LocationId::Irikar__Abandoned_Room__Corner_Core__Core => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__ABANDONED_ROOM__CORNER_CORE__CORE);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__ABANDONED_ROOM__CORNER_CORE__CORE);
            }
            LocationId::Irikar__Basement_Pipes__Left_Vertical_Pipe__Health_Pickup => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP);
            }
            LocationId::Irikar__Boss_Room__Bulls_Feet__Defeat_Gudam => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__BOSS_ROOM__BULLS_FEET__DEFEAT_GUDAM);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__DEFEAT_GUDAM);
            }
            LocationId::Irikar__Boss_Room__Bulls_Feet__Shockwave_Gudam => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__BOSS_ROOM__BULLS_FEET__SHOCKWAVE_GUDAM);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__SHOCKWAVE_GUDAM);
            }
            LocationId::Irikar__Boss_Room__Bulls_Feet__Boss_Reward => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__BOSS_ROOM__BULLS_FEET__BOSS_REWARD);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__BOSS_REWARD);
            }
            LocationId::Irikar__Boss_Room__Healthy_Rooftop__Health => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__BOSS_ROOM__HEALTHY_ROOFTOP__HEALTH);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__HEALTHY_ROOFTOP__HEALTH);
            }
            LocationId::Irikar__East_Rooftops__Top_Rooftop__Tablet => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__EAST_ROOFTOPS__TOP_ROOFTOP__TABLET);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__EAST_ROOFTOPS__TOP_ROOFTOP__TABLET);
            }
            LocationId::Irikar__Lamassu__Desk__Item => {
                self.cbits6.remove(flags::ContextBits6::VISITED_IRIKAR__LAMASSU__DESK__ITEM);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_IRIKAR__LAMASSU__DESK__ITEM);
            }
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_1 => {
                self.cbits7.remove(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_1);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_1);
            }
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_2 => {
                self.cbits7.remove(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_2);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_2);
            }
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_3 => {
                self.cbits7.remove(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_3);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_3);
            }
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_4 => {
                self.cbits7.remove(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_4);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_4);
            }
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_5 => {
                self.cbits7.remove(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_5);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_5);
            }
            LocationId::Menu__Upgrade_Menu__Physiology__Mist_Upgrade => {
                self.cbits7.remove(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__MIST_UPGRADE);
            ...
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Damage_1 => {
                ...
                self.cbits10.remove(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_1);
            }
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Damage_2 => {
                self.cbits6.remove(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_2);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_2);
            }
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Damage_3 => {
                self.cbits6.remove(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_3);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_3);
            }
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Speed_1 => {
                self.cbits6.remove(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_1);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_1);
            }
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Speed_2 => {
                self.cbits6.remove(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_2);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_2);
            }
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Speed_3 => {
            ...
            LocationId::Menu__Upgrade_Menu__Infection__Nano_Points_3 => {
                self.cbits7.remove(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_3);
            ...
            LocationId::Uhrum__West_Entrance__Inner_Dais__Item => {
                ...
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__INNER_DAIS__ITEM);
            }
            LocationId::Uhrum__West_Entrance__Gate_Switch__Open_Gate => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__GATE_SWITCH__OPEN_GATE);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__GATE_SWITCH__OPEN_GATE);
            }
            LocationId::Uhrum__West_Entrance__Upper_Wall_West__Mist_through_Wall => {
            ...
            LocationId::Uhrum__West_Entrance__Upper_Wall_East__Charge_through_Wall => {
                ...
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__CHARGE_THROUGH_WALL);
            }
            LocationId::Uhrum__West_Entrance__Upper_Wall_East__Spin_through_Wall => {
            ...
            LocationId::Uhrum__West_Entrance__Upper_Wall_East__Mist_through_Wall => {
                ...
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__MIST_THROUGH_WALL);
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_West__Charge_through_Wall => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__CHARGE_THROUGH_WALL);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__CHARGE_THROUGH_WALL);
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_West__Spin_through_Wall => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__SPIN_THROUGH_WALL);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__SPIN_THROUGH_WALL);
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_West__Mist_through_Wall => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__MIST_THROUGH_WALL);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__MIST_THROUGH_WALL);
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_East__Charge_through_Wall => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__CHARGE_THROUGH_WALL);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__CHARGE_THROUGH_WALL);
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_East__Spin_through_Wall => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__SPIN_THROUGH_WALL);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__SPIN_THROUGH_WALL);
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_East__Mist_through_Wall => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__MIST_THROUGH_WALL);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__MIST_THROUGH_WALL);
            }
            LocationId::Uhrum__West_Entrance__Sand__Refill => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__SAND__REFILL);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__SAND__REFILL);
            }
            LocationId::Uhrum__Siege_Corridor__Western_Cache__Core => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__WESTERN_CACHE__CORE);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__WESTERN_CACHE__CORE);
            }
            LocationId::Uhrum__Siege_Corridor__Center_Box__Box => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX);
            }
            LocationId::Uhrum__Siege_Corridor__Upper_Rock_Item__Urn => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__UPPER_ROCK_ITEM__URN);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__UPPER_ROCK_ITEM__URN);
            }
            LocationId::Uhrum__Siege_Corridor__Pond__Item => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__POND__ITEM);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__POND__ITEM);
            }
            LocationId::Uhrum__Waterfalls__Ceiling_Cache__Flask => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__CEILING_CACHE__FLASK);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__CEILING_CACHE__FLASK);
            }
            LocationId::Uhrum__Waterfalls__Barrier_West__Charge_through_Wall => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_WEST__CHARGE_THROUGH_WALL);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__CHARGE_THROUGH_WALL);
            }
            LocationId::Uhrum__Waterfalls__Barrier_West__Spin_through_Wall => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_WEST__SPIN_THROUGH_WALL);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__SPIN_THROUGH_WALL);
            }
            LocationId::Uhrum__Waterfalls__Barrier_West__Mist_through_Wall => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_WEST__MIST_THROUGH_WALL);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__MIST_THROUGH_WALL);
            }
            LocationId::Uhrum__Waterfalls__Barrier_East__Charge_through_Wall => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_EAST__CHARGE_THROUGH_WALL);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__CHARGE_THROUGH_WALL);
            }
            LocationId::Uhrum__Waterfalls__Barrier_East__Spin_through_Wall => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_EAST__SPIN_THROUGH_WALL);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__SPIN_THROUGH_WALL);
            }
            LocationId::Uhrum__Waterfalls__Barrier_East__Mist_through_Wall => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_EAST__MIST_THROUGH_WALL);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__MIST_THROUGH_WALL);
            }
            LocationId::Uhrum__Waterfalls__Below_Block__Shockwave_Block => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BELOW_BLOCK__SHOCKWAVE_BLOCK);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BELOW_BLOCK__SHOCKWAVE_BLOCK);
            }
            LocationId::Uhrum__Waterfalls__Above_Block__Block => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__ABOVE_BLOCK__BLOCK);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__ABOVE_BLOCK__BLOCK);
            }
            LocationId::Uhrum__Waterfalls__East_26__Block => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__EAST_26__BLOCK);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__EAST_26__BLOCK);
            }
            LocationId::Uhrum__Waterfalls__West_Water_Nook__Tablet => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__WEST_WATER_NOOK__TABLET);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__WEST_WATER_NOOK__TABLET);
            }
            LocationId::Uhrum__Annuna_Corridor__Upper_Trees__Remote_Urn => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN);
            }
            LocationId::Uhrum__Annuna_Corridor__Pedestal__Urn => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN);
            }
            LocationId::Uhrum__Annuna_Corridor__Pedestal__Urn_Collection_Skip => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP);
            }
            LocationId::Uhrum__Annuna_Corridor__Pedestal__Urn_Fast_Travel => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL);
            }
            LocationId::Uhrum__Annuna_Corridor__Block_West__Dislodge_Block => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_WEST__DISLODGE_BLOCK);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_UHRUM__ANNUNA_CORRIDOR__BLOCK_WEST__DISLODGE_BLOCK);
            }
            LocationId::Uhrum__Annuna_Corridor__Block_East__Dislodge_Block => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_EAST__DISLODGE_BLOCK);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_UHRUM__ANNUNA_CORRIDOR__BLOCK_EAST__DISLODGE_BLOCK);
            }
            LocationId::Uhrum__Annuna_Corridor__East_Cubby__Tablet => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__EAST_CUBBY__TABLET);
                self.cbits10.remove(flags::ContextBits10::SKIPPED_UHRUM__ANNUNA_CORRIDOR__EAST_CUBBY__TABLET);
            }
            LocationId::Uhrum__Annuna_Corridor__Statue__Item => {
                self.cbits7.remove(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM);
                self.cbits11.remove(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM);
            }
        }
    }
    ...
    fn todo(&self, loc_id: LocationId) -> bool {
        match loc_id {
            ...
            LocationId::Annuna__Mirror_Match__Save_Point__Fight => {
                ...
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__SAVE_POINT__FIGHT)
            }
            LocationId::Annuna__Mirror_Match__Below_Switch__Hit_Switch => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH)
            }
            LocationId::Annuna__Mirror_Match__Plinth__Item => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__PLINTH__ITEM)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__PLINTH__ITEM)
            }
            LocationId::Annuna__Mirror_Match__Waving_Distance__Shockwave_Flask => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__WAVING_DISTANCE__SHOCKWAVE_FLASK)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__WAVING_DISTANCE__SHOCKWAVE_FLASK)
            }
            LocationId::Annuna__Mirror_Match__East_26_Lower__Remote_Flask => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__EAST_26_LOWER__REMOTE_FLASK)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_LOWER__REMOTE_FLASK)
            }
            LocationId::Annuna__Mirror_Match__East_26_Upper__Remote_Flask => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__MIRROR_MATCH__EAST_26_UPPER__REMOTE_FLASK)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_UPPER__REMOTE_FLASK)
            }
            LocationId::Annuna__West_Bridge__Plinth__Item => {
            ...
            LocationId::Annuna__East_Bridge__Gate_Button__Switch => {
                ...
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EAST_BRIDGE__GATE_BUTTON__SWITCH)
            }
            LocationId::Annuna__East_Bridge__Below_Gate_Button__Switch_from_Below => {
            ...
            LocationId::Annuna__East_Bridge__Tower_Gate__Tablet => {
                ...
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_GATE__TABLET)
            }
            LocationId::Annuna__East_Bridge__Tower_Secret__Item => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM)
            }
            LocationId::Annuna__Sniper_Valley__Bridge_End__Health_Pickup => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP)
            }
            LocationId::Annuna__Sniper_Valley__Table__Item => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__TABLE__ITEM)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__TABLE__ITEM)
            }
            LocationId::Annuna__Sniper_Valley__Cavern_Outer_Rock_West__Break_Outer_Wall => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_WEST__BREAK_OUTER_WALL)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_WEST__BREAK_OUTER_WALL)
            }
            LocationId::Annuna__Sniper_Valley__Cavern_Outer_Rock_East__Break_Outer_Wall => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_EAST__BREAK_OUTER_WALL)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_EAST__BREAK_OUTER_WALL)
            }
            LocationId::Annuna__Sniper_Valley__Cavern_Inner_Rock_West__Break_Inner_Wall => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_WEST__BREAK_INNER_WALL)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_WEST__BREAK_INNER_WALL)
            }
            LocationId::Annuna__Sniper_Valley__Cavern_Inner_Rock_East__Break_Inner_Wall => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_EAST__BREAK_INNER_WALL)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_EAST__BREAK_INNER_WALL)
            }
            LocationId::Annuna__Sniper_Valley__Cavern_Cache__Item => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM)
            }
            LocationId::Annuna__Vertical_Room__Plinth__Item => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM)
            }
            LocationId::Annuna__Vertical_Room__Gate_Button__Hit_Button => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON)
            }
            LocationId::Annuna__Upper_Hallway__Behind_Pedestal__Health_Pickup => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP)
            }
            LocationId::Annuna__Filter_Teleporter__Door_Ledge__Shockwave_Flask => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__DOOR_LEDGE__SHOCKWAVE_FLASK)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__FILTER_TELEPORTER__DOOR_LEDGE__SHOCKWAVE_FLASK)
            }
            LocationId::Annuna__Filter_Teleporter__Shaft_Bottom__Flask => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__SHAFT_BOTTOM__FLASK)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__FILTER_TELEPORTER__SHAFT_BOTTOM__FLASK)
            }
            LocationId::Annuna__Filter_Teleporter__Northeast_Cubby__Tablet => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET)
            }
            LocationId::Annuna__Spider_Room__Healthy_Corner__Health_Refill => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL)
            }
            LocationId::Annuna__Twisty_Passages__Top__Tablet => {
            ...
            LocationId::Annuna__Twisty_Passages__Northwest_Alcove__Refill => {
                ...
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__TWISTY_PASSAGES__NORTHWEST_ALCOVE__REFILL)
            }
            LocationId::Annuna__West_Climb__Cache__Item => {
            ...
            LocationId::Annuna__Egg_Room__Second_Egg__Remote_Boomerang_Flask => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__SECOND_EGG__REMOTE_BOOMERANG_FLASK)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__SECOND_EGG__REMOTE_BOOMERANG_FLASK)
            }
            LocationId::Annuna__Egg_Room__Cache__Flask => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CACHE__FLASK)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CACHE__FLASK)
            }
            LocationId::Annuna__Egg_Room__Cache__Shockwave_Flask => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK)
            }
            LocationId::Annuna__Egg_Room__Corner_Platform__Shockwave_from_Outside => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__SHOCKWAVE_FROM_OUTSIDE)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__SHOCKWAVE_FROM_OUTSIDE)
            }
            LocationId::Annuna__Egg_Room__Corner_Platform__Remote_Boomerang_Flask => {
                !self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__REMOTE_BOOMERANG_FLASK)
                && !self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__REMOTE_BOOMERANG_FLASK)
            }
            LocationId::Annuna__Apocalypse__Center_Scaffold_West__Boss_Fight => {
            ...
            LocationId::Ebih__Waterfall__Waterfall_Center_Center__Both_Blocks => {
                ...
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS)
            }
            LocationId::Ebih__Waterfall__Alcove_Left__Block_Left => {
            ...
            LocationId::Ebih__Waterfall__Wall_Right__Break_Wall => {
                ...
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL)
            }
            LocationId::Ebih__Waterfall__Wall_Right__Break_Through_Wall => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL)
            }
            LocationId::Ebih__Waterfall__Wall_Left__Break_Wall => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL)
            }
            LocationId::Ebih__Waterfall__Wall_Left__Break_Through_Wall => {
            ...
            LocationId::Filter__Core__Terminal_East__Authorize_Hammond => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND)
            }
            LocationId::Giguna_Breach__Chimney__Cache__Flask => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA_BREACH__CHIMNEY__CACHE__FLASK)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA_BREACH__CHIMNEY__CACHE__FLASK)
            }
            LocationId::Giguna_Breach__Cubby__Rocks__Health => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA_BREACH__CUBBY__ROCKS__HEALTH)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA_BREACH__CUBBY__ROCKS__HEALTH)
            }
            LocationId::Giguna_Breach__Slingshot__Ravine__Urn => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA_BREACH__SLINGSHOT__RAVINE__URN)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA_BREACH__SLINGSHOT__RAVINE__URN)
            }
            LocationId::Giguna__Giguna_Northeast__Gate_Button__Open_Gate => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_NORTHEAST__GATE_BUTTON__OPEN_GATE)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__GATE_BUTTON__OPEN_GATE)
            }
            LocationId::Giguna__Giguna_Northeast__Gate_Right__Remote_Button => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_NORTHEAST__GATE_RIGHT__REMOTE_BUTTON)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__GATE_RIGHT__REMOTE_BUTTON)
            }
            LocationId::Giguna__Giguna_Northeast__Door__Remote_Flask => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_NORTHEAST__DOOR__REMOTE_FLASK)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__DOOR__REMOTE_FLASK)
            }
            LocationId::Giguna__Giguna_Northeast__Vault__Item => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_NORTHEAST__VAULT__ITEM)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__VAULT__ITEM)
            }
            LocationId::Giguna__Carnelian__Vault__Item => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__CARNELIAN__VAULT__ITEM)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__CARNELIAN__VAULT__ITEM)
            }
            LocationId::Giguna__West_Caverns__Cache__Item => {
            ...
            LocationId::Giguna__Giguna_Base__Ruin__Item => {
                ...
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_BASE__RUIN__ITEM)
            }
            LocationId::Giguna__Giguna_Base__Table__News => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GIGUNA_BASE__TABLE__NEWS)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_BASE__TABLE__NEWS)
            }
            LocationId::Giguna__Ruins_East__Way_Up_High__Item => {
            ...
            LocationId::Giguna__Far_Corner__Grass__Obscured_Item => {
                ...
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__FAR_CORNER__GRASS__OBSCURED_ITEM)
            }
            LocationId::Giguna__Helipad__Tablet_Ledge__Tablet => {
            ...
            LocationId::Giguna__Clouds__Cache__Item => {
                ...
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__CLOUDS__CACHE__ITEM)
            }
            LocationId::Giguna__Lamassu__Deposit__Flask => {
            ...
            LocationId::Giguna__Dual_Path__Below_Left_Switch__Remote_Switch => {
                ...
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BELOW_LEFT_SWITCH__REMOTE_SWITCH)
            }
            LocationId::Giguna__Dual_Path__Left_Switch__Hit_Switch => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__LEFT_SWITCH__HIT_SWITCH)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__LEFT_SWITCH__HIT_SWITCH)
            }
            LocationId::Giguna__Dual_Path__Base_of_Wall__Break_Wall => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__BASE_OF_WALL__BREAK_WALL)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BASE_OF_WALL__BREAK_WALL)
            }
            LocationId::Giguna__Dual_Path__Base_of_Wall__Mist_into_Wall => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__BASE_OF_WALL__MIST_INTO_WALL)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BASE_OF_WALL__MIST_INTO_WALL)
            }
            LocationId::Giguna__Dual_Path__Wall_Secret__Health => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__WALL_SECRET__HEALTH)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__WALL_SECRET__HEALTH)
            }
            LocationId::Giguna__Dual_Path__Right_Switch__Hit_Switch => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__RIGHT_SWITCH__HIT_SWITCH)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__RIGHT_SWITCH__HIT_SWITCH)
            }
            LocationId::Giguna__Dual_Path__Below_Right_Switch__Remote_Switch => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__DUAL_PATH__BELOW_RIGHT_SWITCH__REMOTE_SWITCH)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BELOW_RIGHT_SWITCH__REMOTE_SWITCH)
            }
            LocationId::Giguna__Hard_Rock__Rock_Right__Shockwave_Boulder => {
            ...
            LocationId::Giguna__East_Caverns__Hidden_Passage_Center__Hidden_Flask => {
                ...
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__EAST_CAVERNS__HIDDEN_PASSAGE_CENTER__HIDDEN_FLASK)
            }
            LocationId::Giguna__Gateway__Block_Left__Shockwave => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GATEWAY__BLOCK_LEFT__SHOCKWAVE)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__BLOCK_LEFT__SHOCKWAVE)
            }
            LocationId::Giguna__Gateway__Block_Right__Shockwave => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GATEWAY__BLOCK_RIGHT__SHOCKWAVE)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__BLOCK_RIGHT__SHOCKWAVE)
            }
            LocationId::Giguna__Gateway__Flask_Ledge__Item => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GATEWAY__FLASK_LEDGE__ITEM)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__FLASK_LEDGE__ITEM)
            }
            LocationId::Giguna__Gateway__Button__Hit_Switch => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__GATEWAY__BUTTON__HIT_SWITCH)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__BUTTON__HIT_SWITCH)
            }
            LocationId::Giguna__Antechamber__Statue_Head__Tablet => {
                !self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA__ANTECHAMBER__STATUE_HEAD__TABLET)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__ANTECHAMBER__STATUE_HEAD__TABLET)
            }
            LocationId::Giguna__Gubi_Lair__Center_Platform__Hack_Gubi => {
            ...
            LocationId::Glacier__Compass_Room__Center__Table => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__COMPASS_ROOM__CENTER__TABLE)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GLACIER__COMPASS_ROOM__CENTER__TABLE)
            }
            LocationId::Glacier__The_Big_Drop__Water_Surface__Drown => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__THE_BIG_DROP__WATER_SURFACE__DROWN)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GLACIER__THE_BIG_DROP__WATER_SURFACE__DROWN)
            }
            LocationId::Glacier__Vertical_Room__Under_Switch__Switch => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__VERTICAL_ROOM__UNDER_SWITCH__SWITCH)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GLACIER__VERTICAL_ROOM__UNDER_SWITCH__SWITCH)
            }
            LocationId::Glacier__Vertical_Room__Peak__Flask => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__VERTICAL_ROOM__PEAK__FLASK)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GLACIER__VERTICAL_ROOM__PEAK__FLASK)
            }
            LocationId::Glacier__Boomerang_Room__Pedestal__Item => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__ITEM)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GLACIER__BOOMERANG_ROOM__PEDESTAL__ITEM)
            }
            LocationId::Glacier__Boomerang_Room__Pedestal__Switch => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__SWITCH)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GLACIER__BOOMERANG_ROOM__PEDESTAL__SWITCH)
            }
            LocationId::Glacier__Ledge_Grab_Room__Cliff_Bottom__Quick_Grab => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__LEDGE_GRAB_ROOM__CLIFF_BOTTOM__QUICK_GRAB)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GLACIER__LEDGE_GRAB_ROOM__CLIFF_BOTTOM__QUICK_GRAB)
            }
            LocationId::Glacier__Ledge_Grab_Room__Pedestal__Item => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__LEDGE_GRAB_ROOM__PEDESTAL__ITEM)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GLACIER__LEDGE_GRAB_ROOM__PEDESTAL__ITEM)
            }
            LocationId::Glacier__Apocalypse_Entry__Grate_Ledge__Escape => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__APOCALYPSE_ENTRY__GRATE_LEDGE__ESCAPE)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_GLACIER__APOCALYPSE_ENTRY__GRATE_LEDGE__ESCAPE)
            }
            LocationId::Interior__Bunker_Interior__Desk__Note => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE)
            }
            LocationId::Interior__Building_Interior__Entry__Remote_Urn => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__REMOTE_URN)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_INTERIOR__BUILDING_INTERIOR__ENTRY__REMOTE_URN)
            }
            LocationId::Interior__Building_Interior__Entry__Urn_Collection_Skip => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP)
            }
            LocationId::Interior__Building_Interior__Corner__Urn => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__CORNER__URN)
                && !self.cbits9.contains(flags::ContextBits9::SKIPPED_INTERIOR__BUILDING_INTERIOR__CORNER__URN)
            }
            LocationId::Interior__Tent_Interior__Desk__Note => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__TENT_INTERIOR__DESK__NOTE)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__TENT_INTERIOR__DESK__NOTE)
            }
            LocationId::Interior__Garage__Boxes__Under_Boxes => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__GARAGE__BOXES__UNDER_BOXES)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__GARAGE__BOXES__UNDER_BOXES)
            }
            LocationId::Interior__Ebih_Cave__Entry__Health => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH)
            }
            LocationId::Interior__Outpost_Interior__Bookshelf__Note => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE)
            }
            LocationId::Irikar_Breach__Gauntlet__Hidden_Path_Reward__Item => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR_BREACH__GAUNTLET__HIDDEN_PATH_REWARD__ITEM)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR_BREACH__GAUNTLET__HIDDEN_PATH_REWARD__ITEM)
            }
            LocationId::Irikar_Breach__Hover_Room__Bottom__Item => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR_BREACH__HOVER_ROOM__BOTTOM__ITEM)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR_BREACH__HOVER_ROOM__BOTTOM__ITEM)
            }
            LocationId::Irikar_Breach__Worm_Rave__Corner__Item => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR_BREACH__WORM_RAVE__CORNER__ITEM)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR_BREACH__WORM_RAVE__CORNER__ITEM)
            }
            LocationId::Irikar__Hub__Sat_Tower_Top_Ledge__Tablet => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__HUB__SAT_TOWER_TOP_LEDGE__TABLET)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__HUB__SAT_TOWER_TOP_LEDGE__TABLET)
            }
            LocationId::Irikar__Hub__Dagger_Altar__Weapon => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__HUB__DAGGER_ALTAR__WEAPON)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__HUB__DAGGER_ALTAR__WEAPON)
            }
            LocationId::Irikar__Hub__Royal_Storage_By_Wall__Shockwave_Wall => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__SHOCKWAVE_WALL)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__SHOCKWAVE_WALL)
            }
            LocationId::Irikar__Hub__Royal_Storage_By_Wall__Mist_into_Wall => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__MIST_INTO_WALL)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__MIST_INTO_WALL)
            }
            LocationId::Irikar__Hub__Royal_Storage_in_Wall__Item => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__HUB__ROYAL_STORAGE_IN_WALL__ITEM)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_IN_WALL__ITEM)
            }
            LocationId::Irikar__Sight_Room__Item_Pedestal__Urn => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN)
            }
            LocationId::Irikar__Sight_Room__Item_Pedestal__Urn_Collection_Skip => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_COLLECTION_SKIP)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_COLLECTION_SKIP)
            }
            LocationId::Irikar__Sight_Room__Item_Pedestal__Urn_Fast_Travel => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_FAST_TRAVEL)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_FAST_TRAVEL)
            }
            LocationId::Irikar__Abandoned_Room__Corner_Core__Core => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__ABANDONED_ROOM__CORNER_CORE__CORE)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__ABANDONED_ROOM__CORNER_CORE__CORE)
            }
            LocationId::Irikar__Basement_Pipes__Left_Vertical_Pipe__Health_Pickup => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP)
            }
            LocationId::Irikar__Boss_Room__Bulls_Feet__Defeat_Gudam => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__BOSS_ROOM__BULLS_FEET__DEFEAT_GUDAM)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__DEFEAT_GUDAM)
            }
            LocationId::Irikar__Boss_Room__Bulls_Feet__Shockwave_Gudam => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__BOSS_ROOM__BULLS_FEET__SHOCKWAVE_GUDAM)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__SHOCKWAVE_GUDAM)
            }
            LocationId::Irikar__Boss_Room__Bulls_Feet__Boss_Reward => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__BOSS_ROOM__BULLS_FEET__BOSS_REWARD)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__BOSS_REWARD)
            }
            LocationId::Irikar__Boss_Room__Healthy_Rooftop__Health => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__BOSS_ROOM__HEALTHY_ROOFTOP__HEALTH)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__HEALTHY_ROOFTOP__HEALTH)
            }
            LocationId::Irikar__East_Rooftops__Top_Rooftop__Tablet => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__EAST_ROOFTOPS__TOP_ROOFTOP__TABLET)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__EAST_ROOFTOPS__TOP_ROOFTOP__TABLET)
            }
            LocationId::Irikar__Lamassu__Desk__Item => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_IRIKAR__LAMASSU__DESK__ITEM)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__LAMASSU__DESK__ITEM)
            }
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_1 => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_1)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_1)
            }
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_2 => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_2)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_2)
            }
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_3 => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_3)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_3)
            }
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_4 => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_4)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_4)
            }
            LocationId::Menu__Upgrade_Menu__Physiology__Health_Upgrade_5 => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_5)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_5)
            }
            LocationId::Menu__Upgrade_Menu__Physiology__Mist_Upgrade => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__MIST_UPGRADE)
            ...
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Damage_1 => {
                ...
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_1)
            }
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Damage_2 => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_2)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_2)
            }
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Damage_3 => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_3)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_3)
            }
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Speed_1 => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_1)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_1)
            }
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Speed_2 => {
                !self.cbits6.contains(flags::ContextBits6::VISITED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_2)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_2)
            }
            LocationId::Menu__Upgrade_Menu__Combat__Melee_Speed_3 => {
            ...
            LocationId::Menu__Upgrade_Menu__Infection__Nano_Points_3 => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_3)
            ...
            LocationId::Uhrum__West_Entrance__Inner_Dais__Item => {
                ...
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__INNER_DAIS__ITEM)
            }
            LocationId::Uhrum__West_Entrance__Gate_Switch__Open_Gate => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__GATE_SWITCH__OPEN_GATE)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__GATE_SWITCH__OPEN_GATE)
            }
            LocationId::Uhrum__West_Entrance__Upper_Wall_West__Mist_through_Wall => {
            ...
            LocationId::Uhrum__West_Entrance__Upper_Wall_East__Charge_through_Wall => {
                ...
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__CHARGE_THROUGH_WALL)
            }
            LocationId::Uhrum__West_Entrance__Upper_Wall_East__Spin_through_Wall => {
            ...
            LocationId::Uhrum__West_Entrance__Upper_Wall_East__Mist_through_Wall => {
                ...
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__MIST_THROUGH_WALL)
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_West__Charge_through_Wall => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__CHARGE_THROUGH_WALL)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__CHARGE_THROUGH_WALL)
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_West__Spin_through_Wall => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__SPIN_THROUGH_WALL)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__SPIN_THROUGH_WALL)
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_West__Mist_through_Wall => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__MIST_THROUGH_WALL)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__MIST_THROUGH_WALL)
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_East__Charge_through_Wall => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__CHARGE_THROUGH_WALL)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__CHARGE_THROUGH_WALL)
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_East__Spin_through_Wall => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__SPIN_THROUGH_WALL)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__SPIN_THROUGH_WALL)
            }
            LocationId::Uhrum__West_Entrance__Lower_Wall_East__Mist_through_Wall => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__MIST_THROUGH_WALL)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__MIST_THROUGH_WALL)
            }
            LocationId::Uhrum__West_Entrance__Sand__Refill => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WEST_ENTRANCE__SAND__REFILL)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__SAND__REFILL)
            }
            LocationId::Uhrum__Siege_Corridor__Western_Cache__Core => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__WESTERN_CACHE__CORE)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__WESTERN_CACHE__CORE)
            }
            LocationId::Uhrum__Siege_Corridor__Center_Box__Box => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX)
            }
            LocationId::Uhrum__Siege_Corridor__Upper_Rock_Item__Urn => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__UPPER_ROCK_ITEM__URN)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__UPPER_ROCK_ITEM__URN)
            }
            LocationId::Uhrum__Siege_Corridor__Pond__Item => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__POND__ITEM)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__POND__ITEM)
            }
            LocationId::Uhrum__Waterfalls__Ceiling_Cache__Flask => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__CEILING_CACHE__FLASK)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__CEILING_CACHE__FLASK)
            }
            LocationId::Uhrum__Waterfalls__Barrier_West__Charge_through_Wall => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_WEST__CHARGE_THROUGH_WALL)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__CHARGE_THROUGH_WALL)
            }
            LocationId::Uhrum__Waterfalls__Barrier_West__Spin_through_Wall => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_WEST__SPIN_THROUGH_WALL)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__SPIN_THROUGH_WALL)
            }
            LocationId::Uhrum__Waterfalls__Barrier_West__Mist_through_Wall => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_WEST__MIST_THROUGH_WALL)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__MIST_THROUGH_WALL)
            }
            LocationId::Uhrum__Waterfalls__Barrier_East__Charge_through_Wall => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_EAST__CHARGE_THROUGH_WALL)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__CHARGE_THROUGH_WALL)
            }
            LocationId::Uhrum__Waterfalls__Barrier_East__Spin_through_Wall => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_EAST__SPIN_THROUGH_WALL)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__SPIN_THROUGH_WALL)
            }
            LocationId::Uhrum__Waterfalls__Barrier_East__Mist_through_Wall => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BARRIER_EAST__MIST_THROUGH_WALL)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__MIST_THROUGH_WALL)
            }
            LocationId::Uhrum__Waterfalls__Below_Block__Shockwave_Block => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__BELOW_BLOCK__SHOCKWAVE_BLOCK)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BELOW_BLOCK__SHOCKWAVE_BLOCK)
            }
            LocationId::Uhrum__Waterfalls__Above_Block__Block => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__ABOVE_BLOCK__BLOCK)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__ABOVE_BLOCK__BLOCK)
            }
            LocationId::Uhrum__Waterfalls__East_26__Block => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__EAST_26__BLOCK)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__EAST_26__BLOCK)
            }
            LocationId::Uhrum__Waterfalls__West_Water_Nook__Tablet => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__WATERFALLS__WEST_WATER_NOOK__TABLET)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__WEST_WATER_NOOK__TABLET)
            }
            LocationId::Uhrum__Annuna_Corridor__Upper_Trees__Remote_Urn => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN)
            }
            LocationId::Uhrum__Annuna_Corridor__Pedestal__Urn => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN)
            }
            LocationId::Uhrum__Annuna_Corridor__Pedestal__Urn_Collection_Skip => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP)
            }
            LocationId::Uhrum__Annuna_Corridor__Pedestal__Urn_Fast_Travel => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL)
            }
            LocationId::Uhrum__Annuna_Corridor__Block_West__Dislodge_Block => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_WEST__DISLODGE_BLOCK)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_UHRUM__ANNUNA_CORRIDOR__BLOCK_WEST__DISLODGE_BLOCK)
            }
            LocationId::Uhrum__Annuna_Corridor__Block_East__Dislodge_Block => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_EAST__DISLODGE_BLOCK)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_UHRUM__ANNUNA_CORRIDOR__BLOCK_EAST__DISLODGE_BLOCK)
            }
            LocationId::Uhrum__Annuna_Corridor__East_Cubby__Tablet => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__EAST_CUBBY__TABLET)
                && !self.cbits10.contains(flags::ContextBits10::SKIPPED_UHRUM__ANNUNA_CORRIDOR__EAST_CUBBY__TABLET)
            }
            LocationId::Uhrum__Annuna_Corridor__Statue__Item => {
                !self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM)
                && !self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM)
            }
        }
    }
    ...
    // bitflags
        ...
        let n = self.cbits2.contains(flags::ContextBits2::HAMMOND_AUTH);
        let p = old.cbits2.contains(flags::ContextBits2::HAMMOND_AUTH);
        if n != p {
        ...
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_AMAGI__WEST_LAKE__STRONGHOLD_FRONT_ROOM__BREAK_WALL);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_AMAGI__WEST_LAKE__STRONGHOLD_FRONT_ROOM__BREAK_WALL);
        if n != p {
            list.push(format!("{}VISITED_AMAGI__WEST_LAKE__STRONGHOLD_FRONT_ROOM__BREAK_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__BREAK_WALL);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__BREAK_WALL);
        if n != p {
            list.push(format!("{}VISITED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__BREAK_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__ITEM);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__ITEM);
        if n != p {
            list.push(format!("{}VISITED_AMAGI__WEST_LAKE__STRONGHOLD_ITEM__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_AMAGI__WEST_LAKE__STRONGHOLD_MIDDLE_COLUMN__BREAK_WALL);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_AMAGI__WEST_LAKE__STRONGHOLD_MIDDLE_COLUMN__BREAK_WALL);
        if n != p {
        ...
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CACHE__FLASK);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CACHE__FLASK);
        if n != p {
            list.push(format!("{}VISITED_ANNUNA__EGG_ROOM__CACHE__FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK);
        if n != p {
            list.push(format!("{}VISITED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__REMOTE_BOOMERANG_FLASK);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__REMOTE_BOOMERANG_FLASK);
        if n != p {
            list.push(format!("{}VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__REMOTE_BOOMERANG_FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__SHOCKWAVE_FROM_OUTSIDE);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__SHOCKWAVE_FROM_OUTSIDE);
        if n != p {
            list.push(format!("{}VISITED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__SHOCKWAVE_FROM_OUTSIDE", if n { "+" } else { "-" }));
        }
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__SECOND_EGG__REMOTE_BOOMERANG_FLASK);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__EGG_ROOM__SECOND_EGG__REMOTE_BOOMERANG_FLASK);
        if n != p {
            list.push(format!("{}VISITED_ANNUNA__EGG_ROOM__SECOND_EGG__REMOTE_BOOMERANG_FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__DOOR_LEDGE__SHOCKWAVE_FLASK);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__DOOR_LEDGE__SHOCKWAVE_FLASK);
        if n != p {
            list.push(format!("{}VISITED_ANNUNA__FILTER_TELEPORTER__DOOR_LEDGE__SHOCKWAVE_FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET);
        if n != p {
            list.push(format!("{}VISITED_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET", if n { "+" } else { "-" }));
        }
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__SHAFT_BOTTOM__FLASK);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__FILTER_TELEPORTER__SHAFT_BOTTOM__FLASK);
        if n != p {
            list.push(format!("{}VISITED_ANNUNA__FILTER_TELEPORTER__SHAFT_BOTTOM__FLASK", if n { "+" } else { "-" }));
        }
        ...
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL);
        if n != p {
            list.push(format!("{}VISITED_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL", if n { "+" } else { "-" }));
        }
        ...
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP);
        if n != p {
            list.push(format!("{}VISITED_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP", if n { "+" } else { "-" }));
        }
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON);
        if n != p {
            list.push(format!("{}VISITED_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON", if n { "+" } else { "-" }));
        }
        let n = self.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM);
        let p = old.cbits4.contains(flags::ContextBits4::VISITED_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM);
        if n != p {
            list.push(format!("{}VISITED_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM", if n { "+" } else { "-" }));
        }
        ...
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__GRID_25_10_12__EAST_10__REMOTE_BUSH);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_EBIH__GRID_25_10_12__EAST_10__REMOTE_BUSH);
        if n != p {
            list.push(format!("{}VISITED_EBIH__GRID_25_10_12__EAST_10__REMOTE_BUSH", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__GRID_25_10_12__HIDDEN_BUSH__BEHIND_BUSH);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_EBIH__GRID_25_10_12__HIDDEN_BUSH__BEHIND_BUSH);
        if n != p {
            list.push(format!("{}VISITED_EBIH__GRID_25_10_12__HIDDEN_BUSH__BEHIND_BUSH", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__GRID_25_2_6__PIT__ITEM);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_EBIH__GRID_25_2_6__PIT__ITEM);
        if n != p {
            list.push(format!("{}VISITED_EBIH__GRID_25_2_6__PIT__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__GRID_26_10_11__LEDGE__NOTE);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_EBIH__GRID_26_10_11__LEDGE__NOTE);
        if n != p {
            list.push(format!("{}VISITED_EBIH__GRID_26_10_11__LEDGE__NOTE", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__VERTICAL_INTERCHANGE__SWITCH__ACTIVATE_SWITCH);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_EBIH__VERTICAL_INTERCHANGE__SWITCH__ACTIVATE_SWITCH);
        if n != p {
            list.push(format!("{}VISITED_EBIH__VERTICAL_INTERCHANGE__SWITCH__ACTIVATE_SWITCH", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__ALCOVE_LEFT__BLOCK_LEFT);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__ALCOVE_LEFT__BLOCK_LEFT);
        if n != p {
            list.push(format!("{}VISITED_EBIH__WATERFALL__ALCOVE_LEFT__BLOCK_LEFT", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__ALCOVE_RIGHT__BLOCK_RIGHT);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__ALCOVE_RIGHT__BLOCK_RIGHT);
        if n != p {
            list.push(format!("{}VISITED_EBIH__WATERFALL__ALCOVE_RIGHT__BLOCK_RIGHT", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__ALCOVE__BLOCK_LEFT);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__ALCOVE__BLOCK_LEFT);
        if n != p {
            list.push(format!("{}VISITED_EBIH__WATERFALL__ALCOVE__BLOCK_LEFT", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__ALCOVE__BLOCK_RIGHT);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__ALCOVE__BLOCK_RIGHT);
        if n != p {
            list.push(format!("{}VISITED_EBIH__WATERFALL__ALCOVE__BLOCK_RIGHT", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__ALCOVE__PEDESTAL);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__ALCOVE__PEDESTAL);
        if n != p {
            list.push(format!("{}VISITED_EBIH__WATERFALL__ALCOVE__PEDESTAL", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_THROUGH_WALL);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_THROUGH_WALL);
        if n != p {
            list.push(format!("{}VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL);
        if n != p {
            list.push(format!("{}VISITED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL);
        if n != p {
            list.push(format!("{}VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL);
        if n != p {
            list.push(format!("{}VISITED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS);
        if n != p {
            list.push(format!("{}VISITED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND);
        if n != p {
            list.push(format!("{}VISITED_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND", if n { "+" } else { "-" }));
        }
        let n = self.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA_BREACH__CHIMNEY__CACHE__FLASK);
        let p = old.cbits5.contains(flags::ContextBits5::VISITED_GIGUNA_BREACH__CHIMNEY__CACHE__FLASK);
        if n != p {
        ...
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__APOCALYPSE_ENTRY__GRATE_LEDGE__ESCAPE);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__APOCALYPSE_ENTRY__GRATE_LEDGE__ESCAPE);
        if n != p {
            list.push(format!("{}VISITED_GLACIER__APOCALYPSE_ENTRY__GRATE_LEDGE__ESCAPE", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__ITEM);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__ITEM);
        if n != p {
            list.push(format!("{}VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__SWITCH);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__SWITCH);
        if n != p {
            list.push(format!("{}VISITED_GLACIER__BOOMERANG_ROOM__PEDESTAL__SWITCH", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__COMPASS_ROOM__CENTER__TABLE);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__COMPASS_ROOM__CENTER__TABLE);
        if n != p {
            list.push(format!("{}VISITED_GLACIER__COMPASS_ROOM__CENTER__TABLE", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__LEDGE_GRAB_ROOM__CLIFF_BOTTOM__QUICK_GRAB);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__LEDGE_GRAB_ROOM__CLIFF_BOTTOM__QUICK_GRAB);
        if n != p {
            list.push(format!("{}VISITED_GLACIER__LEDGE_GRAB_ROOM__CLIFF_BOTTOM__QUICK_GRAB", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__LEDGE_GRAB_ROOM__PEDESTAL__ITEM);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__LEDGE_GRAB_ROOM__PEDESTAL__ITEM);
        if n != p {
            list.push(format!("{}VISITED_GLACIER__LEDGE_GRAB_ROOM__PEDESTAL__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__THE_BIG_DROP__WATER_SURFACE__DROWN);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__THE_BIG_DROP__WATER_SURFACE__DROWN);
        if n != p {
            list.push(format!("{}VISITED_GLACIER__THE_BIG_DROP__WATER_SURFACE__DROWN", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__VERTICAL_ROOM__PEAK__FLASK);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__VERTICAL_ROOM__PEAK__FLASK);
        if n != p {
            list.push(format!("{}VISITED_GLACIER__VERTICAL_ROOM__PEAK__FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__VERTICAL_ROOM__UNDER_SWITCH__SWITCH);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_GLACIER__VERTICAL_ROOM__UNDER_SWITCH__SWITCH);
        if n != p {
            list.push(format!("{}VISITED_GLACIER__VERTICAL_ROOM__UNDER_SWITCH__SWITCH", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__CORNER__URN);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__CORNER__URN);
        if n != p {
            list.push(format!("{}VISITED_INTERIOR__BUILDING_INTERIOR__CORNER__URN", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__REMOTE_URN);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__REMOTE_URN);
        if n != p {
            list.push(format!("{}VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__REMOTE_URN", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP);
        if n != p {
            list.push(format!("{}VISITED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE);
        if n != p {
            list.push(format!("{}VISITED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH);
        if n != p {
            list.push(format!("{}VISITED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__GARAGE__BOXES__UNDER_BOXES);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__GARAGE__BOXES__UNDER_BOXES);
        if n != p {
            list.push(format!("{}VISITED_INTERIOR__GARAGE__BOXES__UNDER_BOXES", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE);
        if n != p {
            list.push(format!("{}VISITED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE", if n { "+" } else { "-" }));
        }
        let n = self.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__TENT_INTERIOR__DESK__NOTE);
        let p = old.cbits6.contains(flags::ContextBits6::VISITED_INTERIOR__TENT_INTERIOR__DESK__NOTE);
        if n != p {
        ...
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_3);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_3);
        if n != p {
            list.push(format!("{}VISITED_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_3", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_1);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_1);
        if n != p {
            list.push(format!("{}VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_1", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_2);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_2);
        if n != p {
            list.push(format!("{}VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_2", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_3);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_3);
        if n != p {
            list.push(format!("{}VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_3", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_4);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_4);
        if n != p {
            list.push(format!("{}VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_4", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_5);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_5);
        if n != p {
            list.push(format!("{}VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_5", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__MIST_UPGRADE);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__MIST_UPGRADE);
        if n != p {
            list.push(format!("{}VISITED_MENU__UPGRADE_MENU__PHYSIOLOGY__MIST_UPGRADE", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_EAST__DISLODGE_BLOCK);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_EAST__DISLODGE_BLOCK);
        if n != p {
            list.push(format!("{}VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_EAST__DISLODGE_BLOCK", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_WEST__DISLODGE_BLOCK);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_WEST__DISLODGE_BLOCK);
        if n != p {
            list.push(format!("{}VISITED_UHRUM__ANNUNA_CORRIDOR__BLOCK_WEST__DISLODGE_BLOCK", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__EAST_CUBBY__TABLET);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__EAST_CUBBY__TABLET);
        if n != p {
            list.push(format!("{}VISITED_UHRUM__ANNUNA_CORRIDOR__EAST_CUBBY__TABLET", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN);
        if n != p {
            list.push(format!("{}VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP);
        if n != p {
            list.push(format!("{}VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL);
        if n != p {
            list.push(format!("{}VISITED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM);
        if n != p {
            list.push(format!("{}VISITED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN);
        if n != p {
            list.push(format!("{}VISITED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX);
        if n != p {
            list.push(format!("{}VISITED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX", if n { "+" } else { "-" }));
        }
        let n = self.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__POND__ITEM);
        let p = old.cbits7.contains(flags::ContextBits7::VISITED_UHRUM__SIEGE_CORRIDOR__POND__ITEM);
        if n != p {
        ...
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EAST_BRIDGE__GATE_BUTTON__SWITCH);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EAST_BRIDGE__GATE_BUTTON__SWITCH);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__EAST_BRIDGE__GATE_BUTTON__SWITCH", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_GATE__TABLET);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_GATE__TABLET);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_GATE__TABLET", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__EAST_BRIDGE__TOWER_SECRET__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CACHE__FLASK);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CACHE__FLASK);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__EGG_ROOM__CACHE__FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__EGG_ROOM__CACHE__SHOCKWAVE_FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__REMOTE_BOOMERANG_FLASK);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__REMOTE_BOOMERANG_FLASK);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__REMOTE_BOOMERANG_FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__SHOCKWAVE_FROM_OUTSIDE);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__SHOCKWAVE_FROM_OUTSIDE);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__EGG_ROOM__CORNER_PLATFORM__SHOCKWAVE_FROM_OUTSIDE", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__SECOND_EGG__REMOTE_BOOMERANG_FLASK);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__EGG_ROOM__SECOND_EGG__REMOTE_BOOMERANG_FLASK);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__EGG_ROOM__SECOND_EGG__REMOTE_BOOMERANG_FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__FILTER_TELEPORTER__DOOR_LEDGE__SHOCKWAVE_FLASK);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__FILTER_TELEPORTER__DOOR_LEDGE__SHOCKWAVE_FLASK);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__FILTER_TELEPORTER__DOOR_LEDGE__SHOCKWAVE_FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__FILTER_TELEPORTER__NORTHEAST_CUBBY__TABLET", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__FILTER_TELEPORTER__SHAFT_BOTTOM__FLASK);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__FILTER_TELEPORTER__SHAFT_BOTTOM__FLASK);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__FILTER_TELEPORTER__SHAFT_BOTTOM__FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__MIRROR_MATCH__BELOW_SWITCH__HIT_SWITCH", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_LOWER__REMOTE_FLASK);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_LOWER__REMOTE_FLASK);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_LOWER__REMOTE_FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_UPPER__REMOTE_FLASK);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_UPPER__REMOTE_FLASK);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__MIRROR_MATCH__EAST_26_UPPER__REMOTE_FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__PLINTH__ITEM);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__PLINTH__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__MIRROR_MATCH__PLINTH__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__SAVE_POINT__FIGHT);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__SAVE_POINT__FIGHT);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__MIRROR_MATCH__SAVE_POINT__FIGHT", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__WAVING_DISTANCE__SHOCKWAVE_FLASK);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__MIRROR_MATCH__WAVING_DISTANCE__SHOCKWAVE_FLASK);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__MIRROR_MATCH__WAVING_DISTANCE__SHOCKWAVE_FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__SNIPER_VALLEY__BRIDGE_END__HEALTH_PICKUP", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_CACHE__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_EAST__BREAK_INNER_WALL);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_EAST__BREAK_INNER_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_EAST__BREAK_INNER_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_WEST__BREAK_INNER_WALL);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_WEST__BREAK_INNER_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_INNER_ROCK_WEST__BREAK_INNER_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_EAST__BREAK_OUTER_WALL);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_EAST__BREAK_OUTER_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_EAST__BREAK_OUTER_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_WEST__BREAK_OUTER_WALL);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_WEST__BREAK_OUTER_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__SNIPER_VALLEY__CAVERN_OUTER_ROCK_WEST__BREAK_OUTER_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__TABLE__ITEM);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SNIPER_VALLEY__TABLE__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__SNIPER_VALLEY__TABLE__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__SPIDER_ROOM__HEALTHY_CORNER__HEALTH_REFILL", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__TWISTY_PASSAGES__NORTHWEST_ALCOVE__REFILL);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__TWISTY_PASSAGES__NORTHWEST_ALCOVE__REFILL);
        if n != p {
        ...
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__UPPER_HALLWAY__BEHIND_PEDESTAL__HEALTH_PICKUP", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__VERTICAL_ROOM__GATE_BUTTON__HIT_BUTTON", if n { "+" } else { "-" }));
        }
        let n = self.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM);
        let p = old.cbits8.contains(flags::ContextBits8::SKIPPED_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_ANNUNA__VERTICAL_ROOM__PLINTH__ITEM", if n { "+" } else { "-" }));
        }
        ...
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_EBIH__WATERFALL__WALL_LEFT__BREAK_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_EBIH__WATERFALL__WALL_RIGHT__BREAK_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS);
        if n != p {
            list.push(format!("{}SKIPPED_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND);
        if n != p {
            list.push(format!("{}SKIPPED_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA_BREACH__CHIMNEY__CACHE__FLASK);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA_BREACH__CHIMNEY__CACHE__FLASK);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA_BREACH__CHIMNEY__CACHE__FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA_BREACH__CUBBY__ROCKS__HEALTH);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA_BREACH__CUBBY__ROCKS__HEALTH);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA_BREACH__CUBBY__ROCKS__HEALTH", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA_BREACH__SLINGSHOT__RAVINE__URN);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA_BREACH__SLINGSHOT__RAVINE__URN);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA_BREACH__SLINGSHOT__RAVINE__URN", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__ANTECHAMBER__STATUE_HEAD__TABLET);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__ANTECHAMBER__STATUE_HEAD__TABLET);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__ANTECHAMBER__STATUE_HEAD__TABLET", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__CARNELIAN__VAULT__ITEM);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__CARNELIAN__VAULT__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__CARNELIAN__VAULT__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__CLOUDS__CACHE__ITEM);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__CLOUDS__CACHE__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__CLOUDS__CACHE__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BASE_OF_WALL__BREAK_WALL);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BASE_OF_WALL__BREAK_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__DUAL_PATH__BASE_OF_WALL__BREAK_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BASE_OF_WALL__MIST_INTO_WALL);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BASE_OF_WALL__MIST_INTO_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__DUAL_PATH__BASE_OF_WALL__MIST_INTO_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BELOW_LEFT_SWITCH__REMOTE_SWITCH);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BELOW_LEFT_SWITCH__REMOTE_SWITCH);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__DUAL_PATH__BELOW_LEFT_SWITCH__REMOTE_SWITCH", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BELOW_RIGHT_SWITCH__REMOTE_SWITCH);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__BELOW_RIGHT_SWITCH__REMOTE_SWITCH);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__DUAL_PATH__BELOW_RIGHT_SWITCH__REMOTE_SWITCH", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__LEFT_SWITCH__HIT_SWITCH);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__LEFT_SWITCH__HIT_SWITCH);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__DUAL_PATH__LEFT_SWITCH__HIT_SWITCH", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__RIGHT_SWITCH__HIT_SWITCH);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__RIGHT_SWITCH__HIT_SWITCH);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__DUAL_PATH__RIGHT_SWITCH__HIT_SWITCH", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__WALL_SECRET__HEALTH);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__DUAL_PATH__WALL_SECRET__HEALTH);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__DUAL_PATH__WALL_SECRET__HEALTH", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__EAST_CAVERNS__HIDDEN_PASSAGE_CENTER__HIDDEN_FLASK);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__EAST_CAVERNS__HIDDEN_PASSAGE_CENTER__HIDDEN_FLASK);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__EAST_CAVERNS__HIDDEN_PASSAGE_CENTER__HIDDEN_FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__FAR_CORNER__GRASS__OBSCURED_ITEM);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__FAR_CORNER__GRASS__OBSCURED_ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__FAR_CORNER__GRASS__OBSCURED_ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__BLOCK_LEFT__SHOCKWAVE);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__BLOCK_LEFT__SHOCKWAVE);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__GATEWAY__BLOCK_LEFT__SHOCKWAVE", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__BLOCK_RIGHT__SHOCKWAVE);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__BLOCK_RIGHT__SHOCKWAVE);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__GATEWAY__BLOCK_RIGHT__SHOCKWAVE", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__BUTTON__HIT_SWITCH);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__BUTTON__HIT_SWITCH);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__GATEWAY__BUTTON__HIT_SWITCH", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__FLASK_LEDGE__ITEM);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GATEWAY__FLASK_LEDGE__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__GATEWAY__FLASK_LEDGE__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_BASE__RUIN__ITEM);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_BASE__RUIN__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__GIGUNA_BASE__RUIN__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_BASE__TABLE__NEWS);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_BASE__TABLE__NEWS);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__GIGUNA_BASE__TABLE__NEWS", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__DOOR__REMOTE_FLASK);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__DOOR__REMOTE_FLASK);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__GIGUNA_NORTHEAST__DOOR__REMOTE_FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__GATE_BUTTON__OPEN_GATE);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__GATE_BUTTON__OPEN_GATE);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__GIGUNA_NORTHEAST__GATE_BUTTON__OPEN_GATE", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__GATE_RIGHT__REMOTE_BUTTON);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__GATE_RIGHT__REMOTE_BUTTON);
        if n != p {
            list.push(format!("{}SKIPPED_GIGUNA__GIGUNA_NORTHEAST__GATE_RIGHT__REMOTE_BUTTON", if n { "+" } else { "-" }));
        }
        let n = self.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__VAULT__ITEM);
        let p = old.cbits9.contains(flags::ContextBits9::SKIPPED_GIGUNA__GIGUNA_NORTHEAST__VAULT__ITEM);
        if n != p {
        ...
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP);
        if n != p {
            list.push(format!("{}SKIPPED_INTERIOR__BUILDING_INTERIOR__ENTRY__URN_COLLECTION_SKIP", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE);
        if n != p {
            list.push(format!("{}SKIPPED_INTERIOR__BUNKER_INTERIOR__DESK__NOTE", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH);
        if n != p {
            list.push(format!("{}SKIPPED_INTERIOR__EBIH_CAVE__ENTRY__HEALTH", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__GARAGE__BOXES__UNDER_BOXES);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__GARAGE__BOXES__UNDER_BOXES);
        if n != p {
            list.push(format!("{}SKIPPED_INTERIOR__GARAGE__BOXES__UNDER_BOXES", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE);
        if n != p {
            list.push(format!("{}SKIPPED_INTERIOR__OUTPOST_INTERIOR__BOOKSHELF__NOTE", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__TENT_INTERIOR__DESK__NOTE);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_INTERIOR__TENT_INTERIOR__DESK__NOTE);
        if n != p {
            list.push(format!("{}SKIPPED_INTERIOR__TENT_INTERIOR__DESK__NOTE", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR_BREACH__GAUNTLET__HIDDEN_PATH_REWARD__ITEM);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR_BREACH__GAUNTLET__HIDDEN_PATH_REWARD__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR_BREACH__GAUNTLET__HIDDEN_PATH_REWARD__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR_BREACH__HOVER_ROOM__BOTTOM__ITEM);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR_BREACH__HOVER_ROOM__BOTTOM__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR_BREACH__HOVER_ROOM__BOTTOM__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR_BREACH__WORM_RAVE__CORNER__ITEM);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR_BREACH__WORM_RAVE__CORNER__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR_BREACH__WORM_RAVE__CORNER__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__ABANDONED_ROOM__CORNER_CORE__CORE);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__ABANDONED_ROOM__CORNER_CORE__CORE);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__ABANDONED_ROOM__CORNER_CORE__CORE", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__BOSS_REWARD);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__BOSS_REWARD);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__BOSS_REWARD", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__DEFEAT_GUDAM);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__DEFEAT_GUDAM);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__DEFEAT_GUDAM", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__SHOCKWAVE_GUDAM);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__SHOCKWAVE_GUDAM);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__BOSS_ROOM__BULLS_FEET__SHOCKWAVE_GUDAM", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__HEALTHY_ROOFTOP__HEALTH);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__BOSS_ROOM__HEALTHY_ROOFTOP__HEALTH);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__BOSS_ROOM__HEALTHY_ROOFTOP__HEALTH", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__EAST_ROOFTOPS__TOP_ROOFTOP__TABLET);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__EAST_ROOFTOPS__TOP_ROOFTOP__TABLET);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__EAST_ROOFTOPS__TOP_ROOFTOP__TABLET", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__HUB__DAGGER_ALTAR__WEAPON);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__HUB__DAGGER_ALTAR__WEAPON);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__HUB__DAGGER_ALTAR__WEAPON", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__MIST_INTO_WALL);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__MIST_INTO_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__MIST_INTO_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__SHOCKWAVE_WALL);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__SHOCKWAVE_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__SHOCKWAVE_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_IN_WALL__ITEM);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_IN_WALL__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__HUB__ROYAL_STORAGE_IN_WALL__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__HUB__SAT_TOWER_TOP_LEDGE__TABLET);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__HUB__SAT_TOWER_TOP_LEDGE__TABLET);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__HUB__SAT_TOWER_TOP_LEDGE__TABLET", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__LAMASSU__DESK__ITEM);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__LAMASSU__DESK__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__LAMASSU__DESK__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_COLLECTION_SKIP);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_COLLECTION_SKIP);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_COLLECTION_SKIP", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_FAST_TRAVEL);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_FAST_TRAVEL);
        if n != p {
            list.push(format!("{}SKIPPED_IRIKAR__SIGHT_ROOM__ITEM_PEDESTAL__URN_FAST_TRAVEL", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_1);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_1);
        if n != p {
            list.push(format!("{}SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_1", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_2);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_2);
        if n != p {
            list.push(format!("{}SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_2", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_3);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_3);
        if n != p {
            list.push(format!("{}SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_3", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_1);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_1);
        if n != p {
            list.push(format!("{}SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_1", if n { "+" } else { "-" }));
        }
        let n = self.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_2);
        let p = old.cbits10.contains(flags::ContextBits10::SKIPPED_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_2);
        if n != p {
        ...
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_COLLECTION_SKIP", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__ANNUNA_CORRIDOR__PEDESTAL__URN_FAST_TRAVEL", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__ANNUNA_CORRIDOR__UPPER_TREES__REMOTE_URN", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__POND__ITEM);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__POND__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__SIEGE_CORRIDOR__POND__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__UPPER_ROCK_ITEM__URN);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__UPPER_ROCK_ITEM__URN);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__SIEGE_CORRIDOR__UPPER_ROCK_ITEM__URN", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__WESTERN_CACHE__CORE);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__SIEGE_CORRIDOR__WESTERN_CACHE__CORE);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__SIEGE_CORRIDOR__WESTERN_CACHE__CORE", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__ABOVE_BLOCK__BLOCK);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__ABOVE_BLOCK__BLOCK);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WATERFALLS__ABOVE_BLOCK__BLOCK", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__CHARGE_THROUGH_WALL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__CHARGE_THROUGH_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__CHARGE_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__MIST_THROUGH_WALL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__MIST_THROUGH_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__MIST_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__SPIN_THROUGH_WALL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__SPIN_THROUGH_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WATERFALLS__BARRIER_EAST__SPIN_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__CHARGE_THROUGH_WALL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__CHARGE_THROUGH_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__CHARGE_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__MIST_THROUGH_WALL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__MIST_THROUGH_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__MIST_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__SPIN_THROUGH_WALL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__SPIN_THROUGH_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WATERFALLS__BARRIER_WEST__SPIN_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BELOW_BLOCK__SHOCKWAVE_BLOCK);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__BELOW_BLOCK__SHOCKWAVE_BLOCK);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WATERFALLS__BELOW_BLOCK__SHOCKWAVE_BLOCK", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__CEILING_CACHE__FLASK);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__CEILING_CACHE__FLASK);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WATERFALLS__CEILING_CACHE__FLASK", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__EAST_26__BLOCK);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__EAST_26__BLOCK);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WATERFALLS__EAST_26__BLOCK", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__WEST_WATER_NOOK__TABLET);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WATERFALLS__WEST_WATER_NOOK__TABLET);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WATERFALLS__WEST_WATER_NOOK__TABLET", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__GATE_SWITCH__OPEN_GATE);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__GATE_SWITCH__OPEN_GATE);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WEST_ENTRANCE__GATE_SWITCH__OPEN_GATE", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__INNER_DAIS__ITEM);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__INNER_DAIS__ITEM);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WEST_ENTRANCE__INNER_DAIS__ITEM", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__CHARGE_THROUGH_WALL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__CHARGE_THROUGH_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__CHARGE_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__MIST_THROUGH_WALL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__MIST_THROUGH_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__MIST_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__SPIN_THROUGH_WALL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__SPIN_THROUGH_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_EAST__SPIN_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__CHARGE_THROUGH_WALL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__CHARGE_THROUGH_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__CHARGE_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__MIST_THROUGH_WALL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__MIST_THROUGH_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__MIST_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__SPIN_THROUGH_WALL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__SPIN_THROUGH_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WEST_ENTRANCE__LOWER_WALL_WEST__SPIN_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__SAND__REFILL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__SAND__REFILL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WEST_ENTRANCE__SAND__REFILL", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__CHARGE_THROUGH_WALL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__CHARGE_THROUGH_WALL);
        if n != p {
            list.push(format!("{}SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__CHARGE_THROUGH_WALL", if n { "+" } else { "-" }));
        }
        let n = self.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__MIST_THROUGH_WALL);
        let p = old.cbits11.contains(flags::ContextBits11::SKIPPED_UHRUM__WEST_ENTRANCE__UPPER_WALL_EAST__MIST_THROUGH_WALL);
        if n != p {
