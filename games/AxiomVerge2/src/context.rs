...
bitflags!{
    ...
    pub struct ContextBits2 : u64 {
        ...
        const DR_GLORIA = 0x200000000;
        const DRONE_HOVER = 0x400000000;
        const DRONE_MELEE_DAMAGE = 0x800000000;
        const DRONE_MELEE_DAMAGE_2 = 0x1000000000;
        const DRONE_MELEE_SPEED = 0x2000000000;
        const DRONE_MELEE_SPEED_2 = 0x4000000000;
        const EBIH_ALU = 0x8000000000;
        const EBIH_INTERCHANGE_BLOCK = 0x10000000000;
        const EBIH_INTERCHANGE_GATE = 0x20000000000;
        const EBIH_WALLED_OFF_WALL = 0x40000000000;
        const EBIH_WASTELAND_DOOR = 0x80000000000;
        const EBIH_WASTELAND_PASSAGE_H = 0x100000000000;
        const EBIH_WATERFALL_BLOCK_LEFT = 0x200000000000;
        const EBIH_WATERFALL_BLOCK_RIGHT = 0x400000000000;
        const EBIH_WATERFALL_WALL = 0x800000000000;
        const EBIH_WEST_BLOCK = 0x1000000000000;
        const ESCAPE = 0x2000000000000;
        const EXIT_BREACH = 0x4000000000000;
        const EYE_RING = 0x8000000000000;
        const FAMILY_TRAGEDY = 0x10000000000000;
        const FAST_TRAVEL = 0x20000000000000;
        const FORBIDDEN_KNOWLEDGE = 0x40000000000000;
        const FREEDOM_FROM_AANSUR = 0x80000000000000;
        const GIGUNA_BOULDER = 0x100000000000000;
        const GIGUNA_DUAL_PATH_SWITCH = 0x200000000000000;
        const GIGUNA_DUAL_PATH_WALL = 0x400000000000000;
        const GIGUNA_GATEWAY_BLOCK = 0x800000000000000;
        const GIGUNA_GATEWAY_GATE = 0x1000000000000000;
        const GIGUNA_GUBI = 0x2000000000000000;
        const GIGUNA_NORTHEAST_GATE = 0x4000000000000000;
        const GLACIER_BIG_DROP_ROCK = 0x8000000000000000;
    }
}
bitflags!{
    #[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
    pub struct ContextBits3 : u64 {
        const GLACIER_SEA_BURIAL_ROCK = 0x1;
        const GOODBYE = 0x2;
        const HAMMOND_AUTH = 0x4;
        const HEALTH_UPGRADE = 0x8;
        const HEALTH_UPGRADE_2 = 0x10;
        const HEALTH_UPGRADE_3 = 0x20;
        const HEALTH_UPGRADE_4 = 0x40;
        const HERETICS_TABLET = 0x80;
        const ICE_AXE = 0x100;
        const INFECT = 0x200;
        const INFECT_L1 = 0x400;
        const INFECT_L2 = 0x800;
        const INFECT_L3 = 0x1000;
        const INFECTION_RANGE = 0x2000;
        const INFECTION_RANGE_2 = 0x4000;
        const INFECTION_RANGE_3 = 0x8000;
        const INFECTION_SPEED = 0x10000;
        const IRIKAR_GUDAM = 0x20000;
        const IRIKAR_ROYAL_STORAGE_WALL = 0x40000;
        const LAMENT_FOR_FOOLS = 0x80000;
        const LEDGE_GRAB = 0x100000;
        const LETTER_FROM_TRACE = 0x200000;
        const MELEE_DAMAGE = 0x400000;
        const MELEE_DAMAGE_2 = 0x800000;
        const MELEE_SPEED = 0x1000000;
        const MELEE_SPEED_2 = 0x2000000;
        const MIST_UPGRADE = 0x4000000;
        const NANITE_MIST = 0x8000000;
        const NANO_LATTICE_2 = 0x10000000;
        const NANO_POINTS = 0x20000000;
        const NANO_POINTS_2 = 0x40000000;
        const NOTES_2053_02_27 = 0x80000000;
        const PLAGUE_OF_THOUGHTS = 0x100000000;
        const POWER_MATRIX = 0x200000000;
        const RANGED_DAMAGE = 0x400000000;
        const RANGED_DAMAGE_2 = 0x800000000;
        const RANGED_SPEED = 0x1000000000;
        const RANGED_SPEED_2 = 0x2000000000;
        const RECORD_LOSSES = 0x4000000000;
        const REMOTE_BOOMERANG = 0x8000000000;
        const REMOTE_DRONE = 0x10000000000;
        const RESEARCHERS_MISSING = 0x20000000000;
        const SEPARATION = 0x40000000000;
        const SHOCKWAVE = 0x80000000000;
        const SIUNA_STORAGE_WALL = 0x100000000000;
        const SLINGSHOT_CHARGE = 0x200000000000;
        const SLINGSHOT_HOOK = 0x400000000000;
        const SLINGSHOT_WEAPON = 0x800000000000;
        const SNIPER_VALLEY_ROCK_1 = 0x1000000000000;
        const SNIPER_VALLEY_ROCK_2 = 0x2000000000000;
        const STATION_POWER = 0x4000000000000;
        const STORM_BOMB = 0x8000000000000;
        ...
        const UHRUM_ANNUNA_CORRIDOR_BLOCK = 0x1000000000000000;
        const UHRUM_WATERFALL_WALL = 0x2000000000000000;
        const UHRUM_WATERFALLS_BLOCK = 0x4000000000000000;
        const UHRUM_WEST_ENTRANCE_GATE = 0x8000000000000000;
    }
}
bitflags!{
    #[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
    pub struct ContextBits4 : u64 {
        const UHRUM_WEST_ENTRANCE_LOWER_WALL = 0x1;
        const UHRUM_WEST_ENTRANCE_UPPER_WALL = 0x2;
        const UNDER_SIEGE = 0x4;
        const UNDERWATER_MOVEMENT = 0x8;
        const WALL_CLIMB = 0x10;
        const VISITED_AMAGI_DRAGON_EYE_FLASK = 0x20;
        const VISITED_AMAGI_STRONGHOLD_BOULDER_2 = 0x40;
        const VISITED_AMAGI_STRONGHOLD_LEFT_WALL = 0x80;
        const VISITED_AMAGI_STRONGHOLD_WALL_1 = 0x100;
        const VISITED_AMAGI_STRONGHOLD_WALL_2 = 0x200;
        const VISITED_AMAGI_WEST_LAKE_SURFACE_WALL = 0x400;
        const VISITED_ANNUNA_EAST_BRIDGE_GATE = 0x800;
        const VISITED_ANNUNA_MIRROR_MATCH_FLASK = 0x1000;
        const VISITED_ANUMAN = 0x2000;
        const VISITED_APOCALYPSE_BOMB = 0x4000;
        const VISITED_APOCALYPSE_SEALS_WALL = 0x8000;
        const VISITED_BREACH_SIGHT = 0x10000;
        const VISITED_EBIH_ALU = 0x20000;
        const VISITED_EBIH_BASE_CAMP_FRAGMENT = 0x40000;
        const VISITED_EBIH_BUSH_FLASK = 0x80000;
        const VISITED_EBIH_WALLED_OFF_WALL = 0x100000;
        const VISITED_EBIH_WASTELAND_PASSAGE_H = 0x200000;
        const VISITED_EBIH_WATERFALL_BLOCK_LEFT = 0x400000;
        const VISITED_EBIH_WATERFALL_BLOCK_RIGHT = 0x800000;
        const VISITED_EBIH_WATERFALL_WALL = 0x1000000;
        const VISITED_EBIH_WEST_BLOCK = 0x2000000;
        const VISITED_EGG_ROOM_FLASK = 0x4000000;
        const VISITED_ESCAPE = 0x8000000;
        const VISITED_FAST_TRAVEL = 0x10000000;
        const VISITED_FILTER_TELEPORTER_FLASK = 0x20000000;
        const VISITED_GIGUNA_BOULDER = 0x40000000;
        const VISITED_GIGUNA_DUAL_PATH_SWITCH = 0x80000000;
        const VISITED_GIGUNA_DUAL_PATH_WALL = 0x100000000;
        const VISITED_GIGUNA_GATEWAY_BLOCK = 0x200000000;
        const VISITED_GIGUNA_GUBI = 0x400000000;
        const VISITED_GIGUNA_NORTHEAST_FLASK = 0x800000000;
        const VISITED_GIGUNA_NORTHEAST_GATE = 0x1000000000;
        const VISITED_GIGUNA_TOP_FLASK = 0x2000000000;
        const VISITED_GLACIER_40_8_FLASK = 0x4000000000;
        const VISITED_GLACIER_BIG_DROP_ROCK = 0x8000000000;
        const VISITED_GLACIER_DOCK_FLASK = 0x10000000000;
        const VISITED_GLACIER_SEA_BURIAL_ROCK = 0x20000000000;
        const VISITED_HAMMONDS_NOTE = 0x40000000000;
        const VISITED_INFECT = 0x80000000000;
        const VISITED_IRIKAR_GUDAM = 0x100000000000;
        const VISITED_IRIKAR_MIDWEST_FLASK = 0x200000000000;
        const VISITED_IRIKAR_ROYAL_STORAGE_FLASK = 0x400000000000;
        const VISITED_IRIKAR_ROYAL_STORAGE_WALL = 0x800000000000;
        const VISITED_IRIKAR_WELL_FLASK = 0x1000000000000;
        const VISITED_LEDGE_GRAB = 0x2000000000000;
        const VISITED_LOC_AMAGI_BREACH__EAST_ENTRANCE__UPPER_SLOPE__ITEM = 0x4000000000000;
        const VISITED_LOC_AMAGI__EAST_LAKE__FOOT__TABLET = 0x8000000000000;
        ...
        const ALL_VISIT_FLAGS = 0xffffffffffffffe0;
    }
}
bitflags!{
    #[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, Serialize, Deserialize)]
    pub struct ContextBits5 : u64 {
        ...
        const VISITED_LOC_EBIH__GUARDED_HEALTH__FAR_WEST__REFILL = 0x400000;
        const VISITED_LOC_EBIH__GUARDED_HEALTH__WEST_BASIN__HEALTH = 0x800000;
        const VISITED_LOC_EBIH__VERTICAL_INTERCHANGE__BLOCK_CUBBY__SHOCKWAVE_BLOCK = 0x1000000;
        const VISITED_LOC_EBIH__VERTICAL_INTERCHANGE__SWITCH__ACTIVATE_SWITCH = 0x2000000;
        const VISITED_LOC_EBIH__WATERFALL__ALCOVE__PEDESTAL = 0x4000000;
        const VISITED_LOC_EBIH__WATERFALL__WATERFALL_CENTER_CENTER__BOTH_BLOCKS = 0x8000000;
        const VISITED_LOC_FILTER__CORE__TERMINAL_EAST__AUTHORIZE_HAMMOND = 0x10000000;
        const VISITED_LOC_GIGUNA_BREACH__CHIMNEY__CACHE__FLASK = 0x20000000;
        const VISITED_LOC_GIGUNA_BREACH__CUBBY__ROCKS__HEALTH = 0x40000000;
        const VISITED_LOC_GIGUNA_BREACH__SLINGSHOT__RAVINE__URN = 0x80000000;
        const VISITED_LOC_GIGUNA__ANTECHAMBER__STATUE_HEAD__TABLET = 0x100000000;
        const VISITED_LOC_GIGUNA__CARNELIAN__VAULT__ITEM = 0x200000000;
        const VISITED_LOC_GIGUNA__CLOUDS__CACHE__ITEM = 0x400000000;
        const VISITED_LOC_GIGUNA__DUAL_PATH__WALL_SECRET__HEALTH = 0x800000000;
        const VISITED_LOC_GIGUNA__EAST_CAVERNS__HIDDEN_PASSAGE_CENTER__HIDDEN_FLASK = 0x1000000000;
        const VISITED_LOC_GIGUNA__FAR_CORNER__GRASS__OBSCURED_ITEM = 0x2000000000;
        const VISITED_LOC_GIGUNA__GATEWAY__BUTTON__HIT_SWITCH = 0x4000000000;
        const VISITED_LOC_GIGUNA__GATEWAY__FLASK_LEDGE__ITEM = 0x8000000000;
        const VISITED_LOC_GIGUNA__GIGUNA_BASE__RUIN__ITEM = 0x10000000000;
        const VISITED_LOC_GIGUNA__GIGUNA_BASE__TABLE__NEWS = 0x20000000000;
        const VISITED_LOC_GIGUNA__GUBI_LAIR__CENTER_PLATFORM__BOSS_REWARD = 0x40000000000;
        const VISITED_LOC_GIGUNA__GUBI_LAIR__PEDESTAL__AXE = 0x80000000000;
        const VISITED_LOC_GIGUNA__HARD_ROCK__ROCK_CENTER__TABLET = 0x100000000000;
        const VISITED_LOC_GIGUNA__HELIPAD__TABLET_LEDGE__TABLET = 0x200000000000;
        const VISITED_LOC_GIGUNA__LAMASSU__DEPOSIT__FLASK = 0x400000000000;
        const VISITED_LOC_GIGUNA__RUINS_CENTER__TABLET__ITEM = 0x800000000000;
        const VISITED_LOC_GIGUNA__RUINS_EAST__WAY_UP_HIGH__ITEM = 0x1000000000000;
        const VISITED_LOC_GIGUNA__WASTELAND__DOOR_RIGHT__HEALTH = 0x2000000000000;
        const VISITED_LOC_GIGUNA__WEST_CAVERNS__BUSH__ITEM = 0x4000000000000;
        const VISITED_LOC_GIGUNA__WEST_CAVERNS__CACHE__ITEM = 0x8000000000000;
        const VISITED_LOC_GIGUNA__WEST_TOWER__TOP__TABLET = 0x10000000000000;
        const VISITED_LOC_GLACIER_BREACH__GRATE_WORK__GRATE_INTERIOR__ITEM = 0x20000000000000;
        const VISITED_LOC_GLACIER__BOOMERANG_ROOM__PEDESTAL__ITEM = 0x40000000000000;
        const VISITED_LOC_GLACIER__BOOMERANG_ROOM__PEDESTAL__SWITCH = 0x80000000000000;
        const VISITED_LOC_GLACIER__COMPASS_ROOM__CENTER__TABLE = 0x100000000000000;
        const VISITED_LOC_GLACIER__CRYSTALS__LOWER_CORNER__ITEM = 0x200000000000000;
        const VISITED_LOC_GLACIER__CRYSTALS__TOP_CORNER__TABLET = 0x400000000000000;
        const VISITED_LOC_GLACIER__HAMMONDS_END__BETWEEN_CENTER_DOORS__HEALTH = 0x800000000000000;
        const VISITED_LOC_GLACIER__PEAK__BIRDS_EYE__ITEM = 0x1000000000000000;
...
bitflags!{
    ...
    pub struct ContextBits6 : u64 {
        ...
        const VISITED_LOC_IRIKAR__BASEMENT_PIPES__HIGH_PIPE__TABLET = 0x800;
        const VISITED_LOC_IRIKAR__BASEMENT_PIPES__LEFT_VERTICAL_PIPE__HEALTH_PICKUP = 0x1000;
        const VISITED_LOC_IRIKAR__BEACH__CACHE__ITEM = 0x2000;
        const VISITED_LOC_IRIKAR__BOSS_ROOM__BULLS_FEET__BOSS_REWARD = 0x4000;
        const VISITED_LOC_IRIKAR__BOSS_ROOM__HEALTHY_ROOFTOP__HEALTH = 0x8000;
        const VISITED_LOC_IRIKAR__EAST_ROOFTOPS__TOP_ROOFTOP__TABLET = 0x10000;
        const VISITED_LOC_IRIKAR__HUB__DAGGER_ALTAR__WEAPON = 0x20000;
        const VISITED_LOC_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__MIST_INTO_WALL = 0x40000;
        const VISITED_LOC_IRIKAR__HUB__ROYAL_STORAGE_BY_WALL__UPGRADED_MIST_INTO_WALL = 0x80000;
        const VISITED_LOC_IRIKAR__HUB__SW_BUILDING_TOP_PLATFORM__POWER_CORE = 0x100000;
        const VISITED_LOC_IRIKAR__HUB__SAT_TOWER_TOP_LEDGE__TABLET = 0x200000;
        const VISITED_LOC_IRIKAR__LAMASSU__DESK__ITEM = 0x400000;
        const VISITED_LOC_IRIKAR__MIDWEST__TABLET_PLATFORM__TABLET = 0x800000;
        const VISITED_LOC_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_1 = 0x1000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_2 = 0x2000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__COMBAT__MELEE_DAMAGE_3 = 0x4000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_1 = 0x8000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_2 = 0x10000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__COMBAT__MELEE_SPEED_3 = 0x20000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_1 = 0x40000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_2 = 0x80000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__COMBAT__RANGED_DAMAGE_3 = 0x100000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_1 = 0x200000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_2 = 0x400000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__COMBAT__RANGED_SPEED_3 = 0x800000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_1 = 0x1000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_2 = 0x2000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_DAMAGE_3 = 0x4000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_1 = 0x8000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_2 = 0x10000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__DRONE__DRONE_MELEE_SPEED_3 = 0x20000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_1 = 0x40000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_2 = 0x80000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__INFECTION__INFECTION_LEVEL_3 = 0x100000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_1 = 0x200000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_2 = 0x400000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__INFECTION__INFECTION_RANGE_3 = 0x800000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__INFECTION__INFECTION_SPEED_1 = 0x1000000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__INFECTION__INFECTION_SPEED_2 = 0x2000000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_1 = 0x4000000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_2 = 0x8000000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__INFECTION__NANO_POINTS_3 = 0x10000000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_1 = 0x20000000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_2 = 0x40000000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_3 = 0x80000000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_4 = 0x100000000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__PHYSIOLOGY__HEALTH_UPGRADE_5 = 0x200000000000000;
        const VISITED_LOC_MENU__UPGRADE_MENU__PHYSIOLOGY__MIST_UPGRADE = 0x400000000000000;
        const VISITED_LOC_UHRUM__ANNUNA_CORRIDOR__EAST_CUBBY__TABLET = 0x800000000000000;
        const VISITED_LOC_UHRUM__ANNUNA_CORRIDOR__STATUE__ITEM = 0x1000000000000000;
        const VISITED_LOC_UHRUM__SIEGE_CORRIDOR__CENTER_BOX__BOX = 0x2000000000000000;
        const VISITED_LOC_UHRUM__SIEGE_CORRIDOR__POND__ITEM = 0x4000000000000000;
        const VISITED_LOC_UHRUM__SIEGE_CORRIDOR__WESTERN_CACHE__CORE = 0x8000000000000000;
        const ALL_VISIT_FLAGS = 0xffffffffffffffff;
    }
}
bitflags!{
    ...
    pub struct ContextBits7 : u32 {
        const VISITED_LOC_UHRUM__WATERFALLS__CEILING_CACHE__FLASK = 0x1;
        const VISITED_LOC_UHRUM__WATERFALLS__WEST_WATER_NOOK__TABLET = 0x2;
        const VISITED_LOC_UHRUM__WEST_ENTRANCE__GATE_SWITCH__OPEN_GATE = 0x4;
        const VISITED_LOC_UHRUM__WEST_ENTRANCE__INNER_DAIS__ITEM = 0x8;
        const VISITED_LOC_UHRUM__WEST_ENTRANCE__SAND__REFILL = 0x10;
        const VISITED_MELEE_CHARGE = 0x20;
        const VISITED_NANITE_MIST = 0x40;
        const VISITED_NOTES_2053_02_27 = 0x80;
        const VISITED_REMOTE_DRONE = 0x100;
        const VISITED_REVIVAL_HEALTH_NODE = 0x200;
        const VISITED_SHOCKWAVE = 0x400;
        const VISITED_SIUNA_STORAGE_WALL = 0x800;
        const VISITED_SNIPER_VALLEY_ROCK_1 = 0x1000;
        const VISITED_SNIPER_VALLEY_ROCK_2 = 0x2000;
        const VISITED_SYNC_FLASK = 0x4000;
        const VISITED_UHRUM_ANNUNA_CORRIDOR_BLOCK = 0x8000;
        const VISITED_UHRUM_WATERFALL_WALL = 0x10000;
        const VISITED_UHRUM_WATERFALLS_BLOCK = 0x20000;
        const VISITED_UHRUM_WEST_ENTRANCE_LOWER_WALL = 0x40000;
        const VISITED_UHRUM_WEST_ENTRANCE_UPPER_WALL = 0x80000;
