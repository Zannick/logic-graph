...
impl fmt::Display for Deku_TreeSpotId {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            Deku_TreeSpotId::Deku_Tree__Lobby__Entry => write!(f, "{}", "Deku_Tree__Lobby__Entry"),
            Deku_TreeSpotId::Deku_Tree__Lobby__Center => {
                write!(f, "{}", "Deku_Tree__Lobby__Center")
            }
            Deku_TreeSpotId::Deku_Tree__Lobby__Vines => write!(f, "{}", "Deku_Tree__Lobby__Vines"),
            Deku_TreeSpotId::Deku_Tree__Floor_2__Lower => {
                write!(f, "{}", "Deku_Tree__Floor_2__Lower")
            }
            Deku_TreeSpotId::Deku_Tree__Floor_2__Vines => {
                write!(f, "{}", "Deku_Tree__Floor_2__Vines")
            }
            Deku_TreeSpotId::Deku_Tree__Floor_2__Slingshot_Door => {
                write!(f, "{}", "Deku_Tree__Floor_2__Slingshot_Door")
            }
            Deku_TreeSpotId::Deku_Tree__Scrub_Room__Entry => {
                write!(f, "{}", "Deku_Tree__Scrub_Room__Entry")
            }
            Deku_TreeSpotId::Deku_Tree__Scrub_Room__Rear => {
                write!(f, "{}", "Deku_Tree__Scrub_Room__Rear")
            }
            Deku_TreeSpotId::Deku_Tree__Slingshot_Room__Entry => {
                write!(f, "{}", "Deku_Tree__Slingshot_Room__Entry")
            }
            Deku_TreeSpotId::Deku_Tree__Slingshot_Room__Slingshot => {
                write!(f, "{}", "Deku_Tree__Slingshot_Room__Slingshot")
            }
            Deku_TreeSpotId::Deku_Tree__Slingshot_Upper__Ledge => {
                write!(f, "{}", "Deku_Tree__Slingshot_Upper__Ledge")
            }
            Deku_TreeSpotId::Deku_Tree__Floor_3__Climb => {
                write!(f, "{}", "Deku_Tree__Floor_3__Climb")
            }
            Deku_TreeSpotId::Deku_Tree__Floor_3__Door => {
                write!(f, "{}", "Deku_Tree__Floor_3__Door")
            }
            Deku_TreeSpotId::Deku_Tree__Compass_Room__Entry => {
                write!(f, "{}", "Deku_Tree__Compass_Room__Entry")
            }
            Deku_TreeSpotId::Deku_Tree__Compass_Room__Compass => {
                write!(f, "{}", "Deku_Tree__Compass_Room__Compass")
            }
            Deku_TreeSpotId::Deku_Tree__Compass_Room__Ledge => {
                write!(f, "{}", "Deku_Tree__Compass_Room__Ledge")
            }
            Deku_TreeSpotId::Deku_Tree__Basement_1__Center => {
                write!(f, "{}", "Deku_Tree__Basement_1__Center")
            }
            Deku_TreeSpotId::Deku_Tree__Basement_1__Corner => {
                write!(f, "{}", "Deku_Tree__Basement_1__Corner")
            }
            Deku_TreeSpotId::Deku_Tree__Basement_1__South_Door => {
                write!(f, "{}", "Deku_Tree__Basement_1__South_Door")
            }
            Deku_TreeSpotId::Deku_Tree__Back_Room__South => {
                write!(f, "{}", "Deku_Tree__Back_Room__South")
            }
            Deku_TreeSpotId::Deku_Tree__Back_Room__Northwest => {
                write!(f, "{}", "Deku_Tree__Back_Room__Northwest")
            }
            Deku_TreeSpotId::Deku_Tree__Back_Room__East => {
                write!(f, "{}", "Deku_Tree__Back_Room__East")
            }
            Deku_TreeSpotId::Deku_Tree__Skull_Room__Entry => {
                write!(f, "{}", "Deku_Tree__Skull_Room__Entry")
            }
            Deku_TreeSpotId::Deku_Tree__Basement_Ledge__Block => {
                write!(f, "{}", "Deku_Tree__Basement_Ledge__Block")
            }
            Deku_TreeSpotId::Deku_Tree__Basement_Ledge__Web => {
                write!(f, "{}", "Deku_Tree__Basement_Ledge__Web")
            }
            Deku_TreeSpotId::Deku_Tree__Basement_2__Pool => {
                write!(f, "{}", "Deku_Tree__Basement_2__Pool")
            }
            Deku_TreeSpotId::Deku_Tree__Basement_2__Boss_Door => {
                write!(f, "{}", "Deku_Tree__Basement_2__Boss_Door")
            }
            Deku_TreeSpotId::Deku_Tree__Boss_Room__Entry => {
                write!(f, "{}", "Deku_Tree__Boss_Room__Entry")
            }
            Deku_TreeSpotId::Deku_Tree__Boss_Room__Arena => {
                write!(f, "{}", "Deku_Tree__Boss_Room__Arena")
            }
        }
    }
}
impl analyzer::world::Id for Deku_TreeSpotId {}
impl std::str::FromStr for Deku_TreeSpotId {
    type Err = String;

    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "Deku_Tree__Lobby__Entry" => Ok(Deku_TreeSpotId::Deku_Tree__Lobby__Entry),
            "Deku_Tree__Lobby__Center" => Ok(Deku_TreeSpotId::Deku_Tree__Lobby__Center),
            "Deku_Tree__Lobby__Vines" => Ok(Deku_TreeSpotId::Deku_Tree__Lobby__Vines),
            "Deku_Tree__Floor_2__Lower" => Ok(Deku_TreeSpotId::Deku_Tree__Floor_2__Lower),
            "Deku_Tree__Floor_2__Vines" => Ok(Deku_TreeSpotId::Deku_Tree__Floor_2__Vines),
            "Deku_Tree__Floor_2__Slingshot_Door" => {
                Ok(Deku_TreeSpotId::Deku_Tree__Floor_2__Slingshot_Door)
            }
            "Deku_Tree__Scrub_Room__Entry" => Ok(Deku_TreeSpotId::Deku_Tree__Scrub_Room__Entry),
            "Deku_Tree__Scrub_Room__Rear" => Ok(Deku_TreeSpotId::Deku_Tree__Scrub_Room__Rear),
            "Deku_Tree__Slingshot_Room__Entry" => {
                Ok(Deku_TreeSpotId::Deku_Tree__Slingshot_Room__Entry)
            }
            "Deku_Tree__Slingshot_Room__Slingshot" => {
                Ok(Deku_TreeSpotId::Deku_Tree__Slingshot_Room__Slingshot)
            }
            "Deku_Tree__Slingshot_Upper__Ledge" => {
                Ok(Deku_TreeSpotId::Deku_Tree__Slingshot_Upper__Ledge)
            }
            "Deku_Tree__Floor_3__Climb" => Ok(Deku_TreeSpotId::Deku_Tree__Floor_3__Climb),
            "Deku_Tree__Floor_3__Door" => Ok(Deku_TreeSpotId::Deku_Tree__Floor_3__Door),
            "Deku_Tree__Compass_Room__Entry" => Ok(Deku_TreeSpotId::Deku_Tree__Compass_Room__Entry),
            "Deku_Tree__Compass_Room__Compass" => {
                Ok(Deku_TreeSpotId::Deku_Tree__Compass_Room__Compass)
            }
            "Deku_Tree__Compass_Room__Ledge" => Ok(Deku_TreeSpotId::Deku_Tree__Compass_Room__Ledge),
            "Deku_Tree__Basement_1__Center" => Ok(Deku_TreeSpotId::Deku_Tree__Basement_1__Center),
            "Deku_Tree__Basement_1__Corner" => Ok(Deku_TreeSpotId::Deku_Tree__Basement_1__Corner),
            "Deku_Tree__Basement_1__South_Door" => {
                Ok(Deku_TreeSpotId::Deku_Tree__Basement_1__South_Door)
            }
            "Deku_Tree__Back_Room__South" => Ok(Deku_TreeSpotId::Deku_Tree__Back_Room__South),
            "Deku_Tree__Back_Room__Northwest" => {
                Ok(Deku_TreeSpotId::Deku_Tree__Back_Room__Northwest)
            }
            "Deku_Tree__Back_Room__East" => Ok(Deku_TreeSpotId::Deku_Tree__Back_Room__East),
            "Deku_Tree__Skull_Room__Entry" => Ok(Deku_TreeSpotId::Deku_Tree__Skull_Room__Entry),
            "Deku_Tree__Basement_Ledge__Block" => {
                Ok(Deku_TreeSpotId::Deku_Tree__Basement_Ledge__Block)
            }
            "Deku_Tree__Basement_Ledge__Web" => Ok(Deku_TreeSpotId::Deku_Tree__Basement_Ledge__Web),
            "Deku_Tree__Basement_2__Pool" => Ok(Deku_TreeSpotId::Deku_Tree__Basement_2__Pool),
            "Deku_Tree__Basement_2__Boss_Door" => {
                Ok(Deku_TreeSpotId::Deku_Tree__Basement_2__Boss_Door)
            }
            "Deku_Tree__Boss_Room__Entry" => Ok(Deku_TreeSpotId::Deku_Tree__Boss_Room__Entry),
            "Deku_Tree__Boss_Room__Arena" => Ok(Deku_TreeSpotId::Deku_Tree__Boss_Room__Arena),
            _ => Err(format!("Could not recognize as a Deku_TreeSpotId: {}", s)),
        }
    }
}
...
impl fmt::Display for KFSpotId {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            KFSpotId::KF__Links_House__Start_Point => {
                write!(f, "{}", "KF__Links_House__Start_Point")
            }
            KFSpotId::KF__Links_House__Entry => write!(f, "{}", "KF__Links_House__Entry"),
            KFSpotId::KF__Kokiri_Village__Links_Porch => {
                write!(f, "{}", "KF__Kokiri_Village__Links_Porch")
            }
            KFSpotId::KF__Kokiri_Village__Midos_Porch => {
                write!(f, "{}", "KF__Kokiri_Village__Midos_Porch")
            }
            KFSpotId::KF__Kokiri_Village__Know_it_all_Porch => {
                write!(f, "{}", "KF__Kokiri_Village__Know_it_all_Porch")
            }
            KFSpotId::KF__Kokiri_Village__Training_Center => {
                write!(f, "{}", "KF__Kokiri_Village__Training_Center")
            }
            KFSpotId::KF__Kokiri_Village__Shop_Porch => {
                write!(f, "{}", "KF__Kokiri_Village__Shop_Porch")
            }
            KFSpotId::KF__Kokiri_Village__Sarias_Porch => {
                write!(f, "{}", "KF__Kokiri_Village__Sarias_Porch")
            }
            KFSpotId::KF__Kokiri_Village__Midos_Guardpost => {
                write!(f, "{}", "KF__Kokiri_Village__Midos_Guardpost")
            }
            KFSpotId::KF__Boulder_Maze__Entry => write!(f, "{}", "KF__Boulder_Maze__Entry"),
            KFSpotId::KF__Boulder_Maze__Reward => write!(f, "{}", "KF__Boulder_Maze__Reward"),
            KFSpotId::KF__Baba_Corridor__Village_Side => {
                write!(f, "{}", "KF__Baba_Corridor__Village_Side")
            }
            KFSpotId::KF__Baba_Corridor__Deku_Babas => {
                write!(f, "{}", "KF__Baba_Corridor__Deku_Babas")
            }
            KFSpotId::KF__Baba_Corridor__Tree_Side => {
                write!(f, "{}", "KF__Baba_Corridor__Tree_Side")
            }
            KFSpotId::KF__Outside_Deku_Tree__Entry => {
                write!(f, "{}", "KF__Outside_Deku_Tree__Entry")
            }
            KFSpotId::KF__Outside_Deku_Tree__Left => write!(f, "{}", "KF__Outside_Deku_Tree__Left"),
            KFSpotId::KF__Outside_Deku_Tree__Right => {
                write!(f, "{}", "KF__Outside_Deku_Tree__Right")
            }
            KFSpotId::KF__Outside_Deku_Tree__Mouth => {
                write!(f, "{}", "KF__Outside_Deku_Tree__Mouth")
            }
            KFSpotId::KF__Midos_House__Entry => write!(f, "{}", "KF__Midos_House__Entry"),
            KFSpotId::KF__Know_it_all_House__Entry => {
                write!(f, "{}", "KF__Know_it_all_House__Entry")
            }
            KFSpotId::KF__Shop__Entry => write!(f, "{}", "KF__Shop__Entry"),
        }
    }
}
impl analyzer::world::Id for KFSpotId {}
impl std::str::FromStr for KFSpotId {
    type Err = String;

    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "KF__Links_House__Start_Point" => Ok(KFSpotId::KF__Links_House__Start_Point),
            "KF__Links_House__Entry" => Ok(KFSpotId::KF__Links_House__Entry),
            "KF__Kokiri_Village__Links_Porch" => Ok(KFSpotId::KF__Kokiri_Village__Links_Porch),
            "KF__Kokiri_Village__Midos_Porch" => Ok(KFSpotId::KF__Kokiri_Village__Midos_Porch),
            "KF__Kokiri_Village__Know_it_all_Porch" => {
                Ok(KFSpotId::KF__Kokiri_Village__Know_it_all_Porch)
            }
            "KF__Kokiri_Village__Training_Center" => {
                Ok(KFSpotId::KF__Kokiri_Village__Training_Center)
            }
            "KF__Kokiri_Village__Shop_Porch" => Ok(KFSpotId::KF__Kokiri_Village__Shop_Porch),
            "KF__Kokiri_Village__Sarias_Porch" => Ok(KFSpotId::KF__Kokiri_Village__Sarias_Porch),
            "KF__Kokiri_Village__Midos_Guardpost" => {
                Ok(KFSpotId::KF__Kokiri_Village__Midos_Guardpost)
            }
            "KF__Boulder_Maze__Entry" => Ok(KFSpotId::KF__Boulder_Maze__Entry),
            "KF__Boulder_Maze__Reward" => Ok(KFSpotId::KF__Boulder_Maze__Reward),
            "KF__Baba_Corridor__Village_Side" => Ok(KFSpotId::KF__Baba_Corridor__Village_Side),
            "KF__Baba_Corridor__Deku_Babas" => Ok(KFSpotId::KF__Baba_Corridor__Deku_Babas),
            "KF__Baba_Corridor__Tree_Side" => Ok(KFSpotId::KF__Baba_Corridor__Tree_Side),
            "KF__Outside_Deku_Tree__Entry" => Ok(KFSpotId::KF__Outside_Deku_Tree__Entry),
            "KF__Outside_Deku_Tree__Left" => Ok(KFSpotId::KF__Outside_Deku_Tree__Left),
            "KF__Outside_Deku_Tree__Right" => Ok(KFSpotId::KF__Outside_Deku_Tree__Right),
            "KF__Outside_Deku_Tree__Mouth" => Ok(KFSpotId::KF__Outside_Deku_Tree__Mouth),
            "KF__Midos_House__Entry" => Ok(KFSpotId::KF__Midos_House__Entry),
            "KF__Know_it_all_House__Entry" => Ok(KFSpotId::KF__Know_it_all_House__Entry),
            "KF__Shop__Entry" => Ok(KFSpotId::KF__Shop__Entry),
            _ => Err(format!("Could not recognize as a KFSpotId: {}", s)),
        }
    }
}
...
impl fmt::Display for KakSpotId {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            KakSpotId::Kak__Spider_House__Entry => write!(f, "{}", "Kak__Spider_House__Entry"),
        }
    }
}
impl analyzer::world::Id for KakSpotId {}
impl std::str::FromStr for KakSpotId {
    type Err = String;

    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "Kak__Spider_House__Entry" => Ok(KakSpotId::Kak__Spider_House__Entry),
            _ => Err(format!("Could not recognize as a KakSpotId: {}", s)),
        }
    }
}
...
pub enum BigSpotId {
    #[default]
    None,
    Deku_Tree(Deku_TreeSpotId),
    KF(KFSpotId),
    Kak(KakSpotId),
}

impl fmt::Display for BigSpotId {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            BigSpotId::None => write!(f, "{}", "None"),
            BigSpotId::Deku_Tree(s) => s.fmt(f),
            BigSpotId::KF(s) => s.fmt(f),
            BigSpotId::Kak(s) => s.fmt(f),
        }
    }
}

impl analyzer::world::Id for BigSpotId {}

impl std::str::FromStr for BigSpotId {
    type Err = String;

    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "Deku Tree > Lobby > Entry" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Lobby__Entry,
            )),
            "Deku Tree > Lobby > Center" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Lobby__Center,
            )),
            "Deku Tree > Lobby > Vines" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Lobby__Vines,
            )),
            "Deku Tree > Floor 2 > Lower" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Floor_2__Lower,
            )),
            "Deku Tree > Floor 2 > Vines" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Floor_2__Vines,
            )),
            "Deku Tree > Floor 2 > Slingshot Door" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Floor_2__Slingshot_Door,
            )),
            "Deku Tree > Scrub Room > Entry" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Scrub_Room__Entry,
            )),
            "Deku Tree > Scrub Room > Rear" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Scrub_Room__Rear,
            )),
            "Deku Tree > Slingshot Room > Entry" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Slingshot_Room__Entry,
            )),
            "Deku Tree > Slingshot Room > Slingshot" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Slingshot_Room__Slingshot,
            )),
            "Deku Tree > Slingshot Upper > Ledge" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Slingshot_Upper__Ledge,
            )),
            "Deku Tree > Floor 3 > Climb" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Floor_3__Climb,
            )),
            "Deku Tree > Floor 3 > Door" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Floor_3__Door,
            )),
            "Deku Tree > Compass Room > Entry" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Compass_Room__Entry,
            )),
            "Deku Tree > Compass Room > Compass" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Compass_Room__Compass,
            )),
            "Deku Tree > Compass Room > Ledge" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Compass_Room__Ledge,
            )),
            "Deku Tree > Basement 1 > Center" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Basement_1__Center,
            )),
            "Deku Tree > Basement 1 > Corner" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Basement_1__Corner,
            )),
            "Deku Tree > Basement 1 > South Door" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Basement_1__South_Door,
            )),
            "Deku Tree > Back Room > South" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Back_Room__South,
            )),
            "Deku Tree > Back Room > Northwest" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Back_Room__Northwest,
            )),
            "Deku Tree > Back Room > East" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Back_Room__East,
            )),
            "Deku Tree > Skull Room > Entry" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Skull_Room__Entry,
            )),
            "Deku Tree > Basement Ledge > Block" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Basement_Ledge__Block,
            )),
            "Deku Tree > Basement Ledge > Web" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Basement_Ledge__Web,
            )),
            "Deku Tree > Basement 2 > Pool" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Basement_2__Pool,
            )),
            "Deku Tree > Basement 2 > Boss Door" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Basement_2__Boss_Door,
            )),
            "Deku Tree > Boss Room > Entry" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Boss_Room__Entry,
            )),
            "Deku Tree > Boss Room > Arena" => Ok(BigSpotId::Deku_Tree(
                Deku_TreeSpotId::Deku_Tree__Boss_Room__Arena,
            )),
            "KF > Link's House > Start Point" => {
                Ok(BigSpotId::KF(KFSpotId::KF__Links_House__Start_Point))
            }
            "KF > Link's House > Entry" => Ok(BigSpotId::KF(KFSpotId::KF__Links_House__Entry)),
            "KF > Kokiri Village > Link's Porch" => {
                Ok(BigSpotId::KF(KFSpotId::KF__Kokiri_Village__Links_Porch))
            }
            "KF > Kokiri Village > Mido's Porch" => {
                Ok(BigSpotId::KF(KFSpotId::KF__Kokiri_Village__Midos_Porch))
            }
            "KF > Kokiri Village > Know-it-all Porch" => Ok(BigSpotId::KF(
                KFSpotId::KF__Kokiri_Village__Know_it_all_Porch,
            )),
            "KF > Kokiri Village > Training Center" => {
                Ok(BigSpotId::KF(KFSpotId::KF__Kokiri_Village__Training_Center))
            }
            "KF > Kokiri Village > Shop Porch" => {
                Ok(BigSpotId::KF(KFSpotId::KF__Kokiri_Village__Shop_Porch))
            }
            "KF > Kokiri Village > Saria's Porch" => {
                Ok(BigSpotId::KF(KFSpotId::KF__Kokiri_Village__Sarias_Porch))
            }
            "KF > Kokiri Village > Mido's Guardpost" => {
                Ok(BigSpotId::KF(KFSpotId::KF__Kokiri_Village__Midos_Guardpost))
            }
            "KF > Boulder Maze > Entry" => Ok(BigSpotId::KF(KFSpotId::KF__Boulder_Maze__Entry)),
            "KF > Boulder Maze > Reward" => Ok(BigSpotId::KF(KFSpotId::KF__Boulder_Maze__Reward)),
            "KF > Baba Corridor > Village Side" => {
                Ok(BigSpotId::KF(KFSpotId::KF__Baba_Corridor__Village_Side))
            }
            "KF > Baba Corridor > Deku Babas" => {
                Ok(BigSpotId::KF(KFSpotId::KF__Baba_Corridor__Deku_Babas))
            }
            "KF > Baba Corridor > Tree Side" => {
                Ok(BigSpotId::KF(KFSpotId::KF__Baba_Corridor__Tree_Side))
            }
            "KF > Outside Deku Tree > Entry" => {
                Ok(BigSpotId::KF(KFSpotId::KF__Outside_Deku_Tree__Entry))
            }
            "KF > Outside Deku Tree > Left" => {
                Ok(BigSpotId::KF(KFSpotId::KF__Outside_Deku_Tree__Left))
            }
            "KF > Outside Deku Tree > Right" => {
                Ok(BigSpotId::KF(KFSpotId::KF__Outside_Deku_Tree__Right))
            }
            "KF > Outside Deku Tree > Mouth" => {
                Ok(BigSpotId::KF(KFSpotId::KF__Outside_Deku_Tree__Mouth))
            }
            "KF > Mido's House > Entry" => Ok(BigSpotId::KF(KFSpotId::KF__Midos_House__Entry)),
            "KF > Know-it-all House > Entry" => {
                Ok(BigSpotId::KF(KFSpotId::KF__Know_it_all_House__Entry))
            }
            "KF > Shop > Entry" => Ok(BigSpotId::KF(KFSpotId::KF__Shop__Entry)),
            "Kak > Spider House > Entry" => Ok(BigSpotId::Kak(KakSpotId::Kak__Spider_House__Entry)),
            _ => Err(format!("Could not recognize as a BigSpotId: {}", s)),
        }
    }
}
...
impl GetArea for Deku_TreeSpotId {
    fn get_area(&self) -> AreaId {
        match *self {
            Deku_TreeSpotId::Deku_Tree__Lobby__Entry
            | Deku_TreeSpotId::Deku_Tree__Lobby__Center
            | Deku_TreeSpotId::Deku_Tree__Lobby__Vines => AreaId::Deku_Tree__Lobby,
            Deku_TreeSpotId::Deku_Tree__Floor_2__Lower
            | Deku_TreeSpotId::Deku_Tree__Floor_2__Vines
            | Deku_TreeSpotId::Deku_Tree__Floor_2__Slingshot_Door => AreaId::Deku_Tree__Floor_2,
            Deku_TreeSpotId::Deku_Tree__Scrub_Room__Entry
            | Deku_TreeSpotId::Deku_Tree__Scrub_Room__Rear => AreaId::Deku_Tree__Scrub_Room,
            Deku_TreeSpotId::Deku_Tree__Slingshot_Room__Entry
            | Deku_TreeSpotId::Deku_Tree__Slingshot_Room__Slingshot => {
                AreaId::Deku_Tree__Slingshot_Room
            }
            Deku_TreeSpotId::Deku_Tree__Slingshot_Upper__Ledge => {
                AreaId::Deku_Tree__Slingshot_Upper
            }
            Deku_TreeSpotId::Deku_Tree__Floor_3__Climb
            | Deku_TreeSpotId::Deku_Tree__Floor_3__Door => AreaId::Deku_Tree__Floor_3,
            Deku_TreeSpotId::Deku_Tree__Compass_Room__Entry
            | Deku_TreeSpotId::Deku_Tree__Compass_Room__Compass
            | Deku_TreeSpotId::Deku_Tree__Compass_Room__Ledge => AreaId::Deku_Tree__Compass_Room,
            Deku_TreeSpotId::Deku_Tree__Basement_1__Center
            | Deku_TreeSpotId::Deku_Tree__Basement_1__Corner
            | Deku_TreeSpotId::Deku_Tree__Basement_1__South_Door => AreaId::Deku_Tree__Basement_1,
            Deku_TreeSpotId::Deku_Tree__Back_Room__South
            | Deku_TreeSpotId::Deku_Tree__Back_Room__Northwest
            | Deku_TreeSpotId::Deku_Tree__Back_Room__East => AreaId::Deku_Tree__Back_Room,
            Deku_TreeSpotId::Deku_Tree__Skull_Room__Entry => AreaId::Deku_Tree__Skull_Room,
            Deku_TreeSpotId::Deku_Tree__Basement_Ledge__Block
            | Deku_TreeSpotId::Deku_Tree__Basement_Ledge__Web => AreaId::Deku_Tree__Basement_Ledge,
            Deku_TreeSpotId::Deku_Tree__Basement_2__Pool
            | Deku_TreeSpotId::Deku_Tree__Basement_2__Boss_Door => AreaId::Deku_Tree__Basement_2,
            Deku_TreeSpotId::Deku_Tree__Boss_Room__Entry
            | Deku_TreeSpotId::Deku_Tree__Boss_Room__Arena => AreaId::Deku_Tree__Boss_Room,
        }
    }
}
impl GetArea for KFSpotId {
    fn get_area(&self) -> AreaId {
        match *self {
            ...
            | KFSpotId::KF__Kokiri_Village__Shop_Porch
            | KFSpotId::KF__Kokiri_Village__Sarias_Porch
            | KFSpotId::KF__Kokiri_Village__Midos_Guardpost => AreaId::KF__Kokiri_Village,
            KFSpotId::KF__Boulder_Maze__Entry | KFSpotId::KF__Boulder_Maze__Reward => {
                AreaId::KF__Boulder_Maze
            }
            KFSpotId::KF__Baba_Corridor__Village_Side
            | KFSpotId::KF__Baba_Corridor__Deku_Babas
            | KFSpotId::KF__Baba_Corridor__Tree_Side => AreaId::KF__Baba_Corridor,
            KFSpotId::KF__Outside_Deku_Tree__Entry
            | KFSpotId::KF__Outside_Deku_Tree__Left
            | KFSpotId::KF__Outside_Deku_Tree__Right
            | KFSpotId::KF__Outside_Deku_Tree__Mouth => AreaId::KF__Outside_Deku_Tree,
            KFSpotId::KF__Midos_House__Entry => AreaId::KF__Midos_House,
            KFSpotId::KF__Know_it_all_House__Entry => AreaId::KF__Know_it_all_House,
            KFSpotId::KF__Shop__Entry => AreaId::KF__Shop,
        }
    }
}
impl GetArea for KakSpotId {
    fn get_area(&self) -> AreaId {
        match *self {
            KakSpotId::Kak__Spider_House__Entry => AreaId::Kak__Spider_House,
        }
    }
}
pub fn get_region_b(spot: BigSpotId) -> RegionId {
    match spot {
        BigSpotId::None => panic!("Spot not valid"),
        BigSpotId::Deku_Tree(_) => RegionId::Deku_Tree,
        BigSpotId::KF(_) => RegionId::KF,
        BigSpotId::Kak(_) => RegionId::Kak,
    }
}
pub fn get_area_b(spot: BigSpotId) -> AreaId {
    match spot {
        BigSpotId::None => panic!("Spot not valid"),
        BigSpotId::Deku_Tree(s) => s.get_area(),
        BigSpotId::KF(s) => s.get_area(),
        BigSpotId::Kak(s) => s.get_area(),
    }
}
